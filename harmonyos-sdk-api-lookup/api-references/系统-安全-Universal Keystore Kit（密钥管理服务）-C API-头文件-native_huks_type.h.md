...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Huks\_KeyPurpose](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keypurpose) | - | 密钥用途类型。 |
| [OH\_Huks\_KeyDigest](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keydigest) | - | 摘要算法类型。 |
| [OH\_Huks\_KeyPadding](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keypadding) | - | 填充算法类型。 |
| [OH\_Huks\_CipherMode](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_ciphermode) | - | 加密模式。 |
| [OH\_Huks\_KeySize](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keysize) | - | 算法密钥长度。 |
| [OH\_Huks\_KeyAlg](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keyalg) | - | 密钥使用的算法。 |
| [OH\_Huks\_AlgSuite](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_algsuite) | - | 密文导入所需的算法套件类型。 |
| [OH\_Huks\_KeyGenerateType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keygeneratetype) | - | 生成的密钥类型。 |
| [OH\_Huks\_KeyFlag](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keyflag) | - | 密钥的产生方式。 |
| [OH\_Huks\_KeyStorageType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keystoragetype) | - | 密钥的存储方式。 |
| [OH\_Huks\_ImportKeyType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_importkeytype) | - | 导入密钥的类型，默认为导入公钥，导入对称密钥时不需要该字段。 |
| [OH\_Huks\_RsaPssSaltLenType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_rsapsssaltlentype) | - | PSS填充模式下盐值长度类型。 |
| [OH\_Huks\_ErrCode](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_errcode) | - | 错误码。 |
| [OH\_Huks\_TagType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_tagtype) | - | 参数集中参数的类型。 |
| [OH\_Huks\_UserAuthType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_userauthtype) | - | 密钥访问控制中的用户认证类型。 |
| [OH\_Huks\_AuthAccessType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_authaccesstype) | - | 安全访问控制类型，表示密钥失效的原则。 |
| [OH\_Huks\_AuthStorageLevel](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_authstoragelevel) | - | 表示生成或导入密钥时，指定该密钥的存储安全等级。 |
| [OH\_Huks\_ChallengeType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_challengetype) | - | 密钥使用时生成challenge的类型。 |
| [OH\_Huks\_UserAuthMode](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_userauthmode) | - | 密钥访问控制中的用户认证模式。 |
| [OH\_Huks\_ChallengePosition](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_challengeposition) | - | challenge类型为用户自定义类型时，生成的challenge有效长度仅为8字节连续的数据，且仅支持4种位置。 |
| [OH\_Huks\_SecureSignType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_securesigntype) | - | 生成或导入密钥时，指定该密钥的安全签名类型。 |
| [OH\_Huks\_KeyClassType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keyclasstype) | OH\_Huks\_KeyClassType | 密钥类型。 |
| [OH\_Huks\_KeyWrapType](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_keywraptype) | - | 生成或导入密钥时，指定该密钥的封装类型。 |
| [OH\_Huks\_Tag](/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_tag) | - | 参数集所用的TAG值枚举。 |
...
| OH\_HUKS\_TAG\_AUTH\_STORAGE\_LEVEL = OH\_HUKS\_TAG\_TYPE\_UINT | 316 | 密钥文件存储访问控制的类别，类型可在枚举[OH\_Huks\_AuthStorageLevel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_authstoragelevel)中选择。  **起始版本：** 11 |
| OH\_HUKS\_TAG\_USER\_AUTH\_MODE = OH\_HUKS\_TAG\_TYPE\_UINT | 319 | 表示密钥访问控制中用户认证模式，类型可在枚举[OH\_Huks\_UserAuthMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-huks-type-h#oh_huks_userauthmode)中选择。  **起始版本：** 12 |
