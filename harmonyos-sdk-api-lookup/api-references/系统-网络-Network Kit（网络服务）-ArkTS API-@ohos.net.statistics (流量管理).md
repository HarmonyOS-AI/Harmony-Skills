...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| networkInfo | [NetworkInfo](/consumer/cn/doc/harmonyos-references/js-apis-net-statistics#networkinfo22) | 是 | 指定查询的网络信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[NetStatsInfo](/consumer/cn/doc/harmonyos-references/js-apis-net-statistics#netstatsinfo22)> | Promise对象，返回应用历史流量统计信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [NetBearType](/consumer/cn/doc/harmonyos-references/js-apis-net-statistics#netbeartype12) | 否 | 否 | 网络类型。  **注意：** 当type为蜂窝网络时，需指定simId字段。 |
