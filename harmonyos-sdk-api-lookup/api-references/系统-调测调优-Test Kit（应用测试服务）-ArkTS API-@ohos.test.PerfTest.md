...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| metrics | Array<[PerfMetric](/consumer/cn/doc/harmonyos-references/js-apis-perftest#perfmetric)> | 否 | 否 | 被测性能指标列表。 |
...
其中，回调函数的参数为boolean类型，true代表代码段执行符合预期，false代表代码段执行不符合预期。[代码示例](/consumer/cn/doc/harmonyos-references/js-apis-perftest#create)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| metric | [PerfMetric](/consumer/cn/doc/harmonyos-references/js-apis-perftest#perfmetric) | 是 | 否 | 被测性能指标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strategy | [PerfTestStrategy](/consumer/cn/doc/harmonyos-references/js-apis-perftest#perfteststrategy) | 是 | 性能测试执行策略。 |
...
| 类型 | 说明 |
| --- | --- |
| [PerfTest](/consumer/cn/doc/harmonyos-references/js-apis-perftest#perftest) | 返回构造的PerfTest对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| metric | [PerfMetric](/consumer/cn/doc/harmonyos-references/js-apis-perftest#perfmetric) | 是 | 性能指标。 |
...
| 类型 | 说明 |
| --- | --- |
| [PerfMeasureResult](/consumer/cn/doc/harmonyos-references/js-apis-perftest#perfmeasureresult) | 性能指标对应测量结果数据。 |
