...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| config | [AssetDownloadConfig](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#assetdownloadconfig) | 是 | 否 | 资源包下载任务的配置信息，包含任务ID、URL、下载优先级等信息。 |
| taskId | string | 是 | 否 | 系统自动生成的任务ID，用于唯一标识下载任务。  最大长度36个字节。 |
| state | [State](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#state) | 是 | 否 | 资源包下载任务的状态。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| downloadTask | [AssetDownloadTask](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#assetdownloadtask) | 是 | 否 | 资源包下载任务的信息。 |
...
| --- | --- | --- | --- | --- |
| downloadTask | [AssetDownloadTask](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#assetdownloadtask) | 是 | 否 | 资源包下载任务的信息。 |
| fault | [DownloadFault](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#downloadfault) | 是 | 否 | 资源包下载失败的原因。 |
...
| callback | Callback<[DownloadProgressInfo[]](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#downloadprogressinfo)> | 是 | 回调函数。返回任务进度信息。 |
...
| callback | Callback<[DownloadProgressInfo[]](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#downloadprogressinfo)> | 否 | 回调函数。返回任务进度信息。需要取消监听的回调函数，需与订阅时传入的回调函数一致。若不填，则取消当前监听该事件的所有回调函数。 |
...
| callback | Callback<[AssetDownloadTask](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#assetdownloadtask)> | 是 | 回调函数。返回任务信息。 |
...
| callback | Callback<[AssetDownloadTask](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#assetdownloadtask)> | 否 | 回调函数。返回任务进度信息。需要取消监听的回调函数，需与订阅时传入的回调函数一致。若不填，则取消当前监听该事件的所有回调函数。 |
...
| callback | Callback<[DownloadCompletedInfo](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#downloadcompletedinfo)> | 是 | 回调函数。返回任务完成信息。 |
...
| callback | Callback<[DownloadCompletedInfo](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#downloadcompletedinfo)> | 否 | 回调函数。返回任务进度信息。需要取消监听的回调函数，需与订阅时传入的回调函数一致。若不填，则取消当前监听该事件的所有回调函数。 |
...
| callback | Callback<[DownloadFailedInfo](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#downloadfailedinfo)> | 是 | 回调函数。返回任务失败信息。 |
...
| callback | Callback<[DownloadFailedInfo](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#downloadfailedinfo)> | 否 | 回调函数。返回任务进度信息。需要取消监听的回调函数，需与订阅时传入的回调函数一致。若不填，则取消当前监听该事件的所有回调函数。 |
...
| downloadConfig | [AssetDownloadConfig](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#assetdownloadconfig) | 是 | 资源包下载任务的配置信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AssetDownloadTask[]](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#assetdownloadtask)> | Promise对象。返回资源包下载任务列表。 |
...
| speedLimit | [NetSpeedLevel](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#netspeedlevel) | 是 | 网络限速等级。 |
...
| status | [AppDownloadStatus](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#appdownloadstatus) | 否 | 否 | 当前应用自身下载器中的下载状态。 |
| resourceType | [ResourceType](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#resourcetype) | 否 | 是 | 后台正在下载的资源类型，不同的资源类型决定了后台下载通知的内容样式。  默认值为RELEASED。  **起始版本：** 6.1.0(23) |
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| progressInfo | [AppDownloadProgress](/consumer/cn/doc/harmonyos-references/graphics-accelerate-assetdownloadmanager#appdownloadprogress) | 是 | 应用自身下载器中的下载进度信息。 |
