...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| curve | [Curve](/consumer/cn/doc/harmonyos-references/js-apis-curve#curve) | 否 | 曲线类型。  默认值：Curve.Linear |
...
| 类型 | 说明 |
| --- | --- |
| [ICurve](/consumer/cn/doc/harmonyos-references/js-apis-curve#icurve9) | 曲线的插值对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ICurve](/consumer/cn/doc/harmonyos-references/js-apis-curve#icurve9) | 曲线对象。  **说明:**  弹性动画曲线为物理曲线，[animation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-animatorproperty)、[animateTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-explicit-animation)、[pageTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-page-transition-animation)中的duration参数不生效，动画持续时间取决于springMotion动画曲线参数和之前的速度。时间不能归一，故不能通过该曲线的[interpolate](/consumer/cn/doc/harmonyos-references/js-apis-curve#interpolate9)函数获得插值。 |
...
构造弹性跟手动画曲线对象，是[springMotion](/consumer/cn/doc/harmonyos-references/js-apis-curve#curvesspringmotion9)的一种特例，仅默认参数不同，可与springMotion混合使用。
...
| 类型 | 说明 |
| --- | --- |
| [ICurve](/consumer/cn/doc/harmonyos-references/js-apis-curve#icurve9) | 曲线对象。  **说明:**  1、弹性跟手动画曲线为springMotion的一种特例，仅默认值不同。如果使用自定义参数的弹性曲线，推荐使用springMotion构造曲线；如果使用跟手动画，推荐使用默认参数的弹性跟手动画曲线。  2、[animation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-animatorproperty)、[animateTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-explicit-animation)、[pageTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-page-transition-animation)中的duration参数不生效，动画持续时间取决于responsiveSpringMotion动画曲线参数和之前的速度，也不能通过该曲线的[interpolate](/consumer/cn/doc/harmonyos-references/js-apis-curve#interpolate9)函数获得插值。 |
...
曲线对象，支持通过本模块中的[curves.cubicBezierCurve](/consumer/cn/doc/harmonyos-references/js-apis-curve#curvescubicbeziercurve9)、[curves.interpolatingSpring](/consumer/cn/doc/harmonyos-references/js-apis-curve#curvesinterpolatingspring10)等方法创建不同类型的曲线对象，并可通过曲线对象调用其[interpolate](/consumer/cn/doc/harmonyos-references/js-apis-curve#interpolate9)的成员方法。
...
从API version 7开始支持，从API version 9开始废弃。建议使用[Curves.initCurve](/consumer/cn/doc/harmonyos-references/js-apis-curve#curvesinitcurve9)替代。
...
从API version 7开始支持，从API version 9开始废弃。建议使用[Curves. stepsCurve](/consumer/cn/doc/harmonyos-references/js-apis-curve#curvesstepscurve9)替代。
...
从API version 7开始支持，从API version 9开始废弃。建议使用[Curves.cubicBezierCurve](/consumer/cn/doc/harmonyos-references/js-apis-curve#curvescubicbeziercurve9)替代。
...
从API version 7开始支持，从API version 9开始废弃。建议使用[Curves.springCurve](/consumer/cn/doc/harmonyos-references/js-apis-curve#curvesspringcurve9)替代。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/GsaOqYckR7mXmH1N0iZmiw/zh-cn_image_0000002568918712.gif?HW-CC-KV=V1&HW-CC-Date=20260511T034001Z&HW-CC-Expire=86400&HW-CC-Sign=14ACF4ADFC2257A4ACE63C362141FCEEB0770BF78F99C09A78690495919F8B34)