...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [WeatherRequest](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weatherrequest) | 是 | 天气数据请求体。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Weather](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weather)> | Promise对象，返回天气数据对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| location | [Location](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#location) | 否 | 否 | 位置信息。 |
| limitedDatasets | [Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset)[] | 否 | 是 | 接口只返回列表中指定的数据类型，若未设置或数组为空，默认返回全量数据。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| current | [CurrentWeather](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#currentweather) | 否 | 是 | 实况天气，若设置了limitedDatasets且数组中不包含[Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset).CURRENT，该字段不返回。 |
| daily | [Forecast](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#forecastt)<[DailyWeather](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dailyweather)> | 否 | 是 | 多日预报，若设置了limitedDatasets且数组中不包含[Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset).DAILY，该字段不返回。 |
| hourly | [Forecast](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#forecastt)<[HourlyWeather](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#hourlyweather)> | 否 | 是 | 逐小时预报，若设置了limitedDatasets且数组中不包含[Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset).HOURLY，该字段不返回。 |
| minute | [Forecast](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#forecastt)<[MinuteWeather](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#minuteweather)> | 否 | 是 | 分钟级降水预报，若设置了limitedDatasets且数组中不包含[Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset).MINUTE，或者该区域短期无降水，该字段不返回。 |
| alerts | [WeatherAlert](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weatheralert)[] | 否 | 是 | 天气预警，若设置了limitedDatasets且数组中不包含[Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset).ALERTS，或者该区域当前无预警，该字段不返回。 |
| indices | [WeatherIndex](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weatherindex)[] | 否 | 是 | 天气指数，若设置了limitedDatasets且数组中不包含[Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset).INDICES，该字段不返回。 |
| tides | [Tide](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#tide)[] | 否 | 是 | 潮汐，若设置了limitedDatasets且数组中不包含[Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset).TIDES，或者该区域无潮汐站点，该字段不返回。 |
| city | [City](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#city) | 否 | 是 | 请求经纬度对应的城市信息，若设置了limitedDatasets且数组中不包含[Dataset](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dataset).CITY，该字段不返回。  **元服务API：** 从版本6.1.0(23)开始，该接口支持在元服务中使用。  **起始版本：** 6.1.0(23)  **模型约束：** 此接口仅可在Stage模型下使用。 |
| metadata | [WeatherMetadata](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weathermetadata) | 否 | 否 | 天气数据元数据。 |
| attributions | [WeatherAttribution](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weatherattribution)[] | 否 | 否 | 天气数据的归因。 |
...
| pressureTrend | [PressureTrend](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#pressuretrend) | 否 | 否 | 气压趋势。 |
| wind | [Wind](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#wind) | 否 | 否 | 风力风向。 |
| cloudCover | number | 否 | 否 | 云量。  例如云量为30%，本字段返回30。 |
| condition | [WeatherCondition](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weathercondition) | 否 | 否 | 天气现象。 |
| uvIndex | [UVIndex](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#uvindex) | 否 | 否 | 紫外线指数。 |
| aqi | [WeatherAqi](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weatheraqi) | 否 | 是 | 空气质量。 |
...
| aqi | [WeatherAqi](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weatheraqi) | 否 | 是 | 空气质量。 |
| visibility | number | 否 | 否 | 能见度。  单位：km。 |
| moon | [MoonEvents](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#moonevents) | 否 | 否 | 月出/月落时间，月相等信息。 |
| sun | [SunEvents](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#sunevents) | 否 | 否 | 日出/日落时间。 |
| daytimeForecast | [DayPartForecast](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#daypartforecast) | 否 | 否 | 白天天气数据。 |
| overnightForecast | [DayPartForecast](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#daypartforecast) | 否 | 否 | 夜晚天气数据。 |
| pressure | number | 否 | 否 | 地面气压。  单位：hPa。 |
...
| cloudCover | number | 否 | 否 | 云量。  例如云量为30%，本字段返回30。 |
| condition | [WeatherCondition](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weathercondition) | 否 | 否 | 天气现象。 |
| uvIndex | [UVIndex](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#uvindex) | 否 | 否 | 紫外线等级。 |
| aqi | [WeatherAqi](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weatheraqi) | 否 | 是 | 空气质量。 |
| visibility | number | 否 | 否 | 能见度。  单位：km。 |
...
| precipitation | [Precipitation](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#precipitation) | 否 | 否 | 降水类型。 |
...
| level | [AlertLevel](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#alertlevel) | 否 | 否 | 预警等级。 |
| levelDescription | string | 否 | 否 | 预警等级描述。 |
| type | [AlertType](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#alerttype) | 否 | 否 | 预警类型。 |
...
| updateTime | Date | 否 | 否 | 数据更新时间，UTC时间格式。 |
| expirationTime | Date | 否 | 否 | 数据失效时间，UTC时间格式。 |
| type | [WeatherIndexType](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#weatherindextype) | 否 | 否 | 指数类型。 |
| name | string | 否 | 否 | 指数名称。 |
| dailyItems | [DailyIndex](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#dailyindex)[] | 否 | 否 | 每天的指数详情。 |
...
| hourlyTides | [HourlyTide](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#hourlytide)[] | 否 | 否 | 小时潮汐数据。 |
...
| administrativeAreas | [AdministrativeArea](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#administrativearea)[] | 否 | 是 | 行政区域列表。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| direction | [CompassDirection](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#compassdirection) | 否 | 否 | 风向。 |
| speed | number | 否 | 否 | 风速。  单位：km/h。 |
| level | number | 否 | 否 | 风力级别。 |
| gustDirection | [CompassDirection](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#compassdirection) | 否 | 是 | 阵风风向。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [ConditionType](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#conditiontype) | 否 | 否 | 天气现象类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| category | [ExposureCategory](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#exposurecategory) | 否 | 否 | 紫外线暴露类别。 |
...
| aqiCategory | [AqiCategory](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#aqicategory) | 否 | 否 | 空气质量类别。 |
...
| phase | [MoonPhase](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#moonphase) | 否 | 否 | 月相。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [MoonPhaseType](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#moonphasetype) | 否 | 否 | 月相类型。 |
...
| --- | --- | --- | --- | --- |
| date | Date | 否 | 否 | 日期，精确到小时，UTC时间格式。 |
| category | [TideCategory](/consumer/cn/doc/harmonyos-references/weather-service-weatherservice#tidecategory) | 否 | 是 | 潮汐类型。 |
