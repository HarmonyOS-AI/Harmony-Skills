...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Http\_ErrCode](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_errcode) | Http\_ErrCode | 定义HTTP请求的错误码。 |
| [Http\_ResponseCode](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_responsecode) | Http\_ResponseCode | 定义HTTP响应码。 |
| [Http\_AddressFamilyType](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_addressfamilytype) | Http\_AddressFamilyType | 定义解析目标域名时限定的地址类型。 |
| [Http\_HttpProtocol](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_httpprotocol) | Http\_HttpProtocol | HTTP协议版本号枚举定义。 |
| [Http\_CertType](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_certtype) | Http\_CertType | 证书类型枚举。 |
| [Http\_ProxyType](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_proxytype) | Http\_ProxyType | 代理配置类型枚举定义。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*Http\_ResponseCallback)(struct Http\_Response \*response, uint32\_t errCode)](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_responsecallback) | Http\_ResponseCallback | 接收到HTTP响应的回调函数。 |
| [typedef void (\*Http\_OnDataReceiveCallback)(const char \*data, size\_t length)](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_ondatareceivecallback) | Http\_OnDataReceiveCallback | 接收到数据的回调。 |
| [typedef void (\*Http\_OnProgressCallback)(uint64\_t totalSize, uint64\_t transferredSize)](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_onprogresscallback) | Http\_OnProgressCallback | 请求/响应数据传输过程中调用的回调函数。 |
| [typedef void (\*Http\_OnHeaderReceiveCallback)(Http\_Headers \*headers)](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_onheaderreceivecallback) | Http\_OnHeaderReceiveCallback | 收到HTTP响应头的回调函数。 |
| [typedef void (\*Http\_OnVoidCallback)(void)](/consumer/cn/doc/harmonyos-references/capi-net-http-type-h#http_onvoidcallback) | Http\_OnVoidCallback | 请求的DataEnd或Cancel事件回调的回调函数。 |
