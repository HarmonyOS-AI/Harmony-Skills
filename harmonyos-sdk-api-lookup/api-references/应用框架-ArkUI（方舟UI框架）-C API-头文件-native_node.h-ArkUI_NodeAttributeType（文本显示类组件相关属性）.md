...
| 类型 | 说明 |
| --- | --- |
| .object | 文本布局管理器对象，参数类型为[ArkUI\_LayoutManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textlayoutmanager)。 |
...
| .value[2]?.i32 | 字体样式。可选。参数类型为[ArkUI\_FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_fontstyle)。默认值为ARKUI\_FONT\_STYLE\_NORMAL。 |
| ?.object | 字体配置。可选。参数类型为[OH\_ArkUI\_FontConfigs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-fontconfigs)。 |
...
| .value[2].i32 | 字体样式。参数类型为[ArkUI\_FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_fontstyle)。 |
| .object | 字体配置。参数类型为[OH\_ArkUI\_FontConfigs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-fontconfigs)。 |
...
| ?.object | 可选。文本字体粗细配置。参数类型为[OH\_ArkUI\_FontWeightConfigs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-fontweightconfigs)。 |
...
| .object | 文本字体粗细配置。参数类型为[OH\_ArkUI\_FontWeightConfigs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-fontweightconfigs)。 |
...
| .object | 表示 PixelMap 图片数据，参数类型为[ArkUI\_DrawableDescriptor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-drawabledescriptor)。  .object参数和.string参数二选一，不可同时设置。 |
...
| .size | 表示滤镜数组大小为5x4。 |
| .object | 颜色滤波器指针，参数类型为[OH\_Drawing\_ColorFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-colorfilter)。  .object和.size参数只能二选一，不可同时设置。 |
