...
| 名称 | 描述 |
| --- | --- |
| [uint32\_t OH\_NetStack\_CertVerification(const struct NetStack\_CertBlob \*cert, const struct NetStack\_CertBlob \*caCert)](/consumer/cn/doc/harmonyos-references/capi-net-ssl-c-h#oh_netstack_certverification) | 证书链校验接口。 |
| [int32\_t OH\_NetStack\_GetPinSetForHostName(const char \*hostname, NetStack\_CertificatePinning \*pin)](/consumer/cn/doc/harmonyos-references/capi-net-ssl-c-h#oh_netstack_getpinsetforhostname) | 获取证书锁定信息。 |
| [int32\_t OH\_NetStack\_GetCertificatesForHostName(const char \*hostname, NetStack\_Certificates \*certs)](/consumer/cn/doc/harmonyos-references/capi-net-ssl-c-h#oh_netstack_getcertificatesforhostname) | 获取证书信息。 |
| [void OH\_Netstack\_DestroyCertificatesContent(NetStack\_Certificates \*certs)](/consumer/cn/doc/harmonyos-references/capi-net-ssl-c-h#oh_netstack_destroycertificatescontent) | 释放证书内容。 |
| [int32\_t OH\_Netstack\_IsCleartextPermitted(bool \*isCleartextPermitted)](/consumer/cn/doc/harmonyos-references/capi-net-ssl-c-h#oh_netstack_iscleartextpermitted) | 整体明文HTTP是否允许。 |
| [int32\_t OH\_Netstack\_IsCleartextPermittedByHostName(const char \*hostname, bool \*isCleartextPermitted)](/consumer/cn/doc/harmonyos-references/capi-net-ssl-c-h#oh_netstack_iscleartextpermittedbyhostname) | 按域名明文HTTP是否允许。 |
| [int32\_t OH\_Netstack\_IsCleartextCfgByComponent(const char \*component, bool \*componentCfg)](/consumer/cn/doc/harmonyos-references/capi-net-ssl-c-h#oh_netstack_iscleartextcfgbycomponent) | 检查组件是否已配置开启明文HTTP拦截功能。 |
