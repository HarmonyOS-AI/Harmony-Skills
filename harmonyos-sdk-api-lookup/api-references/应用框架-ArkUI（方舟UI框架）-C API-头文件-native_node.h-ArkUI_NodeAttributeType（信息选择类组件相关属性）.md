...
| ?.object | 针对不同选择器类型有如下输入范式：  1：单列支持图片的选择器，输入结构体为[ARKUI\_TextPickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/kui-nativemodule-arkui-textpickerrangecontentarray)；  2：多列联动选择器，输入结构体为[ARKUI\_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ivemodule-arkui-textcascadepickerrangecontentarray)。 |
