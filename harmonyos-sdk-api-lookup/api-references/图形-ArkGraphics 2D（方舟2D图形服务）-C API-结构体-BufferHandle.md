...
| uint64\_t usage | 缓冲区内存的用途，按位标志位，取值具体可见[OH\_NativeBuffer\_Usage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-buffer-h#oh_nativebuffer_usage)枚举值。 |
