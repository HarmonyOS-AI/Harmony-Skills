...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | Array<number> | 是 | 需要获取截图的主窗口ID列表。可通过[window.getAllMainWindowInfo()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowgetallmainwindowinfo21)获取到主窗口windowId。当windowId为null、undefined、小于0、存在重复值或数量超过512个时，返回错误码401；当windowId大于0但不存在对应窗口时，返回undefined。 |
...
从API version 7开始支持，从API version 9开始废弃，参数id传入null或undefined时，可能会导致callback无法得到执行，建议使用[createWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowcreatewindow9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[createWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowcreatewindow9-1)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[createWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowcreatewindow9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[createWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowcreatewindow9-1)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[findWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowfindwindow9)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[getLastWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowgetlastwindow9)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[getLastWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowgetlastwindow9-1)替代。
...
从API version 8开始支持，从API version 9开始废弃，参数ctx传入null或undefined时，可能会导致callback无法得到执行，建议使用[getLastWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowgetlastwindow9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getLastWindow()](/consumer/cn/doc/harmonyos-references/arkts-apis-window-f#windowgetlastwindow9-1)替代。
