...
回调返回的信息为[BusinessError](/consumer/cn/doc/harmonyos-references/js-apis-base#businesserror)类型的信息。
...
错误参数为[BusinessError](/consumer/cn/doc/harmonyos-references/js-apis-base#businesserror)类型的信息。
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| err | [BusinessError](/consumer/cn/doc/harmonyos-references/js-apis-base#businesserror) | 是 | 接口调用失败的公共错误信息。 |
| data | T | 是 | 接口调用时的公共回调信息。 |
