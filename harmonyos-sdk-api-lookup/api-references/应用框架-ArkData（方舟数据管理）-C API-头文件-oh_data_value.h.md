...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_ColumnType](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_columntype) | OH\_ColumnType | 表示列的类型。 |
...
| 名称 | 描述 |
| --- | --- |
| [OH\_Data\_Value \*OH\_Value\_Create(void)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_create) | 创建[OH\_Data\_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-data-value)实例，用于储存单条键值对数据。 |
| [int OH\_Value\_Destroy(OH\_Data\_Value \*value)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_destroy) | 销毁[OH\_Data\_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-data-value)对象。 |
| [int OH\_Value\_PutNull(OH\_Data\_Value \*value)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_putnull) | 添加空数据。 |
| [int OH\_Value\_PutInt(OH\_Data\_Value \*value, int64\_t val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_putint) | 添加整型数据。 |
| [int OH\_Value\_PutReal(OH\_Data\_Value \*value, double val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_putreal) | 添加REAL类型数据。 |
| [int OH\_Value\_PutText(OH\_Data\_Value \*value, const char \*val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_puttext) | 添加字符串类型数据。 |
| [int OH\_Value\_PutBlob(OH\_Data\_Value \*value, const unsigned char \*val, size\_t length)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_putblob) | 添加BLOB类型数据。 |
| [int OH\_Value\_PutAsset(OH\_Data\_Value \*value, const Data\_Asset \*val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_putasset) | 添加ASSET类型数据。 |
| [int OH\_Value\_PutAssets(OH\_Data\_Value \*value, const Data\_Asset \* const \* val, size\_t length)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_putassets) | 添加ASSETS类型数据。 |
| [int OH\_Value\_PutFloatVector(OH\_Data\_Value \*value, const float \*val, size\_t length)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_putfloatvector) | 添加float数组类型数据。 |
| [int OH\_Value\_PutUnlimitedInt(OH\_Data\_Value \*value, int sign, const uint64\_t \*trueForm, size\_t length)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_putunlimitedint) | 添加任意长度的整型数组数据。 |
| [int OH\_Value\_GetType(OH\_Data\_Value \*value, OH\_ColumnType \*type)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_gettype) | 获取数据类型。 |
| [int OH\_Value\_IsNull(OH\_Data\_Value \*value, bool \*val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_isnull) | 检查数据是否为空。 |
| [int OH\_Value\_GetInt(OH\_Data\_Value \*value, int64\_t \*val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getint) | 获取整型数据。 |
| [int OH\_Value\_GetReal(OH\_Data\_Value \*value, double \*val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getreal) | 获取REAL类型数据。 |
| [int OH\_Value\_GetText(OH\_Data\_Value \*value, const char \*\*val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_gettext) | 获取字符串类型数据。 |
| [int OH\_Value\_GetBlob(OH\_Data\_Value \*value, const uint8\_t \*\*val, size\_t \*length)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getblob) | 获取BLOB类型数据。 |
| [int OH\_Value\_GetAsset(OH\_Data\_Value \*value, Data\_Asset \*val)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getasset) | 获取ASSET类型数据。 |
| [int OH\_Value\_GetAssetsCount(OH\_Data\_Value \*value, size\_t \*length)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getassetscount) | 获取ASSETS类型数据的大小。 |
| [int OH\_Value\_GetAssets(OH\_Data\_Value \*value, Data\_Asset \*\*val, size\_t inLen, size\_t \*outLen)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getassets) | 获取ASSETS类型数据。 |
| [int OH\_Value\_GetFloatVectorCount(OH\_Data\_Value \*value, size\_t \*length)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getfloatvectorcount) | 获取float数组类型数据的大小。 |
| [int OH\_Value\_GetFloatVector(OH\_Data\_Value \*value, float \*val, size\_t inLen, size\_t \*outLen)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getfloatvector) | 获取float数组类型数据。 |
| [int OH\_Value\_GetUnlimitedIntBand(OH\_Data\_Value \*value, size\_t \*length)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getunlimitedintband) | 获取任意长度的整型数据的大小。 |
| [int OH\_Value\_GetUnlimitedInt(OH\_Data\_Value \*value, int \*sign, uint64\_t \*trueForm, size\_t inLen, size\_t \*outLen)](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_getunlimitedint) | 获取任意长度的整型数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Data\_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-data-value) | 执行成功时返回指向[OH\_Data\_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-data-value)实例的指针。否则返回nullptr。  使用完成后，必须通过[OH\_Value\_Destroy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_value_destroy)接口释放内存。 |
...
| --- | --- |
| [OH\_Data\_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-data-value) \*value | 表示指向[OH\_Data\_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-data-value)实例的指针。 |
| [OH\_ColumnType](/consumer/cn/doc/harmonyos-references/capi-oh-data-value-h#oh_columntype) \*type | 一个输出参数，表示数据类型。 |
