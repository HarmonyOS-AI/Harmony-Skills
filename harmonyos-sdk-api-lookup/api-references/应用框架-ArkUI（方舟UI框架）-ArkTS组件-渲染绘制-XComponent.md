...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [NativeXComponentParameters](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#nativexcomponentparameters19) | 是 | 定义XComponent的具体配置参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [XComponentOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#xcomponentoptions12) | 是 | 定义XComponent的具体配置参数。 |
...
| controller | [XComponentController](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#xcomponentcontroller) | 否 | 给组件绑定一个控制器，通过控制器调用组件方法，仅类型为SURFACE或TEXTURE时有效。 |
...
| controller | [XComponentController](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#xcomponentcontroller) | 否 | 给组件绑定一个控制器，通过控制器调用组件方法，仅XComponent类型为"surface"时有效。 |
...
| controller | [XComponentController](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#xcomponentcontroller) | 否 | 否 | 给组件绑定一个控制器，通过控制器调用组件方法，仅类型为SURFACE或TEXTURE时有效。 |
...
* 如果将参数type设置为[HdrType](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#hdrtype24枚举说明).AIHDR，调用该接口前需先检查[Display](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-display#display)的hdrFormats性是否包含[HDRFormat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hdrcapability#hdrformat).VIDEO\_AIHDR。仅当包含HDRFormat.VIDEO\_AIHDR时，当前设备才支持AI HDR类型，参数设置才会生效；否则按默认值HdrType.DEFAULT处理。
* 不支持[ArkUI NDK接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ndk-build-ui-overview)创建的XComponent组件。
...
| type | [HdrType](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#hdrtype24枚举说明) | 否 | 播放HDR视频时的HDR类型。  默认值: HdrType.DEFAULT |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNativeLoadCallback](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#onnativeloadcallback18) | 是 | XComponent持有的Surface创建后回调事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [SurfaceRect](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#surfacerect12对象说明) | 是 | XComponent持有Surface的显示区域。 |
...
| 类型 | 说明 |
| --- | --- |
| [SurfaceRect](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#surfacerect12对象说明) | 获取XComponent持有Surface的显示区域。 |
...
| --- | --- | --- | --- |
| surfaceId | string | 是 | 回调该方法的时候，绑定XComponent持有Surface的ID。 |
| rect | [SurfaceRect](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#surfacerect12对象说明) | 是 | 回调该方法的时候，绑定XComponent持有Surface的显示区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotationOptions | [SurfaceRotationOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#surfacerotationoptions12对象说明) | 是 | 设置XComponent持有Surface在屏幕旋转时是否锁定方向。 |
...
| 类型 | 说明 |
| --- | --- |
| Required<[SurfaceRotationOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#surfacerotationoptions12对象说明)> | 获取XComponent持有Surface在屏幕旋转时是否锁定方向的设置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [SurfaceConfig](/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#surfaceconfig22对象说明) | 是 | Surface选项。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/zurhkMaST-yJT5oM5BTn6A/zh-cn_image_0000002568759670.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035502Z&HW-CC-Expire=86400&HW-CC-Sign=190AFC3B5700472963247CE0EAB3822DD3F896943D060164C7169E2388E0000C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/htLfrkUuRw6Z83WHqQ1Uyw/zh-cn_image_0000002599358913.png?HW-CC-KV=V1&HW-CC-Date=20260511T035502Z&HW-CC-Expire=86400&HW-CC-Sign=F572C62FD4E53ED3F457824D05D9BD22741A93F12B303639B09D5FAE855CA5E0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/RnIp4aEcTayi5CH_OIycIQ/zh-cn_image_0000002568919318.jpeg?HW-CC-KV=V1&HW-CC-Date=20260511T035502Z&HW-CC-Expire=86400&HW-CC-Sign=7BAB6EAFB28878F048D421E9C4F317F2B80A32B0DBA43DE95210E1538F675A16)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/hLZvJOdKQzGAZTcbUVKsng/zh-cn_image_0000002599478863.jpeg?HW-CC-KV=V1&HW-CC-Date=20260511T035502Z&HW-CC-Expire=86400&HW-CC-Sign=DC308310963AF2343C455F0370910986165ECED7DD4017C379C135473A7BD471)