...
从API version 8支持，从API version 9开始废弃，建议使用[hidebug.startJsCpuProfiling](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebugstartjscpuprofiling9)替代。
...
从API version 8支持，从API version 9开始废弃，建议使用[hidebug.stopJsCpuProfiling](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebugstopjscpuprofiling9)替代。
...
从API version 8支持，从API version 9开始废弃，建议使用[hidebug.dumpJsHeapData](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebugdumpjsheapdata9)替代。
...
| 类型 | 说明 |
| --- | --- |
| [VMMemoryInfo](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#vmmemoryinfo12) | 返回VM内存信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [ThreadCpuUsage](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#threadcpuusage12)[] | 返回当前应用进程下所有ThreadCpuUsage数组。 |
...
startAppTraceCapture()方法的调用需要与'[stopAppTraceCapture()](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebugstopapptracecapture12)'方法的调用一一对应，重复开启trace采集将导致接口调用异常，由于trace采集过程中会消耗较多性能，开发者应在完成采集后及时关闭。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| tags | number[] | 是 | trace范围，详情请见[tags](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebugtags12)。 |
| flag | TraceFlag | 是 | 详情请见[TraceFlag](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#traceflag12)。 |
...
停止应用trace采集。调用前，需先调用'[startAppTraceCapture()](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebugstartapptracecapture12)'方法开始采集。关闭前未开启或重复关闭会导致接口异常。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [RequestTraceConfig](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#requesttraceconfig24) | 是 | trace采集配置信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [MemoryLimit](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#memorylimit12) | 应用程序进程内存限制。 |
...
由于读取/proc/{pid}/smaps\_rollup耗时较长，推荐使用异步接口[hidebug.getAppNativeMemInfoAsync](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebuggetappnativememinfoasync20)，以避免应用丢帧或卡顿。

推荐使用[hidebug.getRssInfo](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebuggetrssinfo24)接口获取应用的rss使用信息
...
| 类型 | 说明 |
| --- | --- |
| [NativeMemInfo](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#nativememinfo12) | 应用进程内存信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[NativeMemInfo](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#nativememinfo12)> | promise对象，返回应用进程内存信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [SystemMemInfo](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#systemmeminfo12) | 系统内存信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [GcStats](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#gcstats12) | 系统GC统计信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rssLimit | bigint | 否 | 否 | 应用程序进程可用的物理内存限制，以KB为单位，实际当前系统未对进程可用物理内存做限制，但是进程的可用物理内存仍然不会超过设备的实际最大可用物理内存，当前设备的物理内存使用情况可通过[hidebug.getSystemMemInfo](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebuggetsystemmeminfo12)获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[GraphicsMemorySummary](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#graphicsmemorysummary21)> | promise对象，返回应用显存数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [GwpAsanOptions](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#gwpasanoptions20) | 否 | GWP-ASan配置项。未设置时，使用默认参数。 |
...
停止使能GWP-ASan。调用该接口将取消自定义配置，恢复默认参数[GwpAsanOptions](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#gwpasanoptions20)。
...
该接口影响[dumpJsRawHeapData](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebugdumpjsrawheapdata18)的结果。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| level | [JsRawHeapTrimLevel](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#jsrawheaptrimlevel20) | 是 | 转储堆快照的裁剪级别，默认为TRIM\_LEVEL\_1。 |
...
该接口不影响其他场景下转储的堆快照内容。如：不会影响[dumpJsRawHeapData](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebugdumpjsrawheapdata18)的结果。
...
读取/proc/{pid}/status耗时很短，与[hidebug.getAppNativeMemInfo](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#hidebuggetappnativememinfo12)接口中获取的rss值相比存在一点误差，但该接口更加轻量，为避免应用丢帧或卡顿推荐使用该接口。
...
| 类型 | 说明 |
| --- | --- |
| [RssInfo](/consumer/cn/doc/harmonyos-references/js-apis-hidebug#rssinfo24) | 应用进程的物理内存信息。 |
