...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state | [DownloadState](/consumer/cn/doc/harmonyos-references/js-apis-file-cloudsyncmanager#downloadstate20) | 否 | 否 | 下载任务的状态。 |
...
| stopReason | [DownloadStopReason](/consumer/cn/doc/harmonyos-references/js-apis-file-cloudsyncmanager#downloadstopreason20) | 否 | 否 | 下载停止的原因。 |
