...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [JSVM\_PropertyAttributes](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_propertyattributes) | JSVM\_PropertyAttributes | 用于控制JavaScript对象属性的行为。 |
| [JSVM\_ValueType](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_valuetype) | JSVM\_ValueType | 描述JSVM\_Value的类型。 |
| [JSVM\_TypedarrayType](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_typedarraytype) | JSVM\_TypedarrayType | 描述TypedArray的类型。 |
| [JSVM\_Status](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | JSVM\_Status | 表示JSVM-API调用成功或失败的完整状态码。 |
| [JSVM\_KeyCollectionMode](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_keycollectionmode) | JSVM\_KeyCollectionMode | 限制查找属性的范围。 |
| [JSVM\_KeyFilter](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_keyfilter) | JSVM\_KeyFilter | 属性过滤器，可以通过使用or来构造一个复合过滤器。 |
| [JSVM\_KeyConversion](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_keyconversion) | JSVM\_KeyConversion | 键转换选项。 |
| [JSVM\_MemoryPressureLevel](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_memorypressurelevel) | JSVM\_MemoryPressureLevel | 内存压力水平。 |
| [JSVM\_CompileMode](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_compilemode) | JSVM\_CompileMode | JSVM编译模式。 |
| [JSVM\_CompileOptionId](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_compileoptionid) | JSVM\_CompileOptionId | JSVM编译选项ID。 |
| [JSVM\_RegExpFlags](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_regexpflags) | JSVM\_RegExpFlags | 正则表达式标志位。它们可以用来启用一组标志。 |
| [JSVM\_InitializedFlag](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_initializedflag) | JSVM\_InitializedFlag | 初始化方式的标志位。 |
| [JSVM\_WasmOptLevel](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_wasmoptlevel) | JSVM\_WasmOptLevel | WebAssembly 函数优化等级。 |
| [JSVM\_CacheType](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_cachetype) | JSVM\_CacheType | 缓存类型。 |
| [JSVM\_MicrotaskPolicy](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_microtaskpolicy) | JSVM\_MicrotaskPolicy | JSVM 微任务执行策略。 |
| [JSVM\_TraceCategory](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_tracecategory) | JSVM\_TraceCategory | JSVM 内部 Trace 事件的类别。 |
| [JSVM\_CBTriggerTimeForGC](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_cbtriggertimeforgc) | JSVM\_CBTriggerTimeForGC | 触发回调函数的时机。 |
| [JSVM\_GCType](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_gctype) | JSVM\_GCType | GC类型。 |
| [JSVM\_GCCallbackFlags](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_gccallbackflags) | JSVM\_GCCallbackFlags | GC回调函数标记。 |
| [JSVM\_PromiseRejectEvent](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_promiserejectevent) | JSVM\_PromiseRejectEvent | promise-reject事件。 |
| [JSVM\_MessageErrorLevel](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_messageerrorlevel) | JSVM\_MessageErrorLevel | message的报错级别。 |
| [JSVM\_DefineClassOptionsId](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_defineclassoptionsid) | JSVM\_DefineClassOptionsId | 定义Class的选项ID。 |
| [JSVM\_DebugOption](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_debugoption) | JSVM\_DebugOption | 调试选项。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (JSVM\_CDECL\* JSVM\_Finalize)(JSVM\_Env env,void\* finalizeData,void\* finalizeHint)](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_finalize) | JSVM\_CDECL\* JSVM\_Finalize | 函数指针类型，当native类型对象或数据与JS对象被关联时，传入该指针。该函数将会在关联的JS对象被GC回收时被调用，用以执行native的清理动作。 |
| [typedef bool (JSVM\_CDECL\* JSVM\_OutputStream)(const char\* data,int size,void\* streamData)](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_outputstream) | JSVM\_CDECL\* JSVM\_OutputStream | ASCII输出流回调的函数指针类型。参数data是指输出的数据指针。参数size是指输出的数据大小。空数据指针指示流的结尾。参数streamData是指与回调一起传递给API函数的指针，该API函数向输出流生成数据。 |
| [typedef void (JSVM\_CDECL\* JSVM\_HandlerForGC)(JSVM\_VM vm, JSVM\_GCType gcType, JSVM\_GCCallbackFlags flags, void\* data)](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforgc) | JSVM\_CDECL\* JSVM\_HandlerForGC | GC回调的函数指针类型。 |
| [typedef void (JSVM\_CDECL\* JSVM\_HandlerForOOMError)(const char\* location,const char\* detail,bool isHeapOOM)](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforoomerror) | JSVM\_CDECL\* JSVM\_HandlerForOOMError | OOM-Error回调的函数指针类型。 |
| [typedef void (JSVM\_CDECL\* JSVM\_HandlerForFatalError)(const char\* location,const char\* message)](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforfatalerror) | JSVM\_CDECL\* JSVM\_HandlerForFatalError | Fatal-Error回调的函数指针类型。 |
| [typedef void (JSVM\_CDECL\* JSVM\_HandlerForPromiseReject)(JSVM\_Env env, JSVM\_PromiseRejectEvent rejectEvent, JSVM\_Value rejectInfo)](/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforpromisereject) | JSVM\_CDECL\* JSVM\_HandlerForPromiseReject | Promise-Reject回调的函数指针类型。 |
