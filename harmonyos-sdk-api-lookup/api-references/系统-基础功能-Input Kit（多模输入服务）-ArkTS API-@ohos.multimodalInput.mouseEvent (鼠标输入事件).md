...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| axis | [Axis](/consumer/cn/doc/harmonyos-references/js-apis-mouseevent#axis) | 否 | 否 | 鼠标轴类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| action | [Action](/consumer/cn/doc/harmonyos-references/js-apis-mouseevent#action) | 否 | 否 | 鼠标事件类型。 |
...
| button | [Button](/consumer/cn/doc/harmonyos-references/js-apis-mouseevent#button) | 否 | 否 | 鼠标按键。 |
| pressedButtons | [Button](/consumer/cn/doc/harmonyos-references/js-apis-mouseevent#button)[] | 否 | 否 | 当前处于按下状态的鼠标按键。 |
| axes | [AxisValue](/consumer/cn/doc/harmonyos-references/js-apis-mouseevent#axisvalue)[] | 否 | 否 | 鼠标轴类型和轴的值。 |
...
| toolType11+ | [ToolType](/consumer/cn/doc/harmonyos-references/js-apis-mouseevent#tooltype11) | 否 | 否 | 工具类型。 |
