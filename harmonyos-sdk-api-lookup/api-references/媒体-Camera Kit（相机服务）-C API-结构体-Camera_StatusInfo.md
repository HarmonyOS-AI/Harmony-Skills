...
```
1. typedef struct Camera_StatusInfo {...} Camera_StatusInfo
```
...
| [Camera\_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_status) status | 当前相机状态。 |