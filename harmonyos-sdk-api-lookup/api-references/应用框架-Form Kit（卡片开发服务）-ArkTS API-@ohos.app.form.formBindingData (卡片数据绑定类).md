...
| proxies10+ | Array<[ProxyData](/consumer/cn/doc/harmonyos-references/js-apis-app-form-formbindingdata#proxydata10)> | 否 | 是 | 卡片代理刷新的订阅信息，默认为空数组。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 类型 | 说明 |
| --- | --- |
| [FormBindingData](/consumer/cn/doc/harmonyos-references/js-apis-app-form-formbindingdata#formbindingdata) | 根据传入数据创建的FormBindingData对象。 |
