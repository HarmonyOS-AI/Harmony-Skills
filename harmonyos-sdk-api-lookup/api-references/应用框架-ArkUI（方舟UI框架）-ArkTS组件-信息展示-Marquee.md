...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [MarqueeOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-marquee#marqueeoptions18对象说明)18+ | 是 | 配置跑马灯组件的参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | 是 | 是否允许文本缩放。  true：允许文本缩放；false：不允许文本缩放。  默认值：false  **说明：**  仅当[fontSize](/consumer/cn/doc/harmonyos-references/ts-basic-components-marquee#fontsize)为fp单位时生效。 |
...
该示例通过设置[MarqueeOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-marquee#marqueeoptions18对象说明)的start、step、loop、fromStart、src、spacing、delay属性和[marqueeUpdateStrategy](/consumer/cn/doc/harmonyos-references/ts-basic-components-marquee#marqueeupdatestrategy12)展示了跑马灯内容动态更新时运行的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/uEj-ASj1T_OvpZq7UO17JQ/zh-cn_image_0000002599358805.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035320Z&HW-CC-Expire=86400&HW-CC-Sign=91700372AD30AA7DC21B7520E0F62A39D68EEC8F991C6DE1FB45531DB9391CDC)