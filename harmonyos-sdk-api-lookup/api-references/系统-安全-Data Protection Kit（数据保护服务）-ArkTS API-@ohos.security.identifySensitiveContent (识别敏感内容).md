识别敏感内容功能的实现是通过输入的[扫描策略](/consumer/cn/doc/harmonyos-references/js-apis-identifysensitivecontent#policy)来检测指定文件中的敏感信息。
...
| identifyPolicies | Array<[Policy](/consumer/cn/doc/harmonyos-references/js-apis-identifysensitivecontent#policy)> | 是 | 识别的策略。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[MatchResult](/consumer/cn/doc/harmonyos-references/js-apis-identifysensitivecontent#matchresult)>> | Promise对象。返回敏感内容识别的结果。 |
