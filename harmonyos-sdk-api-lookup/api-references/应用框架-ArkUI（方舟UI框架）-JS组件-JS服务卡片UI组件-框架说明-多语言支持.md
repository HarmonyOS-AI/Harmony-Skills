...
开发者仅需要通过[定义资源文件](/consumer/cn/doc/harmonyos-references/js-service-widget-multiple-languages#定义资源文件)和[引用资源](/consumer/cn/doc/harmonyos-references/js-service-widget-multiple-languages#引用资源)两个步骤，就可以使用开发框架的多语言能力。
