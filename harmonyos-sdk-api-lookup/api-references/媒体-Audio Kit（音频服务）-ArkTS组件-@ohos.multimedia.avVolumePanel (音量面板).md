...
| volumeParameter | [AVVolumePanelParameter](/consumer/cn/doc/harmonyos-references/ohos-multimedia-avvolumepanel#avvolumepanelparameter) | 否 | @Prop | 设置音量面板的自定义参数。  如果不设置该参数，则为系统音量条。 |
