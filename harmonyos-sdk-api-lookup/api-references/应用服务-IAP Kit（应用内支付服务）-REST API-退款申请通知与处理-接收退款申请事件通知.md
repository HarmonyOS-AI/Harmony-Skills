...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/nsSdTC31T_2N3UN0HiIcrQ/zh-cn_image_0000002599479745.png?HW-CC-KV=V1&HW-CC-Date=20260511T062513Z&HW-CC-Expire=86400&HW-CC-Sign=D40337EF59B1AC9AC435E23A09CDDCC248F2865F3FFA20BEF6FD1A7238892A98)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| jwsNotification | 是 | String | 通知内容信息，对通知内容NotificationPayload签名后的字符串。具体请参见表[NotificationPayload](/consumer/cn/doc/harmonyos-references/iap-server-refund-receive-notify#notificationpayload)。  需要参见[对返回结果验签](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-verifying-signature)使用JWS签名方式对NotificationPayload消息体进行验签。 |
...
| notificationMetaData | 是 | Object | 通知元数据，具体请参见表[NotificationMetaData](/consumer/cn/doc/harmonyos-references/iap-server-refund-receive-notify#notificationmetadata)说明。 |
...
| refundRequestData | 是 | [RefundRequestData](/consumer/cn/doc/harmonyos-references/iap-server-refund-receive-notify#refundrequestdata) | 具体退款申请信息。 |
...
| refundOrders | 是 | List<[RefundOrder](/consumer/cn/doc/harmonyos-references/iap-server-refund-receive-notify#refundorder)> | 退款申请工单下的订单号，当前仅游戏应用场景支持多笔订单。 |
