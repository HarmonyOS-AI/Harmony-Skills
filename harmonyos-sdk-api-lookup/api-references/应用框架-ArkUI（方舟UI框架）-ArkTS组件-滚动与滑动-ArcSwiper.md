...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | [ArcSwiperController](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#arcswipercontroller) | 否 | 给组件绑定一个控制器，用来控制组件翻页。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | Optional<[ArcDotIndicator](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#arcdotindicator) | boolean> | 是 | 弧形圆点指示器样式。  - ArcDotIndicator：弧形圆点指示器属性及功能。  - boolean：是否启用弧形圆点指示器。设置为true启用，false不启用。  默认值：true  默认类型：ArcDotIndicator |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [FinishAnimationHandler](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#finishanimationhandler) | 否 | 动画结束的回调。  默认值：不传入的情况，无回调 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| direction | Optional<[ArcDirection](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#arcdirection-1)> | 是 | 设置弧形指示器的方向。  默认值：ArcDirection.SIX\_CLOCK\_DIRECTION，6点钟方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArcDotIndicator](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#arcdotindicator) | 提供弧形圆点指示器属性及功能。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | Optional<[IndexChangedHandler](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#indexchangedhandler)> | 是 | 当前显示元素的索引回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | Optional<[AnimationStartHandler](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#animationstarthandler)> | 是 | 切换动画开始时的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | Optional<[AnimationEndHandler](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#animationendhandler)> | 是 | 切换动画结束时触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | Optional<[GestureSwipeHandler](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#gestureswipehandler)> | 是 | 在页面跟手滑动过程中，逐帧触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transition | Optional<[SwiperContentAnimatedTransition](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#swipercontentanimatedtransition)> | 是 | ArcSwiper自定义切换动画相关信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| timeout | number | 否 | 是 | ArcSwiper自定义切换动画超时时间。从页面执行默认动画（页面滑动）至移出视窗外的第一帧开始计时，如果到达该时间后，开发者仍未调用[SwiperContentTransitionProxy](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#swipercontenttransitionproxy)的[finishTransition](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#finishtransition)接口通知ArcSwiper组件此页面的自定义动画已结束，那么组件就会认为此页面的自定义动画已结束，立即在该页面节点下渲染树。单位ms，默认值为0。 |
| transition | Callback<[SwiperContentTransitionProxy](/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#swipercontenttransitionproxy)> | 否 | 否 | 自定义切换动画具体内容。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/8JRavLkZRymTNcuVN_UImQ/zh-cn_image_0000002568759294.gif?HW-CC-KV=V1&HW-CC-Date=20260511T034937Z&HW-CC-Expire=86400&HW-CC-Sign=3F6C4CE10671C6E4A7E6EBC0F776828EA747CD899ACEB8314ADAC8E90DF46371)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/Fq85jekdS3-z_pT-iUeFyA/zh-cn_image_0000002599358537.gif?HW-CC-KV=V1&HW-CC-Date=20260511T034937Z&HW-CC-Expire=86400&HW-CC-Sign=CA30345A73432818AF774909B3BD9D5B267501AE59026730105B8C5881662D2D)