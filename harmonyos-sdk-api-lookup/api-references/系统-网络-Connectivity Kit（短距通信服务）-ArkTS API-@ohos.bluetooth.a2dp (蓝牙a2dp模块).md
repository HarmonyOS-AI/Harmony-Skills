...
| 类型 | 说明 |
| --- | --- |
| [A2dpSourceProfile](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#a2dpsourceprofile) | 返回蓝牙媒体音频源实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [PlayingState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#playingstate) | 蓝牙媒体音频播放状态。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| codecType | [CodecType](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codectype11) | 否 | 否 | 编解码器类型，默认值为CODEC\_TYPE\_SBC。 |
| codecBitsPerSample | [CodecBitsPerSample](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecbitspersample11) | 否 | 否 | 每个采样点的位深，默认值为CODEC\_BITS\_PER\_SAMPLE\_NONE。 |
| codecChannelMode | [CodecChannelMode](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecchannelmode11) | 否 | 否 | 编解码器的声道模式，默认值为CODEC\_CHANNEL\_MODE\_NONE。 |
| codecSampleRate | [CodecSampleRate](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecsamplerate11) | 否 | 否 | 编解码器的采样率，默认值为CODEC\_SAMPLE\_RATE\_NONE。 |
| codecBitRate19+ | [CodecBitRate](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecbitrate19) | 否 | 是 | 编解码器的码率，默认值为CODEC\_BIT\_RATE\_ABR。 |
| codecFrameLength19+ | [CodecFrameLength](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecframelength19) | 否 | 是 | 编解码器的帧长，默认值为CODEC\_FRAME\_LENGTH\_10MS。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| codecType | [CodecType](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codectype11) | 否 | 否 | 编解码器类型。 |
| codecBitsPerSampleArray | [CodecBitsPerSample](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecbitspersample11)[] | 否 | 否 | 编解码器支持的位深能力集合。 |
| codecChannelModeArray | [CodecChannelMode](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecchannelmode11)[] | 否 | 否 | 编解码器支持的声道模式能力集合。 |
| codecSampleRateArray | [CodecSampleRate](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecsamplerate11)[] | 否 | 否 | 编解码器支持的采样率能力集合。 |
| codecBitRateArray | [CodecBitRate](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecbitrate19)[] | 否 | 否 | 编解码器支持的码率能力集合。 |
| codecFrameLengthArray | [CodecFrameLength](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-a2dp#codecframelength19)[] | 否 | 否 | 编解码器支持的帧长能力集合。 |
