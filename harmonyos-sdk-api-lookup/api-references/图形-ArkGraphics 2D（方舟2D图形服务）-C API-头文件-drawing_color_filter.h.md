...
| 名称 | 描述 |
| --- | --- |
| [OH\_Drawing\_ColorFilter\* OH\_Drawing\_ColorFilterCreateBlendMode(uint32\_t color, OH\_Drawing\_BlendMode blendMode)](/consumer/cn/doc/harmonyos-references/capi-drawing-color-filter-h#oh_drawing_colorfiltercreateblendmode) | 创建具有混合模式的颜色滤波器。 |
| [OH\_Drawing\_ColorFilter\* OH\_Drawing\_ColorFilterCreateCompose(OH\_Drawing\_ColorFilter\* outerColorFilter,OH\_Drawing\_ColorFilter\* innerColorFilter)](/consumer/cn/doc/harmonyos-references/capi-drawing-color-filter-h#oh_drawing_colorfiltercreatecompose) | 将两个颜色滤波器合成一个新的颜色滤波器。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-error-code-h#oh_drawing_errorcodeget)查看错误码的取值。  outerColorFilter、innerColorFilter任意一个为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [OH\_Drawing\_ColorFilter\* OH\_Drawing\_ColorFilterCreateMatrix(const float matrix[20])](/consumer/cn/doc/harmonyos-references/capi-drawing-color-filter-h#oh_drawing_colorfiltercreatematrix) | 创建具有5x4颜色矩阵的颜色滤波器。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-error-code-h#oh_drawing_errorcodeget)查看错误码的取值。  matrix为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [OH\_Drawing\_ColorFilter\* OH\_Drawing\_ColorFilterCreateLinearToSrgbGamma(void)](/consumer/cn/doc/harmonyos-references/capi-drawing-color-filter-h#oh_drawing_colorfiltercreatelineartosrgbgamma) | 创建一个从线性颜色空间转换到SRGB颜色空间的颜色滤波器。 |
| [OH\_Drawing\_ColorFilter\* OH\_Drawing\_ColorFilterCreateSrgbGammaToLinear(void)](/consumer/cn/doc/harmonyos-references/capi-drawing-color-filter-h#oh_drawing_colorfiltercreatesrgbgammatolinear) | 创建颜色滤波器将RGB颜色通道应用于SRGB的伽玛曲线。 |
| [OH\_Drawing\_ColorFilter\* OH\_Drawing\_ColorFilterCreateLuma(void)](/consumer/cn/doc/harmonyos-references/capi-drawing-color-filter-h#oh_drawing_colorfiltercreateluma) | 创建一个颜色滤波器将其输入的亮度值乘以透明度通道，并将红色、绿色和蓝色通道设置为零。 |
| [OH\_Drawing\_ColorFilter\* OH\_Drawing\_ColorFilterCreateLighting(uint32\_t mulColor, uint32\_t addColor)](/consumer/cn/doc/harmonyos-references/capi-drawing-color-filter-h#oh_drawing_colorfiltercreatelighting) | 创建一个光照颜色滤波器，此滤波器会将RGB通道的颜色值乘以一种颜色值并加上另一种颜色值，计算结果会被限制在0到255范围内。 |
| [void OH\_Drawing\_ColorFilterDestroy(OH\_Drawing\_ColorFilter\* colorFilter)](/consumer/cn/doc/harmonyos-references/capi-drawing-color-filter-h#oh_drawing_colorfilterdestroy) | 销毁颜色滤波器对象，并回收该对象占用的内存。 |
