...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ffrt\_queue\_priority\_t](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_queue_priority_t) | ffrt\_queue\_priority\_t | 任务的优先级类型。 |
| [ffrt\_qos\_default\_t](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_qos_default_t) | ffrt\_qos\_default\_t | 任务的QoS类型。 |
| [ffrt\_storage\_size\_t](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_storage_size_t) | ffrt\_storage\_size\_t | 多种类型数据结构分配大小定义。 |
| [ffrt\_function\_kind\_t](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_function_kind_t) | ffrt\_function\_kind\_t | 任务类型。 |
| [ffrt\_dependence\_type\_t](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_dependence_type_t) | ffrt\_dependence\_type\_t | 依赖类型。 |
| [ffrt\_error\_t](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_error_t) | ffrt\_error\_t | FFRT错误码。 |
| [ffrt\_mutex\_type](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_mutex_type) | ffrt\_mutex\_type | 互斥锁类型枚举。描述互斥类型，ffrt\_mutex\_normal是普通互斥锁；ffrt\_mutex\_recursive是递归互斥锁，ffrt\_mutex\_default是普通互斥锁。 |
| [qos\_default](/consumer/cn/doc/harmonyos-references/capi-type-def-h#qos_default) | - | 任务QoS类型枚举。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void(\*ffrt\_function\_t)(void\*)](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_function_t) | ffrt\_function\_t | 任务执行函数指针类型。 |
| [typedef void (\*ffrt\_poller\_cb)(void\* data, uint32\_t event)](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_poller_cb) | ffrt\_poller\_cb | poller回调函数定义。 |
| [typedef void (\*ffrt\_timer\_cb)(void\* data)](/consumer/cn/doc/harmonyos-references/capi-type-def-h#ffrt_timer_cb) | ffrt\_timer\_cb | timer回调函数定义。 |
