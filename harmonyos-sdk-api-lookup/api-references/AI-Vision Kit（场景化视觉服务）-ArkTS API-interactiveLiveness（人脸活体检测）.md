...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| isSilentMode | [DetectionMode](/consumer/cn/doc/harmonyos-references/vision-interactive-liveness#detectionmode) | 否 | 否 | 表示的是人脸活体检测模式，默认动作活体检测模式。  INTERACTIVE\_MODE表示动作活体检测模式。 |
| actionsNum | [ActionsNumber](/consumer/cn/doc/harmonyos-references/vision-interactive-liveness#actionsnumber) | 否 | 是 | 表示动作活体检测的动作数量，数量范围3或4个，默认3个动作。随机生成，规则如下：  当actionsNum=3时，[眨眼，注视]组合中的动作元素不会同时存在并且相邻的动作元素不会相同。  当actionsNum=4时，眨眼动作元素有且仅有1次，注视动作元素最多出现1次，[眨眼，注视]组合中的动作元素不会相邻，相邻的动作元素不会相同。  该参数只有当isSilentMode是INTERACTIVE\_MODE的时候有效。 |
...
| routeMode | [RouteRedirectionMode](/consumer/cn/doc/harmonyos-references/vision-interactive-liveness#routeredirectionmode) | 否 | 是 | 人脸活体检测完成后跳转模式，默认REPLACE\_MODE模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [InteractiveLivenessConfig](/consumer/cn/doc/harmonyos-references/vision-interactive-liveness#interactivelivenessconfig) | 是 | 跳转到人脸活体检测页面的配置项 |
...
| --- | --- | --- | --- |
| config | [InteractiveLivenessConfig](/consumer/cn/doc/harmonyos-references/vision-interactive-liveness#interactivelivenessconfig) | 是 | 跳转到人脸活体检测页面的配置项。 |
| callback | [AsyncCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#asynccallback)<[InteractiveLivenessResult](/consumer/cn/doc/harmonyos-references/vision-interactive-liveness#interactivelivenessresult) | undefined> | 是 | 回调函数。当人脸活体检测成功，err为undefined，data为获取到的InteractiveLivenessResult；否则为错误对象。当前只适用于RouteRedirectionMode.BACK\_MODE跳转模式。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| livenessType | [LivenessType](/consumer/cn/doc/harmonyos-references/vision-interactive-liveness#livenesstype) | 否 | 否 | 活体检测模式。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[InteractiveLivenessResult](/consumer/cn/doc/harmonyos-references/vision-interactive-liveness#interactivelivenessresult)> | Promise对象，返回人脸活体检测的结果。 |
