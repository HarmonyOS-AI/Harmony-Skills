...
| status | [AssetStatus](/consumer/cn/doc/harmonyos-references/js-apis-data-commontype#assetstatus) | 否 | 是 | 资产的状态，默认值为ASSET\_NORMAL。 |
...
表示[Asset](/consumer/cn/doc/harmonyos-references/js-apis-data-commontype#asset)类型的数组。
...
| 类型 | 说明 |
| --- | --- |
| Array<[Asset](/consumer/cn/doc/harmonyos-references/js-apis-data-commontype#asset)> | 表示Asset类型的数组。 |
...
| Asset | 表示值类型为附件[Asset](/consumer/cn/doc/harmonyos-references/js-apis-data-commontype#asset)。 |
| Assets | 表示值类型为附件数组[Assets](/consumer/cn/doc/harmonyos-references/js-apis-data-commontype#assets)。 |
...
| 类型 | 说明 |
| --- | --- |
| Record<string, [ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-commontype#valuetype)> | 表示键值对类型。键的类型为string，值的类型为[ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-commontype#valuetype)。 |