...
| 类型 | 说明 |
| --- | --- |
| Promise<[AddressInfo](/consumer/cn/doc/harmonyos-references/account-choose-address#addressinfo)> | Promise对象，返回[AddressInfo](/consumer/cn/doc/harmonyos-references/account-choose-address#addressinfo)对象可以获取收货地址的详细信息。 |
