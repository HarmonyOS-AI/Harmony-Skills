...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [AVSession\_Type](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_type) | AVSession\_Type | 会话类型枚举。 |
| [AVSession\_PlaybackState](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_playbackstate) | AVSession\_PlaybackState | 媒体播放状态的相关属性枚举。 |
| [AVSession\_LoopMode](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_loopmode) | AVSession\_LoopMode | 定义媒体播放循环模式。 |
| [AVSession\_ControlCommand](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_controlcommand) | AVSession\_ControlCommand | 播控命令枚举。 |
| [AVMetadata\_SkipIntervals](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avmetadata_skipintervals) | AVMetadata\_SkipIntervals | 定义快进或快退的时间间隔。 |
| [AVMetadata\_DisplayTag](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avmetadata_displaytag) | AVMetadata\_DisplayTag | 当前媒体资源的金标枚举，即应用媒体音源的特殊类型标识。 |
| [AVSession\_ConnectionState](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_connectionstate) | AVSession\_ConnectionState | 设备连接状态枚举。 |
| [AVSession\_AVCastCategory](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_avcastcategory) | AVSession\_AVCastCategory | 表示不同播放场景的投播类别枚举。 |
| [AVSession\_DeviceType](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_devicetype) | AVSession\_DeviceType | 设备类型枚举。 |
| [AVSession\_ProtocolType](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_protocoltype) | AVSession\_ProtocolType | 协议类型枚举。 |
| [AVSession\_AVCastControlCommandType](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_avcastcontrolcommandtype) | AVSession\_AVCastControlCommandType | 命令类型枚举。 |
| [AVSession\_PlaybackSpeed](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_playbackspeed) | AVSession\_PlaybackSpeed | 播放倍速类型枚举。 |
| [AVSession\_PlaybackFilter](/consumer/cn/doc/harmonyos-references/capi-native-avsession-base-h#avsession_playbackfilter) | AVSession\_PlaybackFilter | 播放状态过滤器枚举。 |
