...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CloudOptions](/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#cloudoptions) | 否 | 设置初始化参数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| region | [CloudRegion](/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#cloudregion) | 否 | 是 | 存储地，默认为CHINA。 |
| authProvider | [AuthProvider](/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#authprovider) | 否 | 是 | 认证提供方。 |
| functionOptions | [FunctionOptions](/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#functionoptions) | 否 | 是 | 云函数初始化设置。 |
| storageOptions | [StorageOptions](/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#storageoptions) | 否 | 是 | 云存储初始化设置。 |
| databaseOptions | [DatabaseOptions](/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#databaseoptions) | 否 | 是 | 云数据库初始化设置。 |
