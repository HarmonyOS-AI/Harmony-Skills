...
* 事件回调函数中通过参数可以携带额外的信息，如组件上的数据对象[dataSet](/consumer/cn/doc/harmonyos-references/js-components-common-events#target对象6)、事件特有的回调参数。
...
| target12+ | [Target](/consumer/cn/doc/harmonyos-references/js-components-common-events#target对象6) | 触发该事件的目标对象。 |
...
| dataTransfer9+ | [DataTransfer](/consumer/cn/doc/harmonyos-references/js-components-common-events#datatransfer对象9) | 用于传输数据。 |
