...
| 类型 | 说明 |
| --- | --- |
| number | 以Long形式返回指定列的值。  该接口支持的数据范围是：Number.MIN\_SAFE\_INTEGER ~ Number.MAX\_SAFE\_INTEGER，若超出该范围，建议使用[getDouble](/consumer/cn/doc/harmonyos-references/js-apis-data-resultset#getdouble)。 |
