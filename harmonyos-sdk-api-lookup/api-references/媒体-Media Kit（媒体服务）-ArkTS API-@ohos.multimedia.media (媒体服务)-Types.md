...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [AVPlayerState](/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#avplayerstate9) | 是 | 当前播放状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [AVRecorderState](/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#avrecorderstate9) | 是 | 当前录制状态。 |
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVPlayerState](/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#avplayerstate9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayerState](/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#avplayerstate9)替代。
