...
| fill | string | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | number | 否 | 填充至新缓存区的值，默认值：0。 |
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferencoding) | 否 | 编码格式（当fill为string时，才有意义）。默认值：'utf8'。 |
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 返回一个Buffer对象。 |
...
创建的Buffer内容未知，需要使用[fill](/consumer/cn/doc/harmonyos-references/js-apis-buffer#fill)函数来初始化Buffer对象。
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 未初始化的Buffer实例。 |
...
创建的Buffer的内容未知，需要使用[fill](/consumer/cn/doc/harmonyos-references/js-apis-buffer#fill)函数来初始化Buffer对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| string | string | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | TypedArray | DataView | ArrayBuffer | SharedArrayBuffer | 是 | 指定字符串。 |
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferencoding) | 否 | 编码格式。默认值：'utf8'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| buf1 | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | 是 | 待比较数组。 |
| buf2 | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | 是 | 待比较数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| list | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer)[] | Uint8Array[] | 是 | 实例数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 返回新的Buffer对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 新的Buffer对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 返回一个Buffer对象，该对象与入参对象arrayBuffer共享相同的内存区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| buffer | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | 是 | 对象数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | 是 | 实例对象。 |
| fromEnc | string | 是 | 当前编码。 支持的格式范围为[BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferencoding)。 |
| toEnc | string | 是 | 目标编码。 支持的格式范围为[BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferencoding)。 |
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 将当前编码转换成目标编码，并返回一个新的Buffer对象。 |
...
| byteOffset | number | 是 | 否 | 当前Buffer所在内存池的偏移量。  - 当Buffer通过内存池创建时（如使用[allocUninitializedFromPool](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferallocuninitializedfrompool)创建Buffer，或使用buffer.from()传入字符串，且字符串长度加当前内存池偏移量小于4kb），返回相对于内存池的偏移量。  - 当Buffer直接分配内存时（如使用[alloc](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferalloc)），返回值为0。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| target | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | 是 | 要比较的实例对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| target | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | 是 | 要复制到的Buffer或Uint8Array实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| otherBuffer | Uint8Array | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 是 | 比较的目标对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | number | 是 | 用于填充的值。 |
| offset | number | 否 | 起始偏移量。默认值：0。 |
| end | number | 否 | 结束偏移量（不包含结束位置）。 默认值：当前对象的字节长度。 |
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferencoding) | 否 | 字符编码格式（value为string才有意义）。默认值：'utf8'。 |
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 返回填充后的Buffer对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | number | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | 是 | 要搜索的内容。 |
| byteOffset | number | 否 | 字节偏移量。如果为负数，则从末尾开始计算偏移量。默认值：0。 |
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferencoding) | 否 | 字符编码格式。默认值：'utf8'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | number | [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | Uint8Array | 是 | 要查找的内容。 |
| byteOffset | number | 否 | 字节偏移量。如果为负数，则从末尾开始计算偏移量。默认值：0。 |
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-buffer#bufferencoding) | 否 | 字符编码格式。默认值：'utf8'。 |
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 返回新的Buffer对象。当start < 0或end < 0时返回空Buffer。 |
...
| 类型 | 说明 |
| --- | --- |
| [Buffer](/consumer/cn/doc/harmonyos-references/js-apis-buffer#buffer) | 交换之后的Buffer对象。 |
