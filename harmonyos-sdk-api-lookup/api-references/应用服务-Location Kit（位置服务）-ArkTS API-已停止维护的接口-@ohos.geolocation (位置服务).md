...
应用如需使用ohos.permission.LOCATION\_IN\_BACKGROUND权限，需要在设置界面由用户手动授予，具体授权方式可参考[ohos.permission.LOCATION\_IN\_BACKGROUND权限说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionlocation_in_background)。
...
| request | [LocationRequest](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestdeprecated) | 是 | 设置位置请求参数。 |
| callback | Callback<[Location](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationdeprecated)> | 是 | 回调函数，返回位置信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置事件类型。type为“locationChange”，表示位置变化。 |
| callback | Callback<[Location](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationdeprecated)> | 否 | 需要取消订阅的回调函数。该回调函数需要与on接口传入的回调函数保持一致。若无此参数，则取消当前类型的所有订阅。 |
...
| request | [CachedGnssLocationsRequest](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#cachedgnsslocationsrequestdeprecated) | 是 | GNSS缓存功能配置参数。 |
| callback | Callback<Array<[Location](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationdeprecated)>> | 是 | 回调函数，返回GNSS缓存位置。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置事件类型。type为“cachedGnssLocationsReporting”，表示GNSS缓存定位结果上报。 |
| callback | Callback<Array<[Location](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationdeprecated)>> | 否 | 需要取消订阅的回调函数。该回调函数需要与on接口传入的回调函数保持一致。若无此参数，则取消当前类型的所有订阅。 |
...
| callback | Callback<[SatelliteStatusInfo](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#satellitestatusinfodeprecated)> | 是 | 回调函数，返回GNSS卫星状态信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置事件类型。type为“gnssStatusChange”，表示订阅GNSS卫星状态信息上报。 |
| callback | Callback<[SatelliteStatusInfo](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#satellitestatusinfodeprecated)> | 否 | 需要取消订阅的回调函数。该回调函数需要与on接口传入的回调函数保持一致。若无此参数，则取消当前类型的所有订阅。 |
...
| request | [GeofenceRequest](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#geofencerequestdeprecated) | 是 | 围栏的配置参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [CurrentLocationRequest](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#currentlocationrequestdeprecated) | 是 | 设置位置请求参数。 |
| callback | AsyncCallback<[Location](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationdeprecated)> | 是 | 回调函数，返回当前位置信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [CurrentLocationRequest](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#currentlocationrequestdeprecated) | 否 | 设置位置请求参数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Location](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationdeprecated)> | Promise对象，返回当前位置信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[Location](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationdeprecated)> | 是 | 回调函数，返回上次位置信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Location](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationdeprecated)> | Promise对象，返回上次位置信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [ReverseGeoCodeRequest](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#reversegeocoderequestdeprecated) | 是 | 设置逆地理编码请求的相关参数。 |
| callback | AsyncCallback<Array<[GeoAddress](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#geoaddressdeprecated)>> | 是 | 回调函数，返回逆地理编码结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[GeoAddress](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#geoaddressdeprecated)>> | Promise对象，返回地理描述信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [GeoCodeRequest](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#geocoderequestdeprecated) | 是 | 设置地理编码请求的相关参数。 |
| callback | AsyncCallback<Array<[GeoAddress](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#geoaddressdeprecated)>> | 是 | 回调函数，返回地理编码结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[GeoAddress](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#geoaddressdeprecated)>> | Promise对象，返回地理编码查询结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| command | [LocationCommand](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationcommanddeprecated) | 是 | 指定目标场景，和将要发送的命令（字符串）。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| priority | [LocationRequestPriority](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestprioritydeprecated) | 否 | 是 | 表示优先级信息。取值范围见[LocationRequestPriority](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestprioritydeprecated)的定义。 |
| scenario | [LocationRequestScenario](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestscenariodeprecated) | 否 | 是 | 表示场景信息。取值范围见[LocationRequestScenario](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestscenariodeprecated)的定义。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| priority | [LocationRequestPriority](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestprioritydeprecated) | 否 | 否 | 表示位置信息优先级。 |
| scenario | [LocationRequestScenario](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestscenariodeprecated) | 否 | 否 | 表示定位场景。 |
| geofence | [Geofence](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#geofencedeprecated) | 否 | 否 | 表示围栏信息。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| UNSET | 0x200 | 表示未设置优先级，表示[LocationRequestPriority](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestprioritydeprecated)无效。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| UNSET | 0x300 | 表示未设置场景信息。  表示[LocationRequestScenario](/consumer/cn/doc/harmonyos-references/js-apis-geolocation#locationrequestscenariodeprecated)字段无效。 |
