...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_CryptoSymKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-cryptosymkeyapi-oh-cryptosymkey) | OH\_CryptoSymKey | 定义对称密钥结构体。 |
...
| 名称 | 描述 |
| --- | --- |
| [OH\_Crypto\_ErrCode OH\_CryptoSymKeyGenerator\_Create(const char \*algoName, OH\_CryptoSymKeyGenerator \*\*ctx)](/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkeygenerator_create) | 根据给定的算法名称创建对称密钥生成器。  注意：创建的资源必须通过[OH\_CryptoSymKeyGenerator\_Destroy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkeygenerator_destroy)销毁。 |
| [OH\_Crypto\_ErrCode OH\_CryptoSymKeyGenerator\_Generate(OH\_CryptoSymKeyGenerator \*ctx, OH\_CryptoSymKey \*\*keyCtx)](/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkeygenerator_generate) | 随机生成对称密钥。  注意：使用完成后必须通过[OH\_CryptoSymKey\_Destroy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkey_destroy)销毁keyCtx内存。 |
| [OH\_Crypto\_ErrCode OH\_CryptoSymKeyGenerator\_Convert(OH\_CryptoSymKeyGenerator \*ctx, const Crypto\_DataBlob \*keyData, OH\_CryptoSymKey \*\*keyCtx)](/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkeygenerator_convert) | 将对称密钥数据转换为对称密钥。  注意：使用完成后必须通过[OH\_CryptoSymKey\_Destroy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkey_destroy)销毁keyCtx内存。 |
| [const char \*OH\_CryptoSymKeyGenerator\_GetAlgoName(OH\_CryptoSymKeyGenerator \*ctx)](/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkeygenerator_getalgoname) | 获取对称密钥生成器的算法名称。 |
| [void OH\_CryptoSymKeyGenerator\_Destroy(OH\_CryptoSymKeyGenerator \*ctx)](/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkeygenerator_destroy) | 销毁对称密钥生成器。 |
| [const char \*OH\_CryptoSymKey\_GetAlgoName(OH\_CryptoSymKey \*keyCtx)](/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkey_getalgoname) | 从对称密钥获取对称密钥算法名称。 |
| [OH\_Crypto\_ErrCode OH\_CryptoSymKey\_GetKeyData(OH\_CryptoSymKey \*keyCtx, Crypto\_DataBlob \*out)](/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkey_getkeydata) | 从密钥实例获取对称密钥数据。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-common-h#oh_crypto_freedatablob)释放out内存。 |
| [void OH\_CryptoSymKey\_Destroy(OH\_CryptoSymKey \*keyCtx)](/consumer/cn/doc/harmonyos-references/capi-crypto-sym-key-h#oh_cryptosymkey_destroy) | 销毁对称密钥实例。 |
