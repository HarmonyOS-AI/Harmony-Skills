...
| 名称 | 描述 |
| --- | --- |
| [AudioChannelSet](/consumer/cn/doc/harmonyos-references/capi-avcodec-audio-channel-layout-h#audiochannelset) | 音频声道数集合，将每一个声道数映射为int64的变量。(API11废弃) |
| [AudioChannelLayout](/consumer/cn/doc/harmonyos-references/capi-avcodec-audio-channel-layout-h#audiochannellayout) | 音频声道数类型，将用户申请的解码器输出格式表示为编解码器的声道类型。(API11废弃) |
