...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_DisplaySoloist\_FrameCallback)(long long timestamp, long long targetTimestamp, void\* data)](/consumer/cn/doc/harmonyos-references/capi-native-display-soloist-h#oh_displaysoloist_framecallback) | OH\_DisplaySoloist\_FrameCallback | OH\_DisplaySoloist回调函数类型。 |
| [OH\_DisplaySoloist\* OH\_DisplaySoloist\_Create(bool useExclusiveThread)](/consumer/cn/doc/harmonyos-references/capi-native-display-soloist-h#oh_displaysoloist_create) | - | 创建一个OH\_DisplaySoloist实例，每次调用都会产生一个新的实例。 |
| [int32\_t OH\_DisplaySoloist\_Destroy(OH\_DisplaySoloist\* displaySoloist)](/consumer/cn/doc/harmonyos-references/capi-native-display-soloist-h#oh_displaysoloist_destroy) | - | 销毁OH\_DisplaySoloist实例并回收对象占用的内存。 |
| [int32\_t OH\_DisplaySoloist\_Start(OH\_DisplaySoloist\* displaySoloist, OH\_DisplaySoloist\_FrameCallback callback, void\* data)](/consumer/cn/doc/harmonyos-references/capi-native-display-soloist-h#oh_displaysoloist_start) | - | 设置每帧回调函数，每次VSync信号到来时启动每帧回调。 |
| [int32\_t OH\_DisplaySoloist\_Stop(OH\_DisplaySoloist\* displaySoloist)](/consumer/cn/doc/harmonyos-references/capi-native-display-soloist-h#oh_displaysoloist_stop) | - | 停止请求下一次VSync信号，并停止调用回调函数callback。 |
| [int32\_t OH\_DisplaySoloist\_SetExpectedFrameRateRange(OH\_DisplaySoloist\* displaySoloist, DisplaySoloist\_ExpectedRateRange\* range)](/consumer/cn/doc/harmonyos-references/capi-native-display-soloist-h#oh_displaysoloist_setexpectedframeraterange) | - | 设置VSync期望帧率范围。 |
...
| --- | --- |
| [OH\_DisplaySoloist](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-nativedisplaysoloist-oh-displaysoloist)\* displaySoloist | 一个指向[OH\_DisplaySoloist](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-nativedisplaysoloist-oh-displaysoloist)实例的指针。 |
| [OH\_DisplaySoloist\_FrameCallback](/consumer/cn/doc/harmonyos-references/capi-native-display-soloist-h#oh_displaysoloist_framecallback) callback | 表示下一次VSync信号到来时执行的回调函数类型。 |
