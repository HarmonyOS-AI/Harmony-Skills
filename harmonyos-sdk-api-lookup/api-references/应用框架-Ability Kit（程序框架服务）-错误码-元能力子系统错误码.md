...
指定的[APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)不存在时，返回该错误码。

**可能原因**

应用的实例中不存在该[APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)指定的实例。

**处理步骤**

确保传入的[APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)是一个有效值。
...
[APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)和[CREATE\_APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)不支持同时指定。当指定[CREATE\_APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)的同时指定[APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)，返回该错误码。
...
参数[APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)和[CREATE\_APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)只支持二选一。
...
只允许应用使用[CREATE\_APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)创建自己的实例，不允许应用间启动时为其他应用创建实例。否则，返回该错误码。
...
删除参数[CREATE\_APP\_INSTANCE\_KEY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#params)。
