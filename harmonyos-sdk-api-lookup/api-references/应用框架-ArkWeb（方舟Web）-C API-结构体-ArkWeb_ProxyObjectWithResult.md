...
| const [ArkWeb\_ProxyMethodWithResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-web-arkweb-proxymethodwithresult)\* methodList | 注入的对象携带的方法结构体数组。 |
