...
设置[Tag.IS\_PERSISTENT](/consumer/cn/doc/harmonyos-references/js-apis-asset#tag)属性时，需要申请ohos.permission.STORE\_PERSISTENT\_DATA权限，申请方式请参考[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| attributes | [AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap) | 是 | 待新增关键资产的属性集合，包括关键资产明文、访问控制属性、自定义数据等。 |
...
如果要设置[Tag.IS\_PERSISTENT](/consumer/cn/doc/harmonyos-references/js-apis-asset#tag)属性，需要申请ohos.permission.STORE\_PERSISTENT\_DATA权限，申请方式请参考[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| query | [AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap) | 是 | 待删除关键资产的搜索条件，如别名、访问控制属性、自定义数据等。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| query | [AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap) | 是 | 待更新关键资产的搜索条件，如关键资产别名、访问控制属性、自定义数据等。 |
| attributesToUpdate | [AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap) | 是 | 待更新关键资产的属性集合，如关键资产明文、自定义数据等。 |
...
查询的预处理，用于需要用户认证的关键资产。在用户认证成功后，应当随后调用[asset.query](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetquery)和[asset.postQuery](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetpostquery)接口。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| query | [AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap) | 是 | 关键资产的查询条件，如别名、访问控制属性、自定义数据等。 |
...
查询的预处理，用于需要用户认证的关键资产。在用户认证成功后，应当随后调用[asset.querySync](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetquerysync12)、[asset.postQuerySync](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetpostquerysync12)。使用同步方式返回结果。
...
查询一条或多条符合条件的关键资产。若查询需要用户认证的关键资产，则需要在本函数前调用[asset.preQuery](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetprequery)接口，在本函数后调用[asset.postQuery](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetpostquery)接口，开发步骤请参考[开发指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-js-query-auth)。使用Promise异步回调。
...
查询一条或多条符合条件的关键资产。若查询需要用户认证的关键资产，则需要在本函数前调用[asset.preQuerySync](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetprequerysync12)，在本函数后调用[asset.postQuerySync](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetpostquerysync12)，开发步骤请参考[开发指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-js-query-auth)。使用同步方式返回结果。
...
查询的后置处理，用于需要用户认证的关键资产（与[asset.preQuery](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetprequery)函数成对出现）。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handle | [AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap) | 是 | 待处理的查询句柄，包含[asset.preQuery](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetprequery)执行成功返回的挑战值。 |
...
查询的后置处理，用于需要用户认证的关键资产。需与[asset.preQuerySync](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetprequerysync12)函数成对出现。使用同步方式返回结果。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handle | [AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap) | 是 | 待处理的查询句柄，包含[asset.preQuerySync](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetprequerysync12)执行成功返回的挑战值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| query | [AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap) | 是 | 同步结果查询条件，如关键资产所属群组、业务自定义属性信息是否加密。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[SyncResult](/consumer/cn/doc/harmonyos-references/js-apis-asset#syncresult20)> | Promise对象，返回同步执行结果。 |
...
枚举，关键资产支持的属性名称类型，用作[AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap)的键。
...
关键资产属性的内容，用作[AssetMap](/consumer/cn/doc/harmonyos-references/js-apis-asset#assetmap)的值。
...
| 类型 | 说明 |
| --- | --- |
| Map<Tag, Value> | 表示值类型是Map，键值对取值范围分别参考[Tag](/consumer/cn/doc/harmonyos-references/js-apis-asset#tag)和[Value](/consumer/cn/doc/harmonyos-references/js-apis-asset#value)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| resultCode | number | 是 | 否 | 关键资产同步的结果码。同步成功时结果码为0，同步失败时结果码参考[ErrorCode](/consumer/cn/doc/harmonyos-references/js-apis-asset#errorcode)。 |
