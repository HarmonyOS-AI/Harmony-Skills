...
* 本模块接口基于[CLDR](https://cldr.unicode.org)国际化数据库实现，随着CLDR标准的迭代演进，接口处理结果可能会相应调整。例如[数字格式化接口](/consumer/cn/doc/harmonyos-references/js-apis-intl#numberformat)，其返回值仅适用于界面展示场景，开发者请勿对返回格式进行硬编码或假设性判断，否则可能导致版本兼容问题。其中，API version 12 对应[CLDR 42](https://cldr.unicode.org/index/downloads/cldr-42)版本，具体数据变更详情可查阅[CLDR官方文档](https://cldr.unicode.org/)。
...
| hourCycle | string | 否 | 否 | 区域的时制信息，取值包括：  "h11"、"h12"、"h23"、"h24"。  不同取值的显示效果可参考[附录表5](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| options | [LocaleOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#localeoptionsdeprecated) | 否 | 创建区域对象的选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [Locale](/consumer/cn/doc/harmonyos-references/js-apis-intl#localedeprecated) | 补齐完脚本、国家地区信息后的区域对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Locale](/consumer/cn/doc/harmonyos-references/js-apis-intl#localedeprecated) | 移除完脚本、国家地区信息后的区域对象。 |
...
| options | [DateTimeOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#datetimeoptionsdeprecated) | 否 | 创建时间、日期格式化对象时可设置的配置项。  若所有选项均未设置时，year、month、day三个属性的默认值为numeric。 |
...
| 类型 | 说明 |
| --- | --- |
| [DateTimeOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#datetimeoptionsdeprecated) | 时间、日期格式化对象设置的配置项。 |
...
| dateStyle | string | 否 | 是 | 日期显示格式，取值包括：  "long", "short", "medium", "full", "auto"。  不同取值的显示效果请参考[附录表1](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| timeStyle | string | 否 | 是 | 时间显示格式，取值包括：  "long", "short", "medium", "full", "auto"。  不同取值的显示效果请参考[附录表2](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| hourCycle | string | 否 | 是 | 时制格式，取值包括：  "h11", "h12", "h23", "h24"。  不设置dateStyle或timeStyle参数时的显示效果请参考[附录表5](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。  设置dateStyle或timeStyle参数时的显示效果请参考[附录表6](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| weekday | string | 否 | 是 | 星期的显示格式，取值包括：  "long", "short", "narrow", "auto"。  不同取值的显示效果请参考[附录表4](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| era | string | 否 | 是 | 纪元的显示格式，取值包括：  "long", "short", "narrow", "auto"。  不同取值的显示效果请参考[附录表9](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| year | string | 否 | 是 | 年份的显示格式，取值包括：  "numeric", "2-digit"。  不同取值的显示效果请参考[附录表3](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| month | string | 否 | 是 | 月份的显示格式，取值包括：  "numeric", "2-digit", "long", "short", "narrow", "auto"。  不同取值的显示效果请参考[附录表7](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| timeZoneName | string | 否 | 是 | 时区名称的本地化表示，取值包括：  "long", "short", "auto"。  不同取值的显示效果请参考[附录表8](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| dayPeriod | string | 否 | 是 | 时段的显示格式，取值包括：  "long", "short", "narrow", "auto"。  不同取值的显示效果请参考[附录表10](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| --- | --- | --- | --- |
| locale | string | Array<string> | 是 | 区域ID或区域ID数组。输入是区域ID数组时，使用第一个有效的区域ID。 |
| options | [NumberOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#numberoptions) | 否 | 创建数字格式化对象时可设置的配置项。 |
...
| 类型 | 说明 |
| --- | --- |
| [NumberOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#numberoptions) | 创建数字格式化对象时设置的配置项。 |
...
| currencySign | string | 否 | 是 | 货币单位的符号显示，取值包括： "standard"，"accounting"。  默认值：standard。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表19](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| currencyDisplay | string | 否 | 是 | 货币的显示方式，取值包括："symbol", "narrowSymbol", "code", "name"。  默认值：symbol。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表20](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| unitDisplay | string | 否 | 是 | 单位的显示格式，取值包括："long", "short", "narrow"。  默认值：short。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表21](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| unitUsage8+ | string | 否 | 是 | 单位的使用场景，取值包括："default", "area-land-agricult", "area-land-commercl", "area-land-residntl", "length-person", "length-person-small", "length-rainfall", "length-road", "length-road-small", "length-snowfall", "length-vehicle", "length-visiblty", "length-visiblty-small", "length-person-informal", "length-person-small-informal", "length-road-informal", "speed-road-travel", "speed-wind", "temperature-person", "temperature-weather", "volume-vehicle-fuel", "elapsed-time-second", "size-file-byte", "size-shortfile-byte"。  默认值：default。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表22](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| compactDisplay | string | 否 | 是 | 紧凑显示格式，取值包括："long", "short"。  默认值：short。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表18](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| notation | string | 否 | 是 | 数字的表示方法，取值包括："standard", "scientific", "engineering", "compact"。  默认值：standard。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表17](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| useGrouping | boolean | 否 | 是 | true表示分组显示，false表示不分组显示。  默认值：true。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表16](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| minimumIntegerDigits | number | 否 | 是 | 表示要使用的最小整数位数，取值范围：1~21。  默认值：1。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表11](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| minimumFractionDigits | number | 否 | 是 | 表示要使用的最小分数位数，取值范围：0~20。  默认值：0。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表12](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| maximumFractionDigits | number | 否 | 是 | 表示要使用的最大分数位数，取值范围：1~21。  默认值：3。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表13](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| minimumSignificantDigits | number | 否 | 是 | 表示要使用的最小有效位数，取值范围：1~21。  默认值：1。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表14](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| maximumSignificantDigits | number | 否 | 是 | 表示要使用的最大有效位数，取值范围：1~21。  默认值：21。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  不同取值的显示效果请参考[附录表15](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| --- | --- | --- | --- |
| locale | string | Array<string> | 是 | 区域ID或区域ID数组。输入是区域ID数组时，使用第一个有效的区域ID。 |
| options | [CollatorOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#collatoroptions8) | 否 | 创建排序对象时可设置的配置项。 |
...
| 类型 | 说明 |
| --- | --- |
| [CollatorOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#collatoroptions8) | 返回排序对象的属性。 |
...
| --- | --- | --- | --- |
| locale | string | Array<string> | 是 | 区域ID或区域ID数组。输入是区域ID数组时，使用第一个有效的区域ID。 |
| options | [PluralRulesOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#pluralrulesoptionsdeprecated) | 否 | 创建单复数对象时设置的配置项。 |
...
| --- | --- | --- | --- |
| locale | string | Array<string> | 是 | 区域ID或区域ID数组。输入是区域ID数组时，使用第一个有效的区域ID。 |
| options | [RelativeTimeFormatInputOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#relativetimeformatinputoptionsdeprecated) | 否 | 创建相对时间格式化对象时可配置的选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [RelativeTimeFormatResolvedOptions](/consumer/cn/doc/harmonyos-references/js-apis-intl#relativetimeformatresolvedoptionsdeprecated) | 相对时间格式化对象的格式化配置项。 |
...
| numeric | string | 否 | 是 | 输出消息的格式，表示格式化结果中是否使用数字表示相对日期或时间。取值包括："always", "auto"。  默认值：always。  不同取值的显示效果请参考[附录表23](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| style | string | 否 | 是 | 国际化消息的长度，取值包括："long", "short", "narrow"。  默认值：long。  不同取值的显示效果请参考[附录表24](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
...
| numeric | string | 否 | 否 | 输出消息的格式，表示格式化结果中是否使用数字表示相对日期或时间。取值包括："always", "auto"。  不同取值的显示效果请参考[附录表23](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
| style | string | 否 | 否 | 国际化消息的长度，取值包括："long", "short", "narrow"。  不同取值的显示效果请参考[附录表24](/consumer/cn/doc/harmonyos-references/js-apis-intl#附录)。 |
