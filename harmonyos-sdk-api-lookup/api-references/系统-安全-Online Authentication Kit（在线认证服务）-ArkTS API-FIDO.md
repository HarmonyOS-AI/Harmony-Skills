...
| plte | Array<[RgbPaletteEntry](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#rgbpaletteentry)> | 否 | 是 | 调色板条目。默认值为空。 |
...
| supportedUAFVersions | Array<[Version](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#version)> | 是 | 否 | 认证器支持的UAF协议版本。 |
...
| tcDisplayPNGCharacteristics | Array<[DisplayPNGCharacteristicsDescriptor](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#displaypngcharacteristicsdescriptor)> | 是 | 否 | 交易确认显示支持的PNG集合。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| supportedUAFVersions | Array<[Version](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#version)> | 否 | 否 | 客户端支持的FIDO UAF协议版本列表。 |
| clientVendor | string | 否 | 否 | UAF客户端的供应商，CFCA长度为4个字符。 |
| clientVersion | [Version](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#version) | 否 | 否 | FIDO UAF客户端版本。 |
| availableAuthenticators | Array<[Authenticator](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#authenticator)> | 否 | 否 | 包含描述可使用UAF认证器的认证器结构数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[DiscoveryData](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#discoverydata)> | Promise对象。返回包含当前设备软件支持的认证器数据的对象。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context#context) | 是 | ability的context。 |
| uafRequest | [UAFMessage](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#uafmessage) | 是 | 需要检测的策略和操作。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context#context) | 是 | ability的context。 |
| uafRequest | [UAFMessage](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#uafmessage) | 是 | FIDO客户端软件使用的[UAFMessage](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#uafmessage)。 |
| channelBindings | [ChannelBinding](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#channelbinding) | 否 | 传输通道的绑定参数，用于验证通道安全性，默认为空。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[UAFMessage](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#uafmessage)> | Promise对象。返回包含签名后响应数据的UAFMessage消息对象。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context#context) | 是 | ability的context。 |
| uafResponse | [UAFMessage](/consumer/cn/doc/harmonyos-references/onlineauthentication-fido-api#uafmessage) | 是 | UAF响应消息。 |
