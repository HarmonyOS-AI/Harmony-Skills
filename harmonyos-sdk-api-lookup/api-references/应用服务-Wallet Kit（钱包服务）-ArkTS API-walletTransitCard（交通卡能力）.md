...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| specifiedDeviceType | [DeviceType](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#devicetype) | 是 | 指定设备的枚举值。 |
...
| 类型 | **说明** |
| --- | --- |
| Promise<[CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice)[]> | Promise对象，返回一个CardMetadataInDevice元数据数组，包含设备信息和卡的元数据。 |
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| logicalCardNumber | string | 是 | 指定卡的卡号，要求使用[getCardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#getcardmetadataindevice) 返回的 [CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice) 中的[CardMetadata](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadata) 对应的logicalCardNumber。 |
| specifiedDeviceId | string | 是 | 存在该卡的设备的ID，要求使用[getCardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#getcardmetadataindevice) 返回的[CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice) 对应的deviceId。 |
| callerToken | string | 否 | 小程序在微信、支付宝等中的鉴权token，要求使用JWT格式生成。 |
...
| 类型 | **说明** |
| --- | --- |
| Promise<[TransitCardInfo](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#transitcardinfo)> | Promise对象，返回cardNumber指定卡的详细信息。 |
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| issuerId | string | 是 | 城市的一种交通卡产品的ID，要求使用 [getCardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#getcardmetadataindevice) 返回的 [CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice)中的 [CardMetadata](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadata) 对应的issuerId。 |
| specifiedDeviceId | string | 是 | 存在该卡的设备的ID，要求使用 [getCardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#getcardmetadataindevice) 返回的 [CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice)对应的deviceId。 |
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| addCardOpaqueData | string | 是 | 开卡令牌，要求使用[canAddTransitCard](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#canaddtransitcard)接口返回的字符串。 |
...
| 类型 | **说明** |
| --- | --- |
| Promise<[CardMetadata](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadata)> | Promise对象，返回添加的卡片数据。 |
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| logicalCardNumber | string | 是 | 卡的序列号，要求使用[getCardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#getcardmetadataindevice)返回的[CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice)中的[CardMetadata](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadata)对应的logicalCardNumber。 |
| specifiedDeviceId | string | 是 | 存在该卡的设备的ID，要求使用[getCardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#getcardmetadataindevice)返回的[CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice)对应的deviceId。 |
...
| --- | --- | --- | --- |
| logicalCardNumber | string | 是 | 指定卡的卡号，要求使用[getCardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#getcardmetadataindevice)返回的[CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice)中的[CardMetadata](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadata)对应的logicalCardNumber。 |
| specifiedDeviceId | string | 是 | 卡所在的设备ID，要求使用[getCardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#getcardmetadataindevice)返回的[CardMetadataInDevice](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadataindevice)对应的deviceId。 |
...
| deviceType | [DeviceType](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#devicetype) | 否 | 否 | 设备的类型 |
| displayName | string | 否 | 否 | 要显示的设备名称 |
| cardMetadata | [CardMetadata](/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#cardmetadata)[] | 否 | 否 | 设备支持的卡的数据。 |
