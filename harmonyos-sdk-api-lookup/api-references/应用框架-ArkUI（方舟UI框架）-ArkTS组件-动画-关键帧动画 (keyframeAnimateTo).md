...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [KeyframeAnimateParam](/consumer/cn/doc/harmonyos-references/ts-keyframeanimateto#keyframeanimateparam对象说明) | 是 | 关键帧动画的整体动画参数。 |
| keyframes | Array<[KeyframeState](/consumer/cn/doc/harmonyos-references/ts-keyframeanimateto#keyframestate对象说明)> | 是 | 所有的关键帧状态。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/eLMSLVGxSM-QxlUc5fiegQ/zh-cn_image_0000002599358919.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035536Z&HW-CC-Expire=86400&HW-CC-Sign=D9B11972DEE8D20FBB2D2243963A49633246402073A43FDCB606AD0D96EFE85F)