...
| 类型 | 说明 |
| --- | --- |
| [DataSharePredicates](/consumer/cn/doc/harmonyos-references/js-apis-data-datasharepredicates#datasharepredicates) | 返回与指定字段匹配的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataSharePredicates](/consumer/cn/doc/harmonyos-references/js-apis-data-datasharepredicates#datasharepredicates) | 返回带有和条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataSharePredicates](/consumer/cn/doc/harmonyos-references/js-apis-data-datasharepredicates#datasharepredicates) | 返回带有左括号的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataSharePredicates](/consumer/cn/doc/harmonyos-references/js-apis-data-datasharepredicates#datasharepredicates) | 返回带有右括号的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataSharePredicates](/consumer/cn/doc/harmonyos-references/js-apis-data-datasharepredicates#datasharepredicates) | 返回带有或条件的谓词。 |
