...
| toolType | [ToolType](/consumer/cn/doc/harmonyos-references/js-apis-touchevent#tooltype) | 否 | 否 | 工具类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| action | [Action](/consumer/cn/doc/harmonyos-references/js-apis-touchevent#action) | 否 | 否 | 触屏输入事件类型。 |
| touch | [Touch](/consumer/cn/doc/harmonyos-references/js-apis-touchevent#touch) | 否 | 否 | 当前触屏点信息。 |
| touches | [Touch](/consumer/cn/doc/harmonyos-references/js-apis-touchevent#touch)[] | 否 | 否 | 所有触屏点。 |
| sourceType | [SourceType](/consumer/cn/doc/harmonyos-references/js-apis-touchevent#sourcetype) | 否 | 否 | 触屏来源的设备类型。 |