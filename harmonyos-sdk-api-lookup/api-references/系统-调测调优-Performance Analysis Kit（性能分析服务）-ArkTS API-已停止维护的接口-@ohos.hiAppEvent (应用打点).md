...
事件类型为[EventType](/consumer/cn/doc/harmonyos-references/js-apis-hiappevent#eventtype)枚举类型。
...
| eventType | [EventType](/consumer/cn/doc/harmonyos-references/js-apis-hiappevent#eventtype) | 是 | 事件类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ConfigOption](/consumer/cn/doc/harmonyos-references/js-apis-hiappevent#configoption) | 是 | 应用事件打点配置项对象。 |
