...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ProgressOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressoptions对象说明) | 是 | 按进度条类型不同，设置不同属性的进度条组件参数。 |
...
| type8+ | [ProgressType](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progresstype8枚举说明) | 否 | 是 | 指定进度条类型。  默认值：ProgressType.Linear  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **说明：** 不同的type需分别对应相应的[style](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#style8)属性设置，详细映射关系参考[ProgressStyleMap](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstylemap10对象说明)。 |
| style(deprecated) | [ProgressStyle](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyle枚举说明) | 否 | 是 | 指定进度条样式。  该参数从API version8开始废弃，建议使用type替代。  默认值：ProgressStyle.Linear |
...
| 名称 | 类型 |
| --- | --- |
| ProgressType.Linear | [LinearStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#linearstyleoptions10) | [ProgressStyleOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
| ProgressType.Ring | [RingStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#ringstyleoptions10) | [ProgressStyleOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
| ProgressType.Eclipse | [EclipseStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#eclipsestyleoptions10) | [ProgressStyleOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
| ProgressType.ScaleRing | [ScaleRingStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#scaleringstyleoptions10) | [ProgressStyleOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
| ProgressType.Capsule | [CapsuleStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#capsulestyleoptions10) | [ProgressStyleOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ProgressStyleOptions8+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) | [CapsuleStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#capsulestyleoptions10) |  [RingStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#ringstyleoptions10) | [LinearStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#linearstyleoptions10) |  [ScaleRingStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#scaleringstyleoptions10) | [EclipseStyleOptions10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#eclipsestyleoptions10) | 是 | 组件的样式。  - CapsuleStyleOptions：设置Capsule的样式。  - RingStyleOptions：设置Ring的样式。  - LinearStyleOptions：设置Linear的样式。  - ScaleRingStyleOptions：设置ScaleRing的样式。  - EclipseStyleOptions：设置Eclipse的样式。  - ProgressStyleOptions：仅可设置各类型进度条的strokeWidth、scaleCount、scaleWidth，仅对支持这些样式设置的进度条生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier<ProgressConfiguration>](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressconfiguration12) | 是 | 在progress组件上，定制内容区的方法。  modifier： 内容修改器，开发者需要自定义class实现ContentModifier接口。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| enableScanEffect | boolean | 否 | 是 | 扫光效果的开关。仅支持[Linear、Ring、Capsule](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progresstype8枚举说明)类型的进度条。  true：表示开启扫光效果。  false：表示关闭扫光效果。  默认值：false |
...
| status | [ProgressStatus10+](/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstatus10枚举说明) | 否 | 是 | 设置进度条状态。当设置为ProgressStatus.LOADING时会开启检查更新动效，此时设置进度值不生效。当从ProgressStatus.LOADING设置为ProgressStatus.PROGRESSING时，检查更新动效会执行到终点再停止。  默认值：ProgressStatus.PROGRESSING |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3