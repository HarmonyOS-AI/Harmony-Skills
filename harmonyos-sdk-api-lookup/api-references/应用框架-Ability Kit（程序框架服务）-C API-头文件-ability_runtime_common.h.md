...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [AbilityRuntime\_ErrorCode](/consumer/cn/doc/harmonyos-references/capi-ability-runtime-common-h#abilityruntime_errorcode) | AbilityRuntime\_ErrorCode | AbilityRuntime模块的错误码的枚举。 |
