...
| notificationHistory | 否 | List<Object> | 历史通知记录信息。具体请参见[NotificationHistory](/consumer/cn/doc/harmonyos-references/iap-server-notifications-record-query#notificationhistory)说明。 |
