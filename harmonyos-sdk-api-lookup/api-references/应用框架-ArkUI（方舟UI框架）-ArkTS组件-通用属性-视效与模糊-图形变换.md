...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [RotateOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#rotateoptions对象说明) | 是 | 可使组件在以组件左上角为坐标原点的[组件坐标系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkui-glossary#组件坐标系)中进行旋转（坐标系如下图所示）。其中，(x, y, z）指定一个矢量，作为旋转轴。  旋转轴和旋转中心点都基于坐标系设定，组件发生位移时，坐标系不会随之移动。  默认值: 在x、y、z都不指定时，x、y、z的默认值分别为0、0、1。指定了x、y、z任何一个值时，x、y、z中未指定的值默认为0。  {  centerX: '50%',  centerY: '50%',  centerZ: 0,  perspective: 0  }  单位：vp |
...
设置组件旋转。与[rotate](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#rotate)相比，options参数新增了对undefined类型的支持。
...
设置组件旋转效果。与[rotate](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#rotate18)相比，options参数新增了对RotateAngleOptions类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TranslateOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#translateoptions对象说明) | 是 | 可使组件在以组件左上角为坐标原点的[组件坐标系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkui-glossary#组件坐标系)中进行移动（坐标系如下图所示）。其中，x，y，z的值分别表示在对应轴移动的距离，值为正时表示向对应轴的正向移动，值为负时表示向对应轴的反向移动。移动距离支持数字和字符串（比如'10px'，'10%'）两种类型。  默认值:  {  x: 0,  y: 0,  z: 0  }  单位：vp    **说明：**  z轴方向移动时由于观察点位置不变，z的值接近观察点组件会有放大效果，远离则缩小。 |
...
设置组件平移。与[translate](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#translate)相比，translate参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ScaleOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#scaleoptions对象说明) | 是 | 可以分别设置X轴、Y轴、Z轴的缩放比例，默认值为1，同时可以通过centerX和centerY设置缩放的中心点。  默认值:  {  x: 1,  y: 1,  z: 1,  centerX:'50%',  centerY:'50%'  } |
...
设置组件缩放。与[scale](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#scale)相比，options参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[ScaleOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#scaleoptions对象说明)> | 是 | 可以分别设置X轴、Y轴、Z轴的缩放比例，默认值为1，同时可以通过centerX和centerY设置缩放的中心点。  默认值:  {  x: 1,  y: 1,  z: 1,  centerX:'50%',  centerY:'50%'  }  当options的值为undefined时，恢复为无缩放效果。 |
...
可用于显示二维变换时的矩阵变换。包含三维变换时应使用[transform3D](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#transform3d20)接口。
...
可用于显示二维变换时的矩阵变换。包含三维变换时应使用[transform3D](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#transform3d20)接口。与[transform](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#transform)相比，transform18+参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transform | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[Matrix4Transit](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#matrix4transit20)> | 是 | 三维变换矩阵。  当transform的值为undefined时，恢复为单位矩阵的效果。 |
...
当组件同时设置了[rotate](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#rotate)和[scale](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#scale)属性时，centerX和centerY的取值会发生冲突，此时centerX和centerY的值以最后设定的属性的值为准。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/-Ylf8bQsRM6quceDlpXivA/zh-cn_image_0000002568918802.png?HW-CC-KV=V1&HW-CC-Date=20260511T034510Z&HW-CC-Expire=86400&HW-CC-Sign=F56B52E3F8FC925A9D66DD4E34F6825D8C22B201BCBD69D36DBF3936A8C42DAF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/zmMg5sVoSz2NTeQTE8Y2mw/zh-cn_image_0000002599478347.gif?HW-CC-KV=V1&HW-CC-Date=20260511T034510Z&HW-CC-Expire=86400&HW-CC-Sign=CBF6EAAD880F064496464036A392FFC9644DBE5FF437C98FA060F94ACB643612)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/06/v3/6Eow5VdnQvG60feDt6-h9w/zh-cn_image_0000002568759156.png?HW-CC-KV=V1&HW-CC-Date=20260511T034510Z&HW-CC-Expire=86400&HW-CC-Sign=2FE391FF3F7E37E92379A3339F44CA36FDB306BA7C2029977B733B6C17D42225)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/oqUFyXtqQqa4z3iglao2bw/zh-cn_image_0000002599358399.png?HW-CC-KV=V1&HW-CC-Date=20260511T034510Z&HW-CC-Expire=86400&HW-CC-Sign=02291DD2CEA06DC3B191FCF56C5FAF3B157DA7BC1842A491F20DEC7753C04FF5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/0kKz_3esTUWHEfgOYFaG9w/zh-cn_image_0000002568918804.png?HW-CC-KV=V1&HW-CC-Date=20260511T034510Z&HW-CC-Expire=86400&HW-CC-Sign=21145170741F268CA7FA4735D957B3984EA58E4480CCC431F697027D74927F6A)