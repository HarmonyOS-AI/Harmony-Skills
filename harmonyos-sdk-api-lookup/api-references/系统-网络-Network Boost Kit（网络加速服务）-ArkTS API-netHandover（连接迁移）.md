...
| callback | Callback<[HandoverInfo](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#handoverinfo)> | 是 | 回调函数，返回连接迁移开始和完成的详细信息。 |
...
| callback | Callback<[HandoverInfo](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#handoverinfo)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [HandoverMode](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#handovermode) | 是 | 表示应用需要通知系统侧的迁移模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [MultiPathQuota](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathquota) | 应用配额信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[MultiPathRequestResult](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathrequestresult)> | 是 | 回调函数，返回发起多网的结果。 |
...
| callback | Callback<[MultiPathStateInfo](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathstateinfo)> | 是 | 回调函数，返回多网状态变化信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填写"multiPathStateChange"字符串，表示多网状态变化事件。 |
| callback | Callback<[MultiPathStateInfo](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathstateinfo)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback<[MultiPathRecommendationInfo](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathrecommendationinfo)> | 是 | 回调函数，返回多网建议变化信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填写"multiPathRecommendation"字符串，表示系统多网建议变化事件。 |
| callback | Callback<[MultiPathRecommendationInfo](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathrecommendationinfo)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| handoverStart | [HandoverStart](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#handoverstart) | 是 | 是 | 表示连接迁移开始信息。 |
| handoverComplete | [HandoverComplete](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#handovercomplete) | 是 | 是 | 表示连接迁移完成信息。 |
...
| dataSpeedAction | [DataSpeedAction](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#dataspeedaction) | 否 | 否 | 老链路的发包建议。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| result | [ErrorResult](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#errorresult) | 否 | 否 | 连接迁移结果。 |
...
| oldDataSpeedAction | [DataSpeedAction](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#dataspeedaction) | 否 | 否 | 老链路发包建议。 |
...
| reEstAction | [ReEstAction](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#reestaction) | 否 | 否 | 链路重建类型。 |
| newDataSpeedAction | [DataSpeedAction](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#dataspeedaction) | 否 | 否 | 新链路发包建议。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| multiPathState | [MultiPathState](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathstate) | 否 | 否 | 多网状态。 |
| cause | [MultiPathChangeCause](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathchangecause) | 否 | 否 | 多网状态变化原因。 |
...
| pathState | [PathState](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#pathstate) | 否 | 否 | 多网链路状态。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| action | [MultiPathAction](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathaction) | 否 | 否 | 多网推荐动作。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| used | [MultiPathQuotaInfo](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathquotainfo) | 是 | 否 | 应用已使用配额信息。 |
| remaining | [MultiPathQuotaInfo](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipathquotainfo) | 是 | 否 | 应用剩余使用配额信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| result | [MultiPathErrorResult](/consumer/cn/doc/harmonyos-references/networkboost-nethandover#multipatherrorresult) | 否 | 否 | 多网请求结果。 |
