...
| cause12+ | [DisconnectCause](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-baseprofile#disconnectcause12) | 否 | 否 | Profile断开连接的原因。 |
...
| callback | Callback<[StateChangeParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-baseprofile#statechangeparam)> | 是 | 指定订阅的回调函数，会携带Profile连接状态。 |
...
| callback | Callback<[StateChangeParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-baseprofile#statechangeparam)> | 否 | 指定取消订阅的回调函数通知。  若传参，则需与[BaseProfile.on('connectionStateChange')](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-baseprofile#baseprofileonconnectionstatechange)中的回调函数一致；若无传参，则取消订阅该type对应的所有回调函数通知。 |
