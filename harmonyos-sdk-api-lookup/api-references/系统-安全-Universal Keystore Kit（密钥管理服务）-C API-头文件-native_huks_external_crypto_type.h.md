...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Huks\_ExternalCryptoTag](/consumer/cn/doc/harmonyos-references/capi-native-huks-external-crypto-type-h#oh_huks_externalcryptotag) | OH\_Huks\_ExternalCryptoTag | 列举参数集合中使用的标签值。 |
