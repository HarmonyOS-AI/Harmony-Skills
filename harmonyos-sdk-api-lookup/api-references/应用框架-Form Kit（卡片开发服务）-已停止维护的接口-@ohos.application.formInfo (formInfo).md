...
| type | [FormType](/consumer/cn/doc/harmonyos-references/js-apis-application-forminfo#formtype) | 否 | 否 | 表示卡片类型，当前支持JS卡片。 |
| jsComponentName | string | 否 | 否 | 表示JS卡片的组件名。 |
| colorMode | [ColorMode](/consumer/cn/doc/harmonyos-references/js-apis-application-forminfo#colormode) | 否 | 否 | 表示卡片颜色模式。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| formState | [FormState](/consumer/cn/doc/harmonyos-references/js-apis-application-forminfo#formstate) | 否 | 否 | 表示卡片状态。 |
