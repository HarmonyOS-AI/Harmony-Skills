...
| callback | Callback<Array<[NetworkQos](/consumer/cn/doc/harmonyos-references/networkboost-netquality#networkqos)>> | 是 | 回调函数，返回网络Qos变化的详细信息。 |
...
| callback | Callback<Array<[NetworkQos](/consumer/cn/doc/harmonyos-references/networkboost-netquality#networkqos)>> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback<Array<[NetworkScene](/consumer/cn/doc/harmonyos-references/networkboost-netquality#networkscene)>> | 是 | 回调函数，返回网络场景变化的详细信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填写"netSceneChange"字符串，表示网络场景变化事件。 |
| callback | Callback<Array<[NetworkScene](/consumer/cn/doc/harmonyos-references/networkboost-netquality#networkscene)>> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appQoe | [AppQoe](/consumer/cn/doc/harmonyos-references/networkboost-netquality#appqoe) | 是 | 表示应用需要反馈的传输体验信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| serviceType | [ServiceType](/consumer/cn/doc/harmonyos-references/networkboost-netquality#servicetype) | 否 | 否 | 应用的业务类型。 |
| qoeType | [QoeType](/consumer/cn/doc/harmonyos-references/networkboost-netquality#qoetype) | 否 | 否 | 应用体验类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pathType | [PathType](/consumer/cn/doc/harmonyos-references/networkboost-netquality#pathtype) | 否 | 否 | 表明相应的数据路径上的网络质量信息。 |
| linkUpBandwidth | [RateBps](/consumer/cn/doc/harmonyos-references/networkboost-netquality#ratebps) | 否 | 否 | 上行带宽信息，单位为bps。 |
| linkDownBandwidth | [RateBps](/consumer/cn/doc/harmonyos-references/networkboost-netquality#ratebps) | 否 | 否 | 下行带宽信息，单位为bps。 |
| linkUpRate | [RateBps](/consumer/cn/doc/harmonyos-references/networkboost-netquality#ratebps) | 否 | 否 | 上行速率，单位为bps。 |
| linkDownRate | [RateBps](/consumer/cn/doc/harmonyos-references/networkboost-netquality#ratebps) | 否 | 否 | 下行速率，单位为bps。 |
...
| [BadQoeCause](/consumer/cn/doc/harmonyos-references/networkboost-netquality#badqoecause) | 表示体验差类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pathType | [PathType](/consumer/cn/doc/harmonyos-references/networkboost-netquality#pathtype) | 否 | 否 | 表明相应的数据路径上的网络场景信息。 |
| scene | [Scene](/consumer/cn/doc/harmonyos-references/networkboost-netquality#scene) | 否 | 否 | 场景状态。 |
| recommendedAction | [RecommendedAction](/consumer/cn/doc/harmonyos-references/networkboost-netquality#recommendedaction) | 否 | 否 | 建议的数传策略。 |
| weakSignalPrediction | [WeakSignalPrediction](/consumer/cn/doc/harmonyos-references/networkboost-netquality#weaksignalprediction) | 否 | 是 | 弱信号预测相关信息。 |
...
| [DataSpeedSimpleAction](/consumer/cn/doc/harmonyos-references/networkboost-netquality#dataspeedsimpleaction) | 应用发包策略的简单建议。 |