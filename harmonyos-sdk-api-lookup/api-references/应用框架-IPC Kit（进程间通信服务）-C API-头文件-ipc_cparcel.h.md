...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void\* (\*OH\_IPC\_MemAllocator)(int32\_t len)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipc_memallocator) | OH\_IPC\_MemAllocator | 内存分配函数类型。 |
| [OHIPCParcel\* OH\_IPCParcel\_Create(void)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_create) | - | 创建OHIPCParcel对象，对象可序列化大小不能超过204800字节。 |
| [void OH\_IPCParcel\_Destroy(OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_destroy) | - | 销毁OHIPCParcel对象。 |
| [int OH\_IPCParcel\_GetDataSize(const OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_getdatasize) | - | 获取OHIPCParcel对象包含的数据的大小。 |
| [int OH\_IPCParcel\_GetWritableBytes(const OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_getwritablebytes) | - | 获取OHIPCParcel对象可以写入的字节数。 |
| [int OH\_IPCParcel\_GetReadableBytes(const OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_getreadablebytes) | - | 获取OHIPCParcel对象还可以读取的字节数。 |
| [int OH\_IPCParcel\_GetReadPosition(const OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_getreadposition) | - | 获取OHIPCParcel对象当前读取位置。 |
| [int OH\_IPCParcel\_GetWritePosition(const OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_getwriteposition) | - | 获取OHIPCParcel对象当前写入位置。 |
| [int OH\_IPCParcel\_RewindReadPosition(OHIPCParcel \*parcel, uint32\_t newReadPos)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_rewindreadposition) | - | 重置OHIPCParcel对象读取位置。 |
| [int OH\_IPCParcel\_RewindWritePosition(OHIPCParcel \*parcel, uint32\_t newWritePos)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_rewindwriteposition) | - | 重置OHIPCParcel对象写入位置。 |
| [int OH\_IPCParcel\_WriteInt8(OHIPCParcel \*parcel, int8\_t value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writeint8) | - | 向OHIPCParcel对象写入一个int8\_t值。 |
| [int OH\_IPCParcel\_ReadInt8(const OHIPCParcel \*parcel, int8\_t \*value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readint8) | - | 从OHIPCParcel对象中读取一个int8\_t值。 |
| [int OH\_IPCParcel\_WriteInt16(OHIPCParcel \*parcel, int16\_t value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writeint16) | - | 向OHIPCParcel对象写入一个int16\_t值。 |
| [int OH\_IPCParcel\_ReadInt16(const OHIPCParcel \*parcel, int16\_t \*value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readint16) | - | 从OHIPCParcel对象中读取一个int16\_t值。 |
| [int OH\_IPCParcel\_WriteInt32(OHIPCParcel \*parcel, int32\_t value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writeint32) | - | 向OHIPCParcel对象写入一个int32\_t值。 |
| [int OH\_IPCParcel\_ReadInt32(const OHIPCParcel \*parcel, int32\_t \*value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readint32) | - | 从OHIPCParcel对象中读取一个int32\_t值。 |
| [int OH\_IPCParcel\_WriteInt64(OHIPCParcel \*parcel, int64\_t value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writeint64) | - | 向OHIPCParcel对象写入一个int64\_t值。 |
| [int OH\_IPCParcel\_ReadInt64(const OHIPCParcel \*parcel, int64\_t \*value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readint64) | - | 从OHIPCParcel对象中读取一个int64\_t值。 |
| [int OH\_IPCParcel\_WriteFloat(OHIPCParcel \*parcel, float value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writefloat) | - | 向OHIPCParcel对象写入一个float值。 |
| [int OH\_IPCParcel\_ReadFloat(const OHIPCParcel \*parcel, float \*value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readfloat) | - | 从OHIPCParcel对象中读取一个float值。 |
| [int OH\_IPCParcel\_WriteDouble(OHIPCParcel \*parcel, double value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writedouble) | - | 向OHIPCParcel对象写入一个double值。 |
| [int OH\_IPCParcel\_ReadDouble(const OHIPCParcel \*parcel, double \*value)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readdouble) | - | 从OHIPCParcel对象中读取一个double值。 |
| [int OH\_IPCParcel\_WriteString(OHIPCParcel \*parcel, const char \*str)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writestring) | - | 向OHIPCParcel对象写入字符串，包含字符串结束符。 |
| [const char\* OH\_IPCParcel\_ReadString(const OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readstring) | - | 从OHIPCParcel对象读取字符串，用户可通过strlen获取字符串长度。 |
| [int OH\_IPCParcel\_Writebuffer(OHIPCParcel \*parcel, const uint8\_t \*buffer, int32\_t len)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writebuffer) | - | 向OHIPCParcel对象写入指定长度的内存信息。 |
| [const uint8\_t\* OH\_IPCParcel\_ReadBuffer(const OHIPCParcel \*parcel, int32\_t len)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readbuffer) | - | 从OHIPCParcel对象读取指定长度的内存信息。 |
| [int OH\_IPCParcel\_WriteRemoteStub(OHIPCParcel \*parcel, const OHIPCRemoteStub \*stub)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writeremotestub) | - | 向OHIPCParcel对象写入OHIPCRemoteStub对象。 |
| [OHIPCRemoteStub\* OH\_IPCParcel\_ReadRemoteStub(const OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readremotestub) | - | 从OHIPCParcel对象读取OHIPCRemoteStub对象。 |
| [int OH\_IPCParcel\_WriteRemoteProxy(OHIPCParcel \*parcel, const OHIPCRemoteProxy \*proxy)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writeremoteproxy) | - | 向OHIPCParcel对象写入OHIPCRemoteProxy对象。 |
| [OHIPCRemoteProxy\* OH\_IPCParcel\_ReadRemoteProxy(const OHIPCParcel \*parcel)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readremoteproxy) | - | 从OHIPCParcel对象读取OHIPCRemoteProxy对象。 |
| [int OH\_IPCParcel\_WriteFileDescriptor(OHIPCParcel \*parcel, int32\_t fd)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writefiledescriptor) | - | 向OHIPCParcel对象写入文件描述符。 |
| [int OH\_IPCParcel\_ReadFileDescriptor(const OHIPCParcel \*parcel, int32\_t \*fd)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readfiledescriptor) | - | 从OHIPCParcel对象读取文件描述符。 |
| [int OH\_IPCParcel\_Append(OHIPCParcel \*parcel, const OHIPCParcel \*data)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_append) | - | OHIPCParcel对象数据拼接。 |
| [int OH\_IPCParcel\_WriteInterfaceToken(OHIPCParcel \*parcel, const char \*token)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_writeinterfacetoken) | - | 向OHIPCParcel对象写入接口描述符，用于接口身份校验。 |
| [int OH\_IPCParcel\_ReadInterfaceToken(const OHIPCParcel \*parcel, char \*\*token, int32\_t \*len, OH\_IPC\_MemAllocator allocator)](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipcparcel_readinterfacetoken) | - | 从OHIPCParcel对象读取接口描述符信息，用于接口身份校验。 |
...
| 返回 | 说明 |
| --- | --- |
| int | 成功返回[OH\_IPC\_ErrorCode#OH\_IPC\_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ipc-error-code-h#oh_ipc_errorcode)；  参数不合法时返回[OH\_IPC\_ErrorCode#OH\_IPC\_CHECK\_PARAM\_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ipc-error-code-h#oh_ipc_errorcode)；  写入失败返回[OH\_IPC\_ErrorCode#OH\_IPC\_PARCEL\_WRITE\_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ipc-error-code-h#oh_ipc_errorcode)。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 成功返回[OH\_IPC\_ErrorCode#OH\_IPC\_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ipc-error-code-h#oh_ipc_errorcode)；  参数不合法时返回[OH\_IPC\_ErrorCode#OH\_IPC\_CHECK\_PARAM\_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ipc-error-code-h#oh_ipc_errorcode)；  拼接失败返回[OH\_IPC\_ErrorCode#OH\_IPC\_PARCEL\_WRITE\_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ipc-error-code-h#oh_ipc_errorcode)。 |
...
| [OH\_IPC\_MemAllocator](/consumer/cn/doc/harmonyos-references/capi-ipc-cparcel-h#oh_ipc_memallocator) allocator | allocator 用户指定的用来分配token的内存分配器，不能为空。 |
