...
| callback | AsyncCallback<[Preferences](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#preferences)> | 是 | 回调函数。当获取Preferences实例成功，err为undefined，返回Preferences实例；否则err为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Preferences](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#preferences)> | Promise对象，返回Preferences实例。 |
...
| --- | --- | --- | --- |
| context | Context | 是 | 应用上下文。  FA模型的应用Context定义见[Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-app-context)。  Stage模型的应用Context定义见[Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context)。 |
| options | [Options](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#options10) | 是 | 与Preferences实例相关的配置选项。 |
| callback | AsyncCallback<[Preferences](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#preferences)> | 是 | 回调函数。当获取Preferences实例成功，err为undefined，返回Preferences实例；否则err为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Preferences](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#preferences) | 返回Preferences实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [StorageType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#storagetype18) | 是 | 需要判断是否支持的存储模式。 |
...
| storageType18+ | [StorageType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#storagetype18)|null|undefined | 否 | 是 | 存储模式，为可选参数。表示当前Preferences实例需要使用的存储模式。当此参数不填时，默认使用XML存储模式。当选择某种存储模式创建Preferences后，不支持中途切换存储模式。  **元服务API：** 从API version 18开始，该参数支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要获取的存储Key名称，不能为空，最大长度限制为[MAX\_KEY\_LENGTH](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#常量)。 |
| defValue | [ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#valuetype) | 是 | 默认返回值。 |
| callback | AsyncCallback<[ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#valuetype)> | 是 | 回调函数。当获取成功时，err为undefined，data为键对应的值；否则err为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#valuetype)> | Promise对象，返回键对应的值。 |
...
| 类型 | 说明 |
| --- | --- |
| [ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#valuetype) | 返回键对应的值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要修改的存储的Key，不能为空，最大长度限制为[MAX\_KEY\_LENGTH](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#常量)。 |
| value | [ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#valuetype) | 是 | 存储的新值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要检查的存储key名称，不能为空，最大长度限制为[MAX\_KEY\_LENGTH](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#常量)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要删除的存储Key名称，不能为空，最大长度限制为[MAX\_KEY\_LENGTH](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#常量)。 |
...
| callback | Callback<Record<string, [ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#valuetype)>> | 是 | 回调函数。回调支持返回多个键值对，其中键为发生变更的订阅key，值为变更后的数据：支持number、string、boolean、Array<number>、Array<string>、Array<boolean>、Uint8Array、object类型。 |
...
| callback | Callback<Record<string, [ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-preferences#valuetype)>> | 否 | 需要取消的回调函数，若callback不填写，表示所有的callback都需要处理；若callback填写，表示只处理该callback。 |
