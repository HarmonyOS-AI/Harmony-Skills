...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [StaticMapOptions](/consumer/cn/doc/harmonyos-references/map-staticmap#staticmapoptions) | 是 | 静态图参数。 |
...
| logoAlignment | [mapCommon.LogoAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#logoalignment) | 否 | 是 | 地图logo的对齐模式，默认为BOTTOM\_START，表示左下角。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| markers | Array<[StaticMapMarker](/consumer/cn/doc/harmonyos-references/map-staticmap#staticmapmarker)> | 否 | 是 | 在地图图像上添加标记。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。  **说明：**  网络图标资源的载入会影响网络性能，建议不超过3个。 |
| path | [StaticMapPath](/consumer/cn/doc/harmonyos-references/map-staticmap#staticmappath) | 否 | 是 | 添加在地图图像上的路径信息。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| defaultIconSize | [IconSize](/consumer/cn/doc/harmonyos-references/map-staticmap#iconsize) | 否 | 是 | 默认图标大小。如果使用默认图标，请选择使用默认图标的大小，默认值为[IconSize](/consumer/cn/doc/harmonyos-references/map-staticmap#iconsize).NORMAL，表示中等大小；如果icon生效，defaultIconSize不生效。 |
