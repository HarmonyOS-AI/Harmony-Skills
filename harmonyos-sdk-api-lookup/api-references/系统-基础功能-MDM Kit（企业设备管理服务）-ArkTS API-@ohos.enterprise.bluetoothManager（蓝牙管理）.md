...
| 类型 | 说明 |
| --- | --- |
| [BluetoothInfo](/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager#bluetoothinfo) | 蓝牙信息，包含蓝牙名称、蓝牙状态和蓝牙连接状态。 |
...
2. 已经通过[addDisallowedBluetoothDevices](/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager#bluetoothmanageradddisallowedbluetoothdevices20)接口添加了蓝牙设备禁用名单。通过[removeDisallowedBluetoothDevices](/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager#bluetoothmanagerremovedisallowedbluetoothdevices20)移除蓝牙设备禁用名单后，可解除冲突。
...
1. 已经通过[setDisallowedPolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-enterprise-restrictions#restrictionssetdisallowedpolicy)接口禁用了蓝牙。通过[setDisallowedPolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-enterprise-restrictions#restrictionssetdisallowedpolicy)接口启用蓝牙后，可解除冲突。
2. 已经通过[addAllowedBluetoothDevices](/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager#bluetoothmanageraddallowedbluetoothdevices)接口添加了蓝牙设备可用名单。通过[removeAllowedBluetoothDevices](/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager#bluetoothmanagerremoveallowedbluetoothdevices)移除蓝牙设备可用名单后，可解除冲突。
...
| protocols | Array<[Protocol](/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager#protocol20)> | 是 | 蓝牙协议的数组。数组长度上限为10000。 |
...
| admin | [Want](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-want) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| accountId | number | 是 | 用户ID，取值范围：大于等于0。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-osaccount#getosaccountlocalid9-1)等接口来获取。 |
| protocols | Array<[Protocol](/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager#protocol20)> | 是 | 蓝牙协议的数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[Protocol](/consumer/cn/doc/harmonyos-references/js-apis-enterprise-bluetoothmanager#protocol20)> | 禁用名单中蓝牙协议的数组。 |
