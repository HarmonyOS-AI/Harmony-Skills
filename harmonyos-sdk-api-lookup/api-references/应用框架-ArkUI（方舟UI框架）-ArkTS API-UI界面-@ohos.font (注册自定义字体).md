...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FontOptions](/consumer/cn/doc/harmonyos-references/js-apis-font#fontoptions) | 是 | 注册的自定义字体信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIFontConfig](/consumer/cn/doc/harmonyos-references/js-apis-font#uifontconfig11) | 系统的UI字体配置信息。 |
...
| generic | Array<[UIFontGenericInfo](/consumer/cn/doc/harmonyos-references/js-apis-font#uifontgenericinfo11)> | 否 | 否 | 系统所支持的通用字体集列表。 |
| fallbackGroups | Array<[UIFontFallbackGroupInfo](/consumer/cn/doc/harmonyos-references/js-apis-font#uifontfallbackgroupinfo11)> | 否 | 否 | 备用字体集。 |
...
| alias | Array<[UIFontAliasInfo](/consumer/cn/doc/harmonyos-references/js-apis-font#uifontaliasinfo11)> | 否 | 否 | 别名列表。 |
| adjust | Array<[UIFontAdjustInfo](/consumer/cn/doc/harmonyos-references/js-apis-font#uifontadjustinfo11)> | 否 | 否 | 字体原本的weight值对应需显示的值。 |
...
| fallback | Array<[UIFontFallbackInfo](/consumer/cn/doc/harmonyos-references/js-apis-font#uifontfallbackinfo11)> | 否 | 否 | 表示以下列表为该字体集的备用字体，如果fontSetName为""，表示可以作为所有字体集的备用字体。 |
