...
| data | string | 否 | 否 | 传递给Ability的数据。  type为'IM'时，参见[data取值样例](/consumer/cn/doc/harmonyos-references/push-pushcommon#data取值样例)（格式化后）。  type为 'VoIP' | 'BACKGROUND' | 'EMERGENCY'时，参见data[取值样例](/consumer/cn/doc/harmonyos-references/push-pushcommon#取值样例)（格式化后）。  type为 'ALERT'时，无需额外配置data字段：  notification完整字段参考AlertPayload 通知消息中[Notification](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-scenariozed-api-request-param#notification)结构体。 参见[样例](/consumer/cn/doc/harmonyos-references/push-pushcommon#样例)。 |
...
扩展通知数据，继承[PushPayload](/consumer/cn/doc/harmonyos-references/push-pushcommon#pushpayload)。
...
| --- | --- | --- | --- | --- |
| id | number | 否 | 否 | 通知id。 |
| type | string | 否 | 否 | 继承自[PushPayload](/consumer/cn/doc/harmonyos-references/push-pushcommon#pushpayload)，表示传递给[RemoteNotificationExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-remote-notification-extension-ability)的消息类型。 |
| data | string | 否 | 否 | 继承自[PushPayload](/consumer/cn/doc/harmonyos-references/push-pushcommon#pushpayload)，表示传递给[RemoteNotificationExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-remote-notification-extension-ability)的数据。 |
...
| wantAgent | [RemoteWantAgent](/consumer/cn/doc/harmonyos-references/push-pushcommon#remotewantagent) | 否 | 是 | 点击事件时可以替换的数据。 |
...
应用内通话消息数据，继承[PushPayload](/consumer/cn/doc/harmonyos-references/push-pushcommon#pushpayload)。
...
| type | string | 否 | 否 | 继承自[PushPayload](/consumer/cn/doc/harmonyos-references/push-pushcommon#pushpayload)，表示传递给[VoIPExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-voip-ability)的消息类型。 |
| data | string | 否 | 否 | 继承自[PushPayload](/consumer/cn/doc/harmonyos-references/push-pushcommon#pushpayload)，表示传递给[VoIPExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-voip-ability)的数据。 |