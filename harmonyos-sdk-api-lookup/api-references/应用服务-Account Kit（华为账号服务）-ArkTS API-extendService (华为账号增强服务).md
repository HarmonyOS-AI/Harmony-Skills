...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| idType | [IdType](/consumer/cn/doc/harmonyos-references/account-api-extendservice#idtype) | 否 | 否 | 属性idValue的ID类型。 |
...
| riskLevel | [RiskLevel](/consumer/cn/doc/harmonyos-references/account-api-extendservice#risklevel) | 否 | 否 | 风险等级，该值与sceneId一起代表了应用在华为账号服务器上的一组配置，一般风险等级高的场景，需要进行二次验证。 |
...
| **名称** | **值** | **说明** |
| --- | --- | --- |
| INVALID\_PARAMETER | [401](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-universal#section401-参数检查失败) | 参数检查失败。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| NETWORK\_ERROR | [1001600001](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1001600001-网络不可用) | 网络不可用。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| ACCOUNT\_NOT\_LOGGED\_IN | [1001600002](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1001600002-账号未登录) | 用户未登录华为账号。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| PACKAGE\_FINGERPRINT\_CHECK\_ERROR | [1001600003](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1001600003-应用指纹证书校验失败) | 应用指纹证书校验失败。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| PERMISSION\_CHECK\_ERROR | [1001600004](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1001600004-应用未申请对应permissions权限) | 应用未申请对应permissions权限。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| USER\_CANCELED | [1001600005](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1001600005-用户取消当前操作) | 用户取消当前操作。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| VERIFICATION\_FACTOR\_UNAVAILABLE | [1001600006](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1001600006-当前设备不支持此验证要素) | 当前设备不支持此验证要素。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| INTERNAL\_ERROR | [1001600007](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1001600007-内部错误) | 内部错误。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| DEVICE\_NOT\_SUPPORTED | [1001600011](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1001600011-该设备不支持此api) | 该设备不支持此API。  **起始版本**：6.1.0(23)  **元服务API：** 从版本6.1.0(23)开始，该接口支持在元服务中使用。 |
...
| request | [VerifyRequest](/consumer/cn/doc/harmonyos-references/account-api-extendservice#verifyrequest) | 是 | 身份验证请求对象，包含请求参数。 |
| callback | AsyncCallback<[VerifyResult](/consumer/cn/doc/harmonyos-references/account-api-extendservice#verifyresult)> | 是 | 回调函数。  当身份验证请求成功，err为undefined，data为获取到的[VerifyResult](/consumer/cn/doc/harmonyos-references/account-api-extendservice#verifyresult)对象；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[VerifyResult](/consumer/cn/doc/harmonyos-references/account-api-extendservice#verifyresult)> | Promise对象，返回[VerifyResult](/consumer/cn/doc/harmonyos-references/account-api-extendservice#verifyresult)对象。 |
