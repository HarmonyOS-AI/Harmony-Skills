...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | number | 是 | 需要被压制子进程的进程号，[OH\_Ability\_StartNativeChildProcess](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-child-process-h#oh_ability_startnativechildprocess)接口创建子进程后的pid参数，即为子进程进程号。 |
| priority | [ProcessPriority](/consumer/cn/doc/harmonyos-references/js-apis-backgroundprocessmanager#processpriority) | 是 | 压制档位。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | number | 是 | 子进程的进程号，[OH\_Ability\_StartNativeChildProcess](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-child-process-h#oh_ability_startnativechildprocess)接口创建子进程后的pid参数，即为子进程进程号。 |
...
| --- | --- | --- | --- |
| pid | number | 是 | 进程号。 |
| powerSaveMode | [PowerSaveMode](/consumer/cn/doc/harmonyos-references/js-apis-backgroundprocessmanager#powersavemode20) | 是 | 能效模式。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PowerSaveMode](/consumer/cn/doc/harmonyos-references/js-apis-backgroundprocessmanager#powersavemode20)> | Promise对象。返回进程能效模式状态。 |
