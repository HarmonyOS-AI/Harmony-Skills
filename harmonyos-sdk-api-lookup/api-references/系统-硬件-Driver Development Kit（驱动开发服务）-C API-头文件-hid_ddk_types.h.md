...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Hid\_DeviceProp](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_deviceprop) | Hid\_DeviceProp | 输入设备特性定义。 |
| [Hid\_EventType](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_eventtype) | Hid\_EventType | 事件类型。 |
| [Hid\_SynEvent](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_synevent) | Hid\_SynEvent | 同步事件编码。 |
| [Hid\_KeyCode](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_keycode) | Hid\_KeyCode | 键值编码。 |
| [Hid\_AbsAxes](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_absaxes) | Hid\_AbsAxes | 绝对坐标编码。 |
| [Hid\_RelAxes](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_relaxes) | Hid\_RelAxes | 相对坐标编码。 |
| [Hid\_MscEvent](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_mscevent) | Hid\_MscEvent | 不适合其它类型的输入事件编码。 |
| [Hid\_DdkErrCode](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_ddkerrcode) | Hid\_DdkErrCode | HID DDK错误码定义。 |
| [Hid\_ReportType](/consumer/cn/doc/harmonyos-references/capi-hid-ddk-types-h#hid_reporttype) | Hid\_ReportType | 报告（HID设备与主机之间交换的数据包）类型定义。 |
