...
```
1. typedef struct {...} ArkUI_AccessibleAction
```
...
| 名称 | 描述 |
| --- | --- |
| [ArkUI\_Accessibility\_ActionType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-interface-accessibility-h#arkui_accessibility_actiontype) actionType | 操作类型。 |
