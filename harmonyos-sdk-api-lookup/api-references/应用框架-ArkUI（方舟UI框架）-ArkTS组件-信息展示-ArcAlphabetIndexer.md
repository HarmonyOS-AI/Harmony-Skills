...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [ArcAlphabetIndexerInitInfo](/consumer/cn/doc/harmonyos-references/ts-container-arc-alphabet-indexer#arcalphabetindexerinitinfo对象说明) | 是 | 定义弧形字母索引条的初始化参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[OnSelectCallback](/consumer/cn/doc/harmonyos-references/ts-container-arc-alphabet-indexer#onselectcallback)> | 是 | 回调函数类型。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/LVkgvn4gRS6wDhhtuY8ldw/zh-cn_image_0000002568759552.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035219Z&HW-CC-Expire=86400&HW-CC-Sign=D5F511B96574087ABC483DB94D9AFC623D4FA2017049BFFDE6317375348DA3A0)