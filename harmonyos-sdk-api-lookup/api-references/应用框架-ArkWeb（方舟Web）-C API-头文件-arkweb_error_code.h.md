...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkWeb\_ErrorCode](/consumer/cn/doc/harmonyos-references/capi-arkweb-error-code-h#arkweb_errorcode) | ArkWeb\_ErrorCode | 定义ArkWeb NDK接口异常错误码。 |
| [ArkWeb\_BlanklessErrorCode](/consumer/cn/doc/harmonyos-references/capi-arkweb-error-code-h#arkweb_blanklesserrorcode) | ArkWeb\_BlanklessErrorCode | 定义无白屏加载的异常错误码。 |
