...
| normal | [NotificationBasicContent](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationbasiccontent) | 否 | 是 | 基本类型通知内容。 |
| longText | [NotificationLongTextContent](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationlongtextcontent) | 否 | 是 | 长文本类型通知内容。 |
| multiLine | [NotificationMultiLineContent](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationmultilinecontent) | 否 | 是 | 多行类型通知内容。 |
| picture | [NotificationPictureContent](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationpicturecontent) | 否 | 是 | 图片类型通知内容。 |
| systemLiveView11+ | [NotificationSystemLiveViewContent](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationsystemliveviewcontent) | 否 | 是 | 系统实况窗类型通知内容。不支持三方应用直接创建该类型通知，可以由系统代理创建系统实况窗类型通知后，三方应用发布同ID的通知来更新指定内容。 |
...
| capsule11+ | [NotificationCapsule](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationcapsule11) | 否 | 是 | 实况通知的胶囊。默认为空。 |
| button11+ | [NotificationButton](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationbutton11) | 否 | 是 | 实况通知的按钮。默认为空。 |
| time11+ | [NotificationTime](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationtime11) | 否 | 是 | 实况通知的时间。默认为空。 |
| progress11+ | [NotificationProgress](/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcontent#notificationprogress11) | 否 | 是 | 实况内容的进度。默认为空。 |
