...
| options | [ForegroundBlurStyleOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style#foregroundblurstyleoptions对象说明) | 否 | 内容模糊选项。默认值请参考[ForegroundBlurStyleOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style#foregroundblurstyleoptions对象说明)。 |
...
为当前组件提供内容模糊能力。与[foregroundBlurStyle18+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style#foregroundblurstyle18)相比，新增了sysOptions参数，即支持系统自适应调节参数。
...
| --- | --- | --- | --- |
| style | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[BlurStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-background#blurstyle9)> | 是 | 内容模糊样式。  当style的值为undefined时，恢复为无模糊的内容。 |
| options | [ForegroundBlurStyleOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style#foregroundblurstyleoptions对象说明) | 否 | 可选参数，内容模糊选项。默认值请参考[ForegroundBlurStyleOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style#foregroundblurstyleoptions对象说明)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| colorMode | [ThemeColorMode](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style#themecolormode枚举说明) | 否 | 是 | 内容模糊效果使用的深浅色模式。  默认值：ThemeColorMode.SYSTEM  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| adaptiveColor | [AdaptiveColor](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style#adaptivecolor枚举说明) | 否 | 是 | 内容模糊效果使用的取色模式。  默认值：AdaptiveColor.DEFAULT  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| blurOptions11+ | [BlurOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-foreground-blur-style#bluroptions11) | 否 | 是 | 灰阶模糊参数。  默认值：grayscale: [0,0]  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/7mAI8FhER_C6ZqFzAsb2cw/zh-cn_image_0000002599478363.png?HW-CC-KV=V1&HW-CC-Date=20260511T034534Z&HW-CC-Expire=86400&HW-CC-Sign=68893A09F15092DFFEA78C87F5EEBDCD10CB7418707FD3B35C422C69173FE331)