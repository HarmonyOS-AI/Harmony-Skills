...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| options | [ArcButtonOptions](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonoptions) | 是 | @Require | 定义ArcButton组件的文本、背景色、阴影等参数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| position | [ArcButtonPosition](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonposition) | 否 | 否 | 上下弧形按钮类型属性。  默认值：ArcButtonPosition.BOTTOM\_EDGE。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| styleMode | [ArcButtonStyleMode](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonstylemode) | 否 | 否 | 弧形按钮样式模式。该样式不支持与[ArcButtonProgressConfig](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonprogressconfig23)样式同时使用。  默认值：ArcButtonStyleMode.EMPHASIZED\_LIGHT。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| status | [ArcButtonStatus](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonstatus) | 否 | 否 | 弧形按钮状态。  默认值：ArcButtonStatus.NORMAL。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| progressConfig23+ | [ArcButtonProgressConfig](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonprogressconfig23) | 否 | 是 | ArcButton进度条参数。不设置该属性时ArcButton组件表现为按钮样式（[示例1](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#示例1-设置弧形按钮)），设置后表现为进度条样式（[示例2](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#示例2-设置设备进度条按钮)），进度条样式不受[ArcButtonStyleMode](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonstylemode)属性设置影响。  默认值：[ArcButtonProgressConfig](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonprogressconfig23) 的各项子属性均取其默认值。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CommonArcButtonOptions](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#commonarcbuttonoptions) | 是 | 定义ArcButton组件的文本、背景色、阴影等参数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| position | [ArcButtonPosition](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonposition) | 否 | 是 | 上下弧形按钮类型属性。  默认值：ArcButtonPosition.BOTTOM\_EDGE。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| styleMode | [ArcButtonStyleMode](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonstylemode) | 否 | 是 | 弧形按钮样式模式。该样式不支持与[ArcButtonProgressConfig](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonprogressconfig23)样式同时使用。  默认值：ArcButtonStyleMode.EMPHASIZED\_LIGHT。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| status | [ArcButtonStatus](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonstatus) | 否 | 是 | 弧形按钮状态。  默认值：ArcButtonStatus.NORMAL。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| color | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 进度条前景色。如果组件设置了背景色（[backgroundColor](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonoptions)），进度条前景色默认值取组件背景色。进度条前景色不受按钮样式（[ArcButtonStyleMode](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonstylemode)）设置影响。进度条背景色仅依赖进度条前景色设置，取进度条前景色的25%透明度。  默认值："#1F71FF"，显示为蓝色。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/92b92_bgRxO9rnKbof2LzA/zh-cn_image_0000002568919028.jpg?HW-CC-KV=V1&HW-CC-Date=20260511T035120Z&HW-CC-Expire=86400&HW-CC-Sign=9647C3458F7D319C4E63066D2EEAC232A0F160179E16E61675C91A175254B8D7)

### 示例2 (设置设备进度条按钮)

该示例展示了ArcButton组件进度条样式的基本用法。从API version 23开始，新增[progressConfig](/consumer/cn/doc/harmonyos-references/ohos-arkui-advanced-arcbutton#arcbuttonoptions)接口。示例配置如下：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/dzZ0RxNsQJSBvpjQQ2dixg/zh-cn_image_0000002599478573.jpg?HW-CC-KV=V1&HW-CC-Date=20260511T035120Z&HW-CC-Expire=86400&HW-CC-Sign=6CC546C881339924CCF1405BFA3B12ED72B6991A951D80BFCF24177B06491219)