...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| mapType | [MapType](/consumer/cn/doc/harmonyos-references/map-common#maptype) | 否 | 是 | 地图类型，默认值为[MapType](/consumer/cn/doc/harmonyos-references/map-common#maptype).STANDARD，异常值按默认值处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| position | [CameraPosition](/consumer/cn/doc/harmonyos-references/map-common#cameraposition) | 否 | 否 | 地图相机位置。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| bounds | [LatLngBounds](/consumer/cn/doc/harmonyos-references/map-common#latlngbounds) | 否 | 是 | 地图展示边界，异常值根据无边界处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。  **说明：**  西南角纬度不能大于东北角纬度。 |
...
| padding | [Padding](/consumer/cn/doc/harmonyos-references/map-common#padding) | 否 | 是 | 设置地图和边界的距离，默认值为{ left: 0 , top: 0 , right: 0 , bottom: 0 }。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| dayNightMode | [DayNightMode](/consumer/cn/doc/harmonyos-references/map-common#daynightmode) | 否 | 是 | 日间夜间模式，默认值为[DayNightMode](/consumer/cn/doc/harmonyos-references/map-common#daynightmode).DAY（日间模式）。  **起始版本：** 5.0.0(12)  **元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
...
| scaleUnit | [ScaleUnit](/consumer/cn/doc/harmonyos-references/map-common#scaleunit) | 否 | 是 | 地图比例尺单位，默认值为[ScaleUnit](/consumer/cn/doc/harmonyos-references/map-common#scaleunit).METRIC\_UNIT（公制单位）。  **起始版本：** 5.1.1(19)  **元服务API：** 从版本5.1.1(19)开始，该接口支持在元服务中使用。 |
...
| 名称 | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| target | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 地图中心位置的经纬度坐标。 |
...
| 名称 | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| northeast | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 东北角经纬度。 |
| southwest | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 西南角经纬度。 |
...
| 名称 | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| type | [PatternItemType](/consumer/cn/doc/harmonyos-references/map-common#patternitemtype) | 否 | 否 | 边框样式类型。 |
...
| displayType | [MyLocationDisplayType](/consumer/cn/doc/harmonyos-references/map-common#mylocationdisplaytype) | 否 | 是 | 定位图标的展示样式，默认值为[MyLocationDisplayType](/consumer/cn/doc/harmonyos-references/map-common#mylocationdisplaytype).DEFAULT。  **起始版本：** 5.0.0(12)  **元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
...
| position | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | POI的经纬度位置。 |
...
定义覆盖物基本属性。[MarkerOptions](/consumer/cn/doc/harmonyos-references/map-common#markeroptions)、[MapCircleOptions](/consumer/cn/doc/harmonyos-references/map-common#mapcircleoptions)、[MapPolygonOptions](/consumer/cn/doc/harmonyos-references/map-common#mappolygonoptions)、[MapPolylineOptions](/consumer/cn/doc/harmonyos-references/map-common#mappolylineoptions)、[MapArcParams](/consumer/cn/doc/harmonyos-references/map-common#maparcparams)、[ImageOverlayParams](/consumer/cn/doc/harmonyos-references/map-common#imageoverlayparams)、[BasePriorityOverlayParams](/consumer/cn/doc/harmonyos-references/map-common#basepriorityoverlayparams)等继承该基础类。
...
| zIndex | number | 否 | 是 | 覆盖物的叠加顺序，具有较大z指数的覆盖物会绘制在具有较小z指数的覆盖物上，具有相同z指数的叠加顺序为元素添加的先后顺序。覆盖物初始化时如果未设置zIndex参数，默认值为0。异常值按默认值处理。  **说明：**  [BasePriorityOverlayParams](/consumer/cn/doc/harmonyos-references/map-common#basepriorityoverlayparams)的zIndex向下取整数。 |

## MarkerOptions

PhonePC/2in1TabletWearable

描述Marker属性，继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| position | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 标记的位置坐标。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| collisionRule | [CollisionRule](/consumer/cn/doc/harmonyos-references/map-common#collisionrule) | 否 | 是 | 标记与地图POI之间的冲突处理规则，默认值为[CollisionRule](/consumer/cn/doc/harmonyos-references/map-common#collisionrule).NONE。异常值按照默认值处理。  **说明：**  从5.0.3(15)版本开始，collisionRule属性支持CollisionRule.NONE和CollisionRule.ALL类型；从6.1.0(23)版本开始，collisionRule属性新增支持CollisionRule.NAME和CollisionRule.ICON\_CASCADE类型。  **起始版本：** 5.0.3(15)  **元服务API：** 从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
| annotations | [Text](/consumer/cn/doc/harmonyos-references/map-common#text)[] | 否 | 是 | 标记的注释，最小长度为1，最大长度为3。  **起始版本：** 5.0.3(15)  **元服务API：** 从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
...
| annotationPosition | [TextPosition](/consumer/cn/doc/harmonyos-references/map-common#textposition) | 否 | 是 | 注释相对于图标的位置，默认值为[TextPosition](/consumer/cn/doc/harmonyos-references/map-common#textposition).DEFAULT。  **起始版本：** 5.0.3(15)  **元服务API：** 从版本5.0.3(15)开始，该接口支持在元服务中使用。 |
...
描述MapCircle属性，继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| center | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 圆的圆心，不能为空。圆的中心点纬度在[-85.051119, 85.051119]范围内才能画出圆。若圆中心点纬度为-85.051119或85.051119时，能画出半径为1米的圆。异常值不处理。 |
...
| patterns | Array<[PatternItem](/consumer/cn/doc/harmonyos-references/map-common#patternitem)> | 否 | 是 | 圆的边框样式，默认值为空数组，异常值按默认值处理。 |
...
描述MapPolygon属性，继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng)> | 否 | 否 | 多边形的一组顶点，纬度取值范围：[-85.2, 85.2]，异常值不处理。 |
| holes | Array<Array<[LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng)>> | 否 | 是 | 多边形的一组空心洞，默认值为空数组，异常值按默认值处理。  **说明：**  当空心洞的坐标贴合多边形边缘时，会导致渲染出现异常，渲染多余的空心区域。 |
...
| jointType | [JointType](/consumer/cn/doc/harmonyos-references/map-common#jointtype) | 否 | 是 | 多边形线条的拐角样式，默认值为[JointType](/consumer/cn/doc/harmonyos-references/map-common#jointtype).DEFAULT，异常值按默认值处理。 |
| patterns | Array<[PatternItem](/consumer/cn/doc/harmonyos-references/map-common#patternitem)> | 否 | 是 | 多边形的边框样式，默认值为空数组，异常值按默认值处理。 |
...
描述MapPolyline属性，继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng)> | 否 | 否 | 折线的一组顶点，异常值不处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| startCap | [CapStyle](/consumer/cn/doc/harmonyos-references/map-common#capstyle) | 否 | 是 | 折线的起始顶点的样式，默认值为[CapStyle](/consumer/cn/doc/harmonyos-references/map-common#capstyle).BUTT，异常值按默认值处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| endCap | [CapStyle](/consumer/cn/doc/harmonyos-references/map-common#capstyle) | 否 | 是 | 折线的结束顶点的样式，默认值为[CapStyle](/consumer/cn/doc/harmonyos-references/map-common#capstyle).BUTT，异常值按默认值处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| geodesic | boolean | 否 | 是 | 折线的线段是否为大地曲线，默认值为false，异常值按默认值处理。  - true：大地曲线  - false：非大地曲线  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| jointType | [JointType](/consumer/cn/doc/harmonyos-references/map-common#jointtype) | 否 | 是 | 折线的线条拐角样式，默认值为[JointType](/consumer/cn/doc/harmonyos-references/map-common#jointtype).DEFAULT，异常值按默认值处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| patterns | Array<[PatternItem](/consumer/cn/doc/harmonyos-references/map-common#patternitem)> | 否 | 是 | 折线的样式，默认值为空数组，异常值按默认值处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
描述气泡、点注释等覆盖物的基础信息，继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
描述点注释属性，继承[BasePriorityOverlayParams](/consumer/cn/doc/harmonyos-references/map-common#basepriorityoverlayparams)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| position | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 点注释图标锚点，异常值不处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
| repeatable | boolean | 否 | 是 | 点注释名称与地图POI名称相同时，是否支持去重，默认值为false，异常值按默认值处理。  - true：支持去重  - false：不支持去重  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。  **说明：**  碰撞规则为[CollisionRule](/consumer/cn/doc/harmonyos-references/map-common#collisionrule).NONE时，repeatable不支持设置。 |
| collisionRule | [CollisionRule](/consumer/cn/doc/harmonyos-references/map-common#collisionrule) | 否 | 是 | 点注释的碰撞规则，默认值为[CollisionRule](/consumer/cn/doc/harmonyos-references/map-common#collisionrule).NAME，异常值按默认值处理。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。  **说明：**  设置碰撞规则为[CollisionRule](/consumer/cn/doc/harmonyos-references/map-common#collisionrule).ALL，需要同时设置覆盖物碰撞优先级priority属性。 |
| titles | Array<[Text](/consumer/cn/doc/harmonyos-references/map-common#text)> | 否 | 否 | 点注释的标题，数组长度最小为1，最大为3。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| textPosition | [TextPosition](/consumer/cn/doc/harmonyos-references/map-common#textposition) | 否 | 是 | 设置点注释的文本位置。  默认值为[TextPosition](/consumer/cn/doc/harmonyos-references/map-common#textposition).DEFAULT。  **起始版本：** 5.0.0(12)  **元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
...
描述气泡属性，继承[BasePriorityOverlayParams](/consumer/cn/doc/harmonyos-references/map-common#basepriorityoverlayparams)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| positions | Array<Array<[LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng)>> | 否 | 否 | 气泡位置，系统基于多个位置段计算图标的适当位置，异常值不处理。 |
...
| fontStyle | [FontStyle](/consumer/cn/doc/harmonyos-references/map-common#fontstyle) | 否 | 是 | 标题字体样式，默认值为[FontStyle](/consumer/cn/doc/harmonyos-references/map-common#fontstyle).REGULAR，异常值按默认值处理。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| farLeft | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 定义相机的左上角。 |
| farRight | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 定义相机的右上角。 |
| bounds | [LatLngBounds](/consumer/cn/doc/harmonyos-references/map-common#latlngbounds) | 否 | 否 | 定义的可视区域的最小边界框。 |
| nearLeft | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 定义相机的左下角。 |
| nearRight | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 定义相机的右下角。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| position | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 待聚合节点的坐标。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| clusterItems | Array<[ClusterItem](/consumer/cn/doc/harmonyos-references/map-common#clusteritem)> | 否 | 否 | 待聚合节点数组。 |
...
| 返回类型 | 方法 |
| --- | --- |
| Promise<[image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)> | [getCustomIcon](/consumer/cn/doc/harmonyos-references/map-common#getcustomicon)?(clusterItems: Array<[ClusterItem](/consumer/cn/doc/harmonyos-references/map-common#clusteritem)>)  根据聚合项自定义图标，使用Promise异步回调。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| clusterItems | Array<[ClusterItem](/consumer/cn/doc/harmonyos-references/map-common#clusteritem)> | 是 | 聚合节点数组。 |
...
覆盖物参数。继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| bounds | [LatLngBounds](/consumer/cn/doc/harmonyos-references/map-common#latlngbounds) | 否 | 是 | 设置基于矩形区域的覆盖物的位置。position和bounds是可选的，但是两个参数需要必填其中一个参数，当两者都入参时，bounds具有更高的优先级。position入参时，width为必填参数。 |
| position | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 是 | 设置覆盖物的位置。position和bounds是可选的，但是两个参数需要必填其中一个，当两者都入参时，bounds具有更高的优先级。position入参时，width为必填参数。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng)> | 否 | 否 | 建筑底面坐标集合。  最少三个坐标点，而且坐标点按顺时针方向连接可以形成完整的平面。 |
...
| sideTexture | [BuildingTexture](/consumer/cn/doc/harmonyos-references/map-common#buildingtexture) | 否 | 是 | 建筑的侧面纹理。 |
| floorTexture | [BuildingTexture](/consumer/cn/doc/harmonyos-references/map-common#buildingtexture) | 否 | 是 | 所选楼层的纹理。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng)> | 否 | 否 | 跟踪点。  points个数上限为100000。 |
...
弧线的参数。继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| startPoint | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 起始位置。 |
| centerPoint | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 中心位置。 |
| endPoint | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 结束位置。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| coordinateType | [CoordinateType](/consumer/cn/doc/harmonyos-references/map-common#coordinatetype) | 否 | 否 | 坐标系类型。 |
| location | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 坐标。 |
...
瓦片图层的参数。继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| tileProvider | [TileProvider](/consumer/cn/doc/harmonyos-references/map-common#tileprovider) | 否 | 是 | 根据瓦片坐标获取瓦片。  **元服务API：** 从版本6.0.0(20)开始，该接口支持在元服务中使用。 |
...
| --- | --- | --- | --- | --- |
| id | string | 否 | 否 | 热力图ID。 |
| data | [WeightedLatLng](/consumer/cn/doc/harmonyos-references/map-common#weightedlatlng)[] | 否 | 否 | 热力图数据（建议数据量小于10000条）。 |
...
| radius | number | Record<number, number> | 否 | 是 | 热力图半径，可以配置不同层级的半径，key表示层级，value表示按半径，如果是number类型，所有层级使用同一个半径，默认值10，默认单位：[RadiusUnit](/consumer/cn/doc/harmonyos-references/map-common#radiusunit).PIXEL\_UNIT。 |
| radiusUnit | [RadiusUnit](/consumer/cn/doc/harmonyos-references/map-common#radiusunit) | 否 | 是 | 半径单位。默认值：[RadiusUnit](/consumer/cn/doc/harmonyos-references/map-common#radiusunit).PIXEL\_UNIT。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| point | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 经纬度。 |
...
矢量图层的参数。继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| source | [MvtSource](/consumer/cn/doc/harmonyos-references/map-common#mvtsource) | 否 | 否 | 矢量图层的来源。  元服务API：从版本6.0.0(20)开始，该接口支持在元服务中使用。 |
| layers | [MvtLayer](/consumer/cn/doc/harmonyos-references/map-common#mvtlayer)[] | 否 | 否 | 样式数组，建议矢量图层少于2000层，确保矢量图层的流畅度。  元服务API：从版本6.0.0(20)开始，该接口支持在元服务中使用。 |
...
| tileProvider | [TileProvider](/consumer/cn/doc/harmonyos-references/map-common#tileprovider) | 否 | 是 | 根据瓦片坐标获取瓦片。 |
...
| type | [MvtLayerType](/consumer/cn/doc/harmonyos-references/map-common#mvtlayertype) | 否 | 否 | 矢量图层类型。 |
| sourceLayer | string | 否 | 否 | 矢量图层数据中图层的名称。 |
| paint | [MvtPaint](/consumer/cn/doc/harmonyos-references/map-common#mvtpaint) | 否 | 是 | 用于配置几何体的渲染，如填充、描边等。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| fillColor | number | [Expression](/consumer/cn/doc/harmonyos-references/map-common#expression) | 否 | 是 | 填充颜色，默认值：0x000000，异常值按默认值处理。支持：  - 十六进制RGB格式。  - 从矢量图层数据的属性中读取。 |
| fillOpacity | number | [Expression](/consumer/cn/doc/harmonyos-references/map-common#expression) | 否 | 是 | 填充不透明度，默认值：0，异常值按默认值处理。支持：  - 介于0到1之间的数字。  - 从矢量图层数据的属性中读取。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| operator | [Operator](/consumer/cn/doc/harmonyos-references/map-common#operator) | 否 | 否 | 操作符。 |
| args | string | string[] | [Expression](/consumer/cn/doc/harmonyos-references/map-common#expression)[] | 否 | 否 | 参数。  **说明：**  string[]和[Expression](/consumer/cn/doc/harmonyos-references/map-common#expression)[]类型为预留类型，将来使用。 |
...
流场图层的参数。继承[BaseOverlayOptions](/consumer/cn/doc/harmonyos-references/map-common#baseoverlayoptions)。
...
| style | [ParticleStyle](/consumer/cn/doc/harmonyos-references/map-common#particlestyle) | 否 | 是 | 粒子样式。 |
...
| position | [LatLng](/consumer/cn/doc/harmonyos-references/map-common#latlng) | 否 | 否 | 项目的经纬度坐标。 |
| title | string | 否 | 是 | 标题。 |
...
| items | [MassPointItem](/consumer/cn/doc/harmonyos-references/map-common#masspointitem)[] | 否 | 否 | 海量点列表（建议数据量小于100000条）。 |
...
| POI | 2 | 底图[Poi](/consumer/cn/doc/harmonyos-references/map-common#poi)。 |
