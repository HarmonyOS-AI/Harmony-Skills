...
| pickerStyle12+ | [AVCastPickerStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-avcastpickerparam#avcastpickerstyle12) | 否 | @Prop | 投播样式。  - 当sessionType是audio或者video时，默认值为STYLE\_PANEL。  - 当sessionType是voice\_call或者video\_call时，默认值为STYLE\_MENU，且不可修改为STYLE\_PANEL。 |
