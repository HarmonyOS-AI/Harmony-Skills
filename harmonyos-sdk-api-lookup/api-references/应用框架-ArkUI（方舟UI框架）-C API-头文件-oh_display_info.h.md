...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [NativeDisplayManager\_Rotation](/consumer/cn/doc/harmonyos-references/capi-oh-display-info-h#nativedisplaymanager_rotation) | NativeDisplayManager\_Rotation | 屏幕顺时针的旋转角度。 |
| [NativeDisplayManager\_Orientation](/consumer/cn/doc/harmonyos-references/capi-oh-display-info-h#nativedisplaymanager_orientation) | NativeDisplayManager\_Orientation | 屏幕的旋转方向。 |
| [NativeDisplayManager\_ErrorCode](/consumer/cn/doc/harmonyos-references/capi-oh-display-info-h#nativedisplaymanager_errorcode) | NativeDisplayManager\_ErrorCode | 屏幕管理接口返回状态码枚举。 |
| [NativeDisplayManager\_FoldDisplayMode](/consumer/cn/doc/harmonyos-references/capi-oh-display-info-h#nativedisplaymanager_folddisplaymode) | NativeDisplayManager\_FoldDisplayMode | 可折叠设备的显示模式枚举。 |
| [NativeDisplayManager\_DisplayState](/consumer/cn/doc/harmonyos-references/capi-oh-display-info-h#nativedisplaymanager_displaystate) | NativeDisplayManager\_DisplayState | 显示设备的状态枚举。 |
| [NativeDisplayManager\_SourceMode](/consumer/cn/doc/harmonyos-references/capi-oh-display-info-h#nativedisplaymanager_sourcemode) | NativeDisplayManager\_SourceMode | 设备的显示模式枚举。 |
