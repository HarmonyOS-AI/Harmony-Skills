...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[PowerModel](/consumer/cn/doc/harmonyos-references/js-apis-wifiext#powermodel)>> | Promise对象。表示功率模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[PowerModel](/consumer/cn/doc/harmonyos-references/js-apis-wifiext#powermodel)>> | 是 | 回调函数。当操作成功时，err为0，data表示支持的功率模式。如果err为非0，表示处理出现错误。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PowerModel](/consumer/cn/doc/harmonyos-references/js-apis-wifiext#powermodel)> | Promise对象。表示功率模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[PowerModel](/consumer/cn/doc/harmonyos-references/js-apis-wifiext#powermodel)> | 是 | 回调函数。当操作成功时，err为0，data表示功率模式。如果err为非0，表示处理出现错误。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| model | [PowerModel](/consumer/cn/doc/harmonyos-references/js-apis-wifiext#powermodel) | 是 | 功率模式。 |
