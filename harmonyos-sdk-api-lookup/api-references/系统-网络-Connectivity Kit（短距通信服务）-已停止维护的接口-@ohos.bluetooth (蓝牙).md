...
| 类型 | 说明 |
| --- | --- |
| [BluetoothState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bluetoothstatedeprecated) | 表示蓝牙开关状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [ProfileConnectionState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#profileconnectionstatedeprecated) | 表示蓝牙设备的Profile连接状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [ProfileConnectionState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#profileconnectionstatedeprecated) | profile的连接状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [DeviceClass](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#deviceclassdeprecated) | 远程设备的类别。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [ScanMode](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#scanmodedeprecated) | 是 | 蓝牙扫描模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ScanMode](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#scanmodedeprecated) | 蓝牙扫描模式。 |
...
| callback | Callback<[PinRequiredParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#pinrequiredparamdeprecated)> | 是 | 表示回调函数的入参，配对请求。回调函数由用户创建通过该接口注册。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"pinRequired"字符串，表示配对请求事件。 |
| callback | Callback<[PinRequiredParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#pinrequiredparamdeprecated)> | 否 | 表示取消订阅蓝牙配对请求事件上报，入参为配对请求参数。不填该参数则取消订阅该type对应的所有回调。 |
...
| callback | Callback<[BondStateParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bondstateparamdeprecated)> | 是 | 表示回调函数的入参，配对的状态。回调函数由用户创建通过该接口注册。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"bondStateChange"字符串，表示蓝牙配对状态改变事件。 |
| callback | Callback<[BondStateParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bondstateparamdeprecated)> | 否 | 表示取消订阅蓝牙配对状态改变事件上报。不填该参数则取消订阅该type对应的所有回调。 |
...
| callback | Callback<[BluetoothState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bluetoothstatedeprecated)> | 是 | 表示回调函数的入参，蓝牙状态。回调函数由用户创建通过该接口注册。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"stateChange"字符串，表示蓝牙状态改变事件。 |
| callback | Callback<[BluetoothState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bluetoothstatedeprecated)> | 否 | 表示取消订阅蓝牙状态改变事件上报。不填该参数则取消订阅该type对应的所有回调。 |
...
| --- | --- | --- | --- |
| name | string | 是 | 服务的名称。 |
| option | [SppOption](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#sppoptiondeprecated) | 是 | spp监听配置参数。 |
...
| option | [SppOption](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#sppoptiondeprecated) | 是 | spp客户端连接配置参数。 |
| callback | AsyncCallback<number> | 是 | 表示回调函数的入参，客户端socket的id。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profileId | [ProfileId](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#profileiddeprecated) | 是 | 表示profile的枚举值，例如：PROFILE\_A2DP\_SOURCE。 |
...
| 类型 | 说明 |
| --- | --- |
| [A2dpSourceProfile](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#a2dpsourceprofile) | [HandsFreeAudioGatewayProfile](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#handsfreeaudiogatewayprofile) | 对应的profile的对象实例，当前支持A2dpSourceProfile， HandsFreeAudioGatewayProfile。 |
...
| 类型 | 说明 |
| --- | --- |
| [GattServer](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#gattserver) | server端类，使用server端方法之前需要创建该类的实例进行操作。 |
...
| 类型 | 说明 |
| --- | --- |
| [GattClientDevice](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#gattclientdevice) | client端类，使用client端方法之前需要创建该类的实例进行操作。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filters | Array<[ScanFilter](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#scanfilterdeprecated)> | 是 | 表示扫描结果过滤策略集合，如果不使用过滤的方式，该参数设置为null。 |
| options | [ScanOptions](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#scanoptionsdeprecated) | 否 | 表示扫描的参数配置，可选参数。 |
...
| callback | Callback<Array<[ScanResult](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#scanresultdeprecated)>> | 是 | 表示回调函数的入参，发现的设备集合。回调函数由用户创建通过该接口注册。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"BLEDeviceFind"字符串，表示BLE设备发现事件。 |
| callback | Callback<Array<[ScanResult](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#scanresultdeprecated)>> | 否 | 表示取消订阅BLE设备发现事件上报。不填该参数则取消订阅该type对应的所有回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [ProfileConnectionState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#profileconnectionstatedeprecated) | 返回profile的连接状态。 |
...
on(type: 'connectionStateChange', callback: Callback<[StateChangeParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#statechangeparamdeprecated)>): void
...
| callback | Callback<[StateChangeParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#statechangeparamdeprecated)> | 是 | 表示回调函数的入参。 |
...
off(type: 'connectionStateChange', callback?: Callback<[StateChangeParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#statechangeparamdeprecated)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"connectionStateChange"字符串，表示连接状态变化事件。 |
| callback | Callback<[StateChangeParam](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#statechangeparamdeprecated)> | 否 | 表示回调函数的入参。 |
...
| 类型 | 说明 |
| --- | --- |
| [PlayingState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#playingstatedeprecated) | 远端设备的播放状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| setting | [AdvertiseSetting](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#advertisesettingdeprecated) | 是 | BLE广播的相关参数。 |
| advData | [AdvertiseData](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#advertisedatadeprecated) | 是 | BLE广播包内容。 |
| advResponse | [AdvertiseData](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#advertisedatadeprecated) | 否 | BLE回复扫描请求回复响应。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| service | [GattService](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#gattservicedeprecated) | 是 | 服务端的service数据。BLE广播的相关参数 |
...
关闭服务端功能，去注册server在协议栈的注册，调用该接口后[GattServer](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#gattserver)实例将不能再使用。
...
| notifyCharacteristic | [NotifyCharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#notifycharacteristicdeprecated) | 是 | 通知的特征值数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| serverResponse | [ServerResponse](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#serverresponsedeprecated) | 是 | server端回复的响应数据。 |
...
| callback | Callback<[CharacteristicReadReq](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#characteristicreadreqdeprecated)> | 是 | 表示回调函数的入参，client端发送的读请求数据。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"characteristicRead"字符串，表示特征值读请求事件。 |
| callback | Callback<[CharacteristicReadReq](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#characteristicreadreqdeprecated)> | 否 | 表示取消订阅特征值读请求事件上报。不填该参数则取消订阅该type对应的所有回调。 |
...
| callback | Callback<[CharacteristicWriteReq](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#characteristicwritereqdeprecated)> | 是 | 表示回调函数的入参，client端发送的写请求数据。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"characteristicWrite"字符串，表示特征值写请求事件。 |
| callback | Callback<[CharacteristicWriteReq](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#characteristicwritereqdeprecated)> | 否 | 表示取消订阅特征值写请求事件上报。不填该参数则取消订阅该type对应的所有回调。 |
...
| callback | Callback<[DescriptorReadReq](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#descriptorreadreqdeprecated)> | 是 | 表示回调函数的入参，client端发送的读请求数据。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"descriptorRead"字符串，表示描述符读请求事件。 |
| callback | Callback<[DescriptorReadReq](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#descriptorreadreqdeprecated)> | 否 | 表示取消订阅描述符读请求事件上报。不填该参数则取消订阅该type对应的所有回调。 |
...
| callback | Callback<[DescriptorWriteReq](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#descriptorwritereqdeprecated)> | 是 | 表示回调函数的入参，client端发送的写请求数据。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"descriptorWrite"字符串，表示描述符写请求事件。 |
| callback | Callback<[DescriptorWriteReq](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#descriptorwritereqdeprecated)> | 否 | 表示取消订阅描述符写请求事件上报。不填该参数则取消订阅该type对应的所有回调。 |
...
| callback | Callback<[BLEConnectChangedState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bleconnectchangedstatedeprecated)> | 是 | 表示回调函数的入参，连接状态。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"connectStateChange"字符串，表示BLE连接状态变化事件。 |
| callback | Callback<[BLEConnectChangedState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bleconnectchangedstatedeprecated)> | 否 | 表示取消订阅BLE连接状态变化事件。不填该参数则取消订阅该type对应的所有回调。 |
...
关闭客户端功能，注销client在协议栈的注册，调用该接口后[GattClientDevice](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#gattclientdevice)实例将不能再使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[GattService](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#gattservicedeprecated)>> | 是 | client进行服务发现，通过注册回调函数获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[GattService](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#gattservicedeprecated)>> | client进行服务发现，通过promise形式获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| characteristic | [BLECharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#blecharacteristicdeprecated) | 是 | 待读取的特征值。 |
| callback | AsyncCallback<[BLECharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#blecharacteristicdeprecated)> | 是 | client读取特征值，通过注册回调函数获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[BLECharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#blecharacteristicdeprecated)> | client读取特征值，通过promise形式获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| descriptor | [BLEDescriptor](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bledescriptordeprecated) | 是 | 待读取的描述符。 |
| callback | AsyncCallback<[BLEDescriptor](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bledescriptordeprecated)> | 是 | client读取描述符，通过注册回调函数获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[BLEDescriptor](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bledescriptordeprecated)> | client读取描述符，通过promise形式获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| characteristic | [BLECharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#blecharacteristicdeprecated) | 是 | 蓝牙设备特征对应的二进制值及其它参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| descriptor | [BLEDescriptor](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bledescriptordeprecated) | 是 | 蓝牙设备描述符的二进制值及其它参数。 |
...
client协商远端蓝牙低功耗设备的最大传输单元（Maximum Transmission Unit, MTU），调用[connect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#connectdeprecated)接口连接成功后才能使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| characteristic | [BLECharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#blecharacteristicdeprecated) | 是 | 蓝牙低功耗特征。 |
...
| callback | Callback<[BLECharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#blecharacteristicdeprecated)> | 是 | 表示蓝牙低功耗设备的特征值变化事件的回调函数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"BLECharacteristicChange"字符串，表示特征值变化事件。 |
| callback | Callback<[BLECharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#blecharacteristicdeprecated)> | 否 | 表示取消订阅蓝牙低功耗设备的特征值变化事件。不填该参数则取消订阅该type对应的所有回调。 |
...
| callback | Callback<[BLEConnectChangedState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bleconnectchangedstatedeprecated)> | 是 | 表示连接状态，已连接或断开。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 填写"BLEConnectionStateChange"字符串，表示连接状态变化事件。 |
| callback | Callback<[BLEConnectChangedState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bleconnectchangedstatedeprecated)> | 否 | 表示取消订阅蓝牙低功耗设备的连接状态变化事件。不填该参数则取消订阅该type对应的所有回调。 |
...
client获取远端蓝牙低功耗设备的信号强度 (Received Signal Strength Indication, RSSI)，调用[connect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#connectdeprecated)接口连接成功后才能使用。
...
| type | [SppType](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#spptypedeprecated) | 否 | 否 | Spp链路类型。 |
...
| characteristics | Array<[BLECharacteristic](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#blecharacteristicdeprecated)> | 否 | 否 | 当前服务包含的特征列表。 |
| includeServices | Array<[GattService](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#gattservicedeprecated)> | 否 | 是 | 当前服务依赖的其它服务。 |
...
| descriptors | Array<[BLEDescriptor](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#bledescriptordeprecated)> | 否 | 否 | 特定特征的描述符列表。 |
...
| --- | --- | --- | --- | --- |
| deviceId | string | 否 | 否 | 表示远端设备地址，例如："XX:XX:XX:XX:XX:XX"。 |
| state | [ProfileConnectionState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#profileconnectionstatedeprecated) | 否 | 否 | 表示BLE连接状态的枚举。 |
...
| dutyMode | [ScanDuty](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#scandutydeprecated) | 否 | 是 | 表示扫描模式，默认值为SCAN\_MODE\_LOW\_POWER。 |
| matchMode | [MatchMode](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#matchmodedeprecated) | 否 | 是 | 表示硬件的过滤匹配模式，默认值为MATCH\_MODE\_AGGRESSIVE。 |
...
| manufactureData | Array<[ManufactureData](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#manufacturedatadeprecated)> | 否 | 否 | 表示要广播的广播的制造商信息列表。 |
| serviceData | Array<[ServiceData](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#servicedatadeprecated)> | 否 | 否 | 表示要广播的服务数据列表。 |
...
| state | [ProfileConnectionState](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#profileconnectionstatedeprecated) | 否 | 否 | 表示蓝牙设备的profile连接状态。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| majorClass | [MajorClass](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#majorclassdeprecated) | 否 | 否 | 表示蓝牙设备主要类别的枚举。 |
| majorMinorClass | [MajorMinorClass](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth#majorminorclassdeprecated) | 否 | 否 | 表示主要次要蓝牙设备类别的枚举。 |
