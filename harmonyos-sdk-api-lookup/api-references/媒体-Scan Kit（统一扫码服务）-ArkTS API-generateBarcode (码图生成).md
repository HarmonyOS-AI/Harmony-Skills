...
| level | [ErrorCorrectionLevel](/consumer/cn/doc/harmonyos-references/scan-generatebarcode#errorcorrectionlevel) | 否 | 是 | 纠错水平，默认值为LEVEL\_H。此参数只在生成QR码时有效。 |
...
| options | [CreateOptions](/consumer/cn/doc/harmonyos-references/scan-generatebarcode#createoptions) | 是 | 码图生成的配置参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | string | 是 | 码内容字符串。参数限制请参见[generateBarcode.createBarcode](/consumer/cn/doc/harmonyos-references/scan-generatebarcode#generatebarcodecreatebarcode)的表1-content参数限制条件。 |
| options | [CreateOptions](/consumer/cn/doc/harmonyos-references/scan-generatebarcode#createoptions) | 是 | 码图生成的配置参数。 |
...
| options | [CreateOptions](/consumer/cn/doc/harmonyos-references/scan-generatebarcode#createoptions) | 是 | 码图生成的配置参数，ScanType仅支持QR Code。 |
