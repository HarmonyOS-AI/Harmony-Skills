...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Asset\_TagType](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_tagtype) | Asset\_TagType | 关键资产属性的类型定义。 |
| [Asset\_Tag](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_tag) | Asset\_Tag | 关键资产属性的名称。 |
| [Asset\_ResultCode](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_resultcode) | Asset\_ResultCode | 调用ASSET返回的结果码。 |
| [Asset\_Accessibility](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_accessibility) | Asset\_Accessibility | 基于锁屏状态的访问控制类型。 |
| [Asset\_AuthType](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_authtype) | Asset\_AuthType | 关键资产支持的用户认证类型。 |
| [Asset\_SyncType](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_synctype) | Asset\_SyncType | 关键资产支持的同步类型。 |
| [Asset\_WrapType](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_wraptype) | Asset\_WrapType | 关键资产支持的加密导入导出类型。 |
| [Asset\_ConflictResolution](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_conflictresolution) | Asset\_ConflictResolution | 新增关键资产时的冲突（如：别名相同）处理策略。 |
| [Asset\_ReturnType](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_returntype) | Asset\_ReturnType | 关键资产查询返回的结果类型。 |
| [Asset\_OperationType](/consumer/cn/doc/harmonyos-references/capi-asset-type-h#asset_operationtype) | Asset\_OperationType | 附属的操作类型。 |
...
| ASSET\_TAG\_IS\_PERSISTENT = ASSET\_TYPE\_BOOL | 0x11 | 表示关键资产是否需持久化存储，其值为bool类型。  在调用OH\_Asset\_Add函数时传入该属性需要校验权限ohos.permission.STORE\_PERSISTENT\_DATA，该权限申请方式请参考[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)。 |
