...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/TP8CbYD9Q8q8CO9BODjSRQ/zh-cn_image_0000002568920202.png?HW-CC-KV=V1&HW-CC-Date=20260511T062506Z&HW-CC-Expire=86400&HW-CC-Sign=5516119CEAAA496BE692D6118E6E0C8CB7B7B22F588A2FE268B2082FF1D67279)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| jwsNotification | 是 | String | 通知内容信息，对通知内容NotificationPayload签名后的字符串。具体请参见表[NotificationPayload](/consumer/cn/doc/harmonyos-references/iap-key-event-notifications#notificationpayload)。  需要参见[对返回结果验签](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-verifying-signature)使用JWS签名方式对NotificationPayload消息体进行验签。 |
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| notificationType | 是 | String | 通知主类型，具体请参见表[NotificationType](/consumer/cn/doc/harmonyos-references/iap-key-event-notifications#notificationtype)说明。 |
| notificationSubtype | 否 | String | 通知子类型，具体请参见表[NotificationSubtype](/consumer/cn/doc/harmonyos-references/iap-key-event-notifications#notificationsubtype)说明。后续子类型会增加，开发者需要设计相应的处理机制。 |
| notificationRequestId | 是 | String | 通知唯一请求ID。 |
| notificationMetaData | 是 | Object | 通知元数据，具体请参见表[NotificationMetaData](/consumer/cn/doc/harmonyos-references/iap-key-event-notifications#notificationmetadata)说明。 |
