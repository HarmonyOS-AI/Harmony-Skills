...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AVCodecBufferFlags](/consumer/cn/doc/harmonyos-references/capi-native-avbuffer-info-h#oh_avcodecbufferflags) | OH\_AVCodecBufferFlags | 枚举OH\_AVCodec缓冲区标记的类别。 |
