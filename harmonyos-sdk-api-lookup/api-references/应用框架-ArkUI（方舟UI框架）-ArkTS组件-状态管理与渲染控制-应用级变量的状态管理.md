...
| 类型 | 说明 |
| --- | --- |
| [AbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#abstractproperty12) | undefined | AppStorage中propName对应属性的引用，如果AppStorage中不存在对应的propName，则返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#abstractproperty12) | AbstractProperty<T>的实例，为AppStorage中propName对应属性的引用。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | 返回双向绑定的数据，如果AppStorage中不存在对应的propName，则返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | SubscribedAbstractProperty<T>的实例，为AppStorage中propName对应属性的双向绑定的数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | 返回单向绑定的数据，如果AppStorage中不存在对应的propName，则返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | SubscribedAbstractProperty<T>的实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | SubscribedAbstractProperty<T>的实例，和AppStorage中propName对应属性的双向绑定的数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<S>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | SubscribedAbstractProperty<S>的实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [LocalStorage](/consumer/cn/doc/harmonyos-references/ts-state-management#localstorage9) | 返回LocalStorage实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#abstractproperty12) | undefined | LocalStorage中propName对应属性的引用，如果LocalStorage中不存在对应的propName，则返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [AbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#abstractproperty12) | AbstractProperty<T>的实例，为LocalStorage中propName对应属性的引用。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | SubscribedAbstractProperty<T>的实例，与LocalStorage中propName对应属性的双向绑定的数据，如果LocalStorage中不存在对应的propName，则返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<T>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | SubscribedAbstractProperty<T>的实例，与LocalStorage中propName对应属性的双向绑定的数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<S>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | SubscribedAbstractProperty<S>的实例，和LocalStorage中propName对应属性的单向绑定的数据。如果LocalStorage中不存在对应的propName，则返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [SubscribedAbstractProperty<S>](/consumer/cn/doc/harmonyos-references/ts-state-management#subscribedabstractproperty) | SubscribedAbstractProperty<S>的实例，和LocalStorage中propName对应属性的单向绑定的数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| props | [PersistPropsOptions](/consumer/cn/doc/harmonyos-references/ts-state-management#persistpropsoptions10)[] | 是 | 持久化数组。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| key | string | 否 | 否 | 环境变量名称，支持的范围详见[内置环境变量说明](/consumer/cn/doc/harmonyos-references/ts-state-management#内置环境变量说明)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 环境变量名称，支持的范围详见[内置环境变量说明](/consumer/cn/doc/harmonyos-references/ts-state-management#内置环境变量说明)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| props | [EnvPropsOptions](/consumer/cn/doc/harmonyos-references/ts-state-management#envpropsoptions10)[] | 是 | 系统环境变量和默认值的键值对的数组。 |
