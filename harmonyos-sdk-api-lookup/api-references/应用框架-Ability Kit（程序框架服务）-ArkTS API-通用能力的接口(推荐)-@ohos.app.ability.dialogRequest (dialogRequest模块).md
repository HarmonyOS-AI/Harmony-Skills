...
| 类型 | 说明 |
| --- | --- |
| [RequestInfo](/consumer/cn/doc/harmonyos-references/js-apis-app-ability-dialogrequest#requestinfo) | 请求方RequestInfo，用于绑定模态窗口。 |
...
| 类型 | 说明 |
| --- | --- |
| [RequestCallback](/consumer/cn/doc/harmonyos-references/js-apis-app-ability-dialogrequest#requestcallback) | 请求方RequestCallback，用于设置返回结果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| windowRect10+ | [WindowRect](/consumer/cn/doc/harmonyos-references/js-apis-app-ability-dialogrequest#windowrect10) | 否 | 是 | 表示模态弹框的位置属性。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| result | [ResultCode](/consumer/cn/doc/harmonyos-references/js-apis-app-ability-dialogrequest#resultcode) | 否 | 否 | 表示结果码。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| result | [RequestResult](/consumer/cn/doc/harmonyos-references/js-apis-app-ability-dialogrequest#requestresult) | 是 | 模态弹框请求结果信息。 |
