...
开始搜寻附近的低功耗蓝牙外围设备。此操作比较耗费系统资源，请在搜索并连接到设备后调用[bluetooth.stopBLEScan](/consumer/cn/doc/harmonyos-references/js-apis-system-bluetooth#bluetoothstopblescanobject)方法停止搜索。
...
停止搜寻附近的低功耗蓝牙外围设备。与[bluetooth.startBLEScan(OBJECT)](/consumer/cn/doc/harmonyos-references/js-apis-system-bluetooth#bluetoothstartblescanobject)接口配套使用。
