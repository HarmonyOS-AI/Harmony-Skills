...
接口最大调用频率限制单个应用每分钟60次，超过此限制会返回错误码[83010002](/consumer/cn/doc/harmonyos-references/push-image-control#section83010002-超出流控阈值)。
...
请按照响应消息中的提示，检查并修改[请求参数](/consumer/cn/doc/harmonyos-references/push-image-control#请求参数)。
...
请根据响应消息中的提示，检查并修改[消息体](/consumer/cn/doc/harmonyos-references/push-image-control#请求参数)内容。
...
请根据响应消息中的提示，检查并修改[push-type](/consumer/cn/doc/harmonyos-references/push-image-control#请求参数)。