...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [PanelType](/consumer/cn/doc/harmonyos-references/js-apis-inputmethod-panel#paneltype) | 否 | 否 | 输入法面板类型。 |
| flag | [PanelFlag](/consumer/cn/doc/harmonyos-references/js-apis-inputmethod-panel#panelflag) | 否 | 是 | 输入法面板状态类型。  - 默认值为固定态。  - 当前仅用于描述软键盘类型的面板的状态。 |
