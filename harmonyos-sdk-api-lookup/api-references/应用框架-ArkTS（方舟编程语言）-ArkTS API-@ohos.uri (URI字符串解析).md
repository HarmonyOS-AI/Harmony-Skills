...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| other | [URI](/consumer/cn/doc/harmonyos-references/js-apis-uri#uri) | 是 | 需要比较的URI对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [URI](/consumer/cn/doc/harmonyos-references/js-apis-uri#uri) | 返回一个path被规范化后的URI对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [URI](/consumer/cn/doc/harmonyos-references/js-apis-uri#uri) | 返回添加查询部分后的URI对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [URI](/consumer/cn/doc/harmonyos-references/js-apis-uri#uri) | 返回已追加字段的URI对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [URI](/consumer/cn/doc/harmonyos-references/js-apis-uri#uri) | 返回一个已被清除查询部分的URI对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [URI](/consumer/cn/doc/harmonyos-references/js-apis-uri#uri) | 返回由给定协议、协议特定部分和片段创建的URI对象。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[equalsTo9+](/consumer/cn/doc/harmonyos-references/js-apis-uri#equalsto9)替代。
