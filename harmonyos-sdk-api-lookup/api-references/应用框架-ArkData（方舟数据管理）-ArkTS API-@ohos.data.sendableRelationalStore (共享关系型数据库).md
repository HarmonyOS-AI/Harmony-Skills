...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| valuesBucket | [NonSendableBucket](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#nonsendablebucket) | 是 | 不可跨线程传递的ValuesBucket数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [ValuesBucket](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#valuesbucket) | 可用于跨线程传递的ValuesBucket数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| valuesBucket | [ValuesBucket](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#valuesbucket) | 是 | 可用于跨线程传递的ValuesBucket数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [NonSendableBucket](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#nonsendablebucket) | 不可跨线程传递的ValuesBucket数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| asset | [NonSendableAsset](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#nonsendableasset) | 是 | 不可跨线程传递的Asset数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [Asset](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#asset) | 可跨线程传递的Asset数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| asset | [Asset](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#asset) | 是 | 可跨线程传递的Asset数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [NonSendableAsset](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#nonsendableasset) | 不可跨线程传递的Asset数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [NonSendableValues](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#nonsendablevalues20) | 不可跨线程传递的数组数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| values | [NonSendableValues](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#nonsendablevalues20) | 是 | 不可跨线程传递的数组数据。 |
...
记录资产附件（文件、图片、视频等类型文件）的相关信息。用于支持资产数据跨线程传递，继承自[lang.ISendable](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkts-lang#langisendable)。资产类型的相关接口暂不支持Datashare。使用[sendableRelationalStore.toSendableAsset](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#sendablerelationalstoretosendableasset)方法创建。
...
| status | number | 否 | 是 | 资产的状态，取值与[relationalStore.AssetStatus](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-e#assetstatus10)枚举值保持一致，默认值为relationalStore.AssetStatus.ASSET\_NORMAL。 |
...
表示[Asset](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#asset)类型数据的集合。用于支持Asset数据集合跨线程传递。
...
| 类型 | 说明 |
| --- | --- |
| [collections.Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-array)<[Asset](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#asset)> | 用于并发场景的Asset附件数据集合。 |
...
| [Asset](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#asset) | 表示值类型为附件Asset。  当字段类型是Asset时，在创建表的sql语句中，类型应当为：ASSET。 |
| [Assets](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#assets) | 表示值类型为附件数据集合Assets。  当字段类型是Assets时，在创建表的sql语句中，类型应当为：ASSETS。 |
...
表示[ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#valuetype)数据的键值对存储，用于支持ValueType数据跨线程传递。
...
| 类型 | 说明 |
| --- | --- |
| [collections.Map](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-map)<string, [ValueType](/consumer/cn/doc/harmonyos-references/js-apis-data-sendablerelationalstore#valuetype)> | 并发场景的键值对数据存储，其中，键的类型为string，值的类型为ValueType。 |
