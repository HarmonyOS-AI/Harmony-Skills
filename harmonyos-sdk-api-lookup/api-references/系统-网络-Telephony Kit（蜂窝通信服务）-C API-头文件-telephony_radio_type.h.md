...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Telephony\_RadioResult](/consumer/cn/doc/harmonyos-references/capi-telephony-radio-type-h#telephony_radioresult) | Telephony\_RadioResult | 错误码类型枚举。 |
| [Telephony\_RegState](/consumer/cn/doc/harmonyos-references/capi-telephony-radio-type-h#telephony_regstate) | Telephony\_RegState | 设备的网络注册状态类型。 |
| [Telephony\_RadioTechnology](/consumer/cn/doc/harmonyos-references/capi-telephony-radio-type-h#telephony_radiotechnology) | Telephony\_RadioTechnology | 设备的无线接入技术类型。 |
| [Telephony\_NsaState](/consumer/cn/doc/harmonyos-references/capi-telephony-radio-type-h#telephony_nsastate) | Telephony\_NsaState | 设备的NSA网络注册状态类型。 |
