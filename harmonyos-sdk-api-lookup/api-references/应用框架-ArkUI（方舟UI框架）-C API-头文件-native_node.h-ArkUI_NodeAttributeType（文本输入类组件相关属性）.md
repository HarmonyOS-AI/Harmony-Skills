...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | false表示退出编辑态，true表示维持现状。  属性获取方法参数[ArkUI\_AttributeItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-attributeitem)格式： |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本超长时的显示方式[ArkUI\_TextOverflow](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_textoverflow)。内联模式非编辑态下默认值为ARKUI\_TEXT\_OVERFLOW\_ELLIPSIS，内联模式编辑态下默认值为ARKUI\_TEXT\_OVERFLOW\_CLIP。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 装饰样式配置项，为可选参数。参数类型为[OH\_ArkUI\_DecorationStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-oh-arkui-decorationstyleoptions)。 |
...
| 类型 | 说明 |
| --- | --- |
| .object | 装饰样式配置项。参数类型为[OH\_ArkUI\_DecorationStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-oh-arkui-decorationstyleoptions)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本超长时的显示方式[ArkUI\_TextOverflow](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_textoverflow)。默认值为ARKUI\_TEXT\_OVERFLOW\_CLIP。 |
