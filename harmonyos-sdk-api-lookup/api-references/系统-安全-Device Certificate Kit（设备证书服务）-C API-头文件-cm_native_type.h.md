...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_CM\_ErrorCode](/consumer/cn/doc/harmonyos-references/capi-cm-native-type-h#oh_cm_errorcode) | OH\_CM\_ErrorCode | 错误码。 |
| [OH\_CM\_CertificatePurpose](/consumer/cn/doc/harmonyos-references/capi-cm-native-type-h#oh_cm_certificatepurpose) | OH\_CM\_CertificatePurpose | 证书凭据用途类型。 |
