...
| 类型 | 说明 |
| --- | --- |
| [Server](/consumer/cn/doc/harmonyos-references/js-apis-link-enhance#server) | 创建成功的服务对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Connection](/consumer/cn/doc/harmonyos-references/js-apis-link-enhance#connection) | 创建成功的连接对象。 |
...
| callback | Callback<[Connection](/consumer/cn/doc/harmonyos-references/js-apis-link-enhance#connection)> | 是 | 注册的回调函数。[Connection](/consumer/cn/doc/harmonyos-references/js-apis-link-enhance#connection)返回的连接对象。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'connectionAccepted'，收到对端连接，触发该事件。 |
| callback | Callback<[Connection](/consumer/cn/doc/harmonyos-references/js-apis-link-enhance#connection)> | 否 | 注册的回调函数。[Connection](/consumer/cn/doc/harmonyos-references/js-apis-link-enhance#connection)返回的连接对象。 |
...
| callback | Callback<[ConnectResult](/consumer/cn/doc/harmonyos-references/js-apis-link-enhance#connectresult)> | 是 | 注册的回调函数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'connectResult'，完成connect()调用，触发该事件。 |
| callback | Callback<[ConnectResult](/consumer/cn/doc/harmonyos-references/js-apis-link-enhance#connectresult)> | 否 | 注册的回调函数。 |
