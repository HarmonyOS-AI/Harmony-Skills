...
请根据响应消息中的提示，检查并修改请求[参数内容](/consumer/cn/doc/harmonyos-references/push-msg-revoke#请求参数)。
...
请根据响应消息中的提示，检查并修改[请求体结构](/consumer/cn/doc/harmonyos-references/push-msg-revoke#请求参数)。
