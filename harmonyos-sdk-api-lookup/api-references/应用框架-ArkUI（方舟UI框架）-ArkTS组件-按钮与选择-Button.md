...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ButtonOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#buttonoptions对象说明) | 是 | 配置按钮的显示样式。 |
...
| options | [ButtonOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#buttonoptions对象说明) | 否 | 配置按钮的显示样式。  未设置时，则按照ButtonOptions中各参数的默认值配置。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [ButtonType](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#buttontype枚举说明) | 否 | 是 | 按钮显示样式。  默认值：ButtonType.ROUNDED\_RECTANGLE  API version 18及之后，ButtonType的默认值修改为ButtonType.ROUNDED\_RECTANGLE。API version 18之前的版本，ButtonType的默认值为ButtonType.Capsule。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ButtonType](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#buttontype枚举说明) | 是 | Button样式。  API version 18及之后，ButtonType的默认值从ButtonType.Capsule变更为ButtonType.ROUNDED\_RECTANGLE。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | 是 | 文本显示字号。  默认值：当controlSize为ControlSize.NORMAL时，默认值为$r('sys.float.Body\_L')。  当controlSize为ControlSize.SMALL时，默认值为$r('sys.float.Body\_S')。  **说明**：设置string类型时，不支持百分比。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 是 | 文本显示颜色。  默认值：$r('sys.color.font\_on\_primary')，显示为白色字体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LabelStyle](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#labelstyle10对象说明) | 是 | Button组件label文本和字体的样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ButtonStyleMode](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#buttonstylemode11枚举说明) | 是 | Button组件的样式和重要程度。  默认值：ButtonStyleMode.EMPHASIZED |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ControlSize](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#controlsize11枚举说明) | 是 | Button组件的尺寸。  默认值：ControlSize.NORMAL |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ButtonRole](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#buttonrole12枚举说明) | 是 | 设置Button组件的角色。  默认值：ButtonRole.NORMAL |
...
| heightAdaptivePolicy | [TextHeightAdaptivePolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#textheightadaptivepolicy10) | 否 | 是 | 设置label文本自适应高度的方式。  默认值：TextHeightAdaptivePolicy.MAX\_LINES\_FIRST  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| triggerClick | [ButtonTriggerClickCallback](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#buttontriggerclickcallback12) | 否 | 否 | 使用builder新构建出来组件的点击事件。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/qjNdcAnURpGRqvtBowC4fg/zh-cn_image_0000002599478533.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035037Z&HW-CC-Expire=86400&HW-CC-Sign=632747B31583CF2284E204663DCF2C7644F506815BBD50068563ABD6FAD26362)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/E5lhpi8-TpCiOICRoNmhmQ/zh-cn_image_0000002568759342.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035037Z&HW-CC-Expire=86400&HW-CC-Sign=7BA4CBBC49BB3CF588F2AF9F43BF230CF13213DBD1A5BCCF2C8B4560A6AA778C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/9w3j4kw8Qq-J697-nJYvPg/zh-cn_image_0000002599358585.png?HW-CC-KV=V1&HW-CC-Date=20260511T035037Z&HW-CC-Expire=86400&HW-CC-Sign=1C44F382D3C2B60873AE9B9D06215DDBDF3CC38894AB27B1637C02259EB51358)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/OtNxn3l3QMynneSRGnDVdw/zh-cn_image_0000002568918990.jpeg?HW-CC-KV=V1&HW-CC-Date=20260511T035037Z&HW-CC-Expire=86400&HW-CC-Sign=9056680F6D92F94236419E4C6BA48E866993096E5341FBE7A2718498502F8961)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/b1mmxUOFQDSWpwvustE9kQ/zh-cn_image_0000002599478535.jpeg?HW-CC-KV=V1&HW-CC-Date=20260511T035037Z&HW-CC-Expire=86400&HW-CC-Sign=7C39F22D3136217001030B79C8DD94103853505616B828C03917C77254C35A44)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/vPPJWEiDRna0NspeAXHT0g/zh-cn_image_0000002568759344.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035037Z&HW-CC-Expire=86400&HW-CC-Sign=7FE02F5A68F969D6BE10D9D7AD5223C42F68BA1DF9BD59AE32DA2F0A0FCB5D34)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/SsSliGaBSXatCcfurXSKTw/zh-cn_image_0000002599358587.jpeg?HW-CC-KV=V1&HW-CC-Date=20260511T035037Z&HW-CC-Expire=86400&HW-CC-Sign=14B7C29D5BB550F0B1E72FD2D8FCE4C6BA58A46D1D08DBE55CD6D7AD0E2FAE86)

### 示例8（设置label文本水平对齐方式）

该示例通过配置[LabelStyle](/consumer/cn/doc/harmonyos-references/ts-basic-components-button#labelstyle10对象说明)的textAlign，设置文本对齐方式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/VxopWVofScWBO6pvAAHlOw/zh-cn_image_0000002568918992.jpeg?HW-CC-KV=V1&HW-CC-Date=20260511T035037Z&HW-CC-Expire=86400&HW-CC-Sign=BD06FD34579583ABEC1DF4028B555C3E229F461FFB17289D7473350543EC3B5E)