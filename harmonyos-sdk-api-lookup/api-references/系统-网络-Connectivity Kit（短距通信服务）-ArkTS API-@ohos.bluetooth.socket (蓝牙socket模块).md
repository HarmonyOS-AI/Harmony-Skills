...
通过[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)创建客户端套接字并向服务端发起连接。

通过[socket.sppListen](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketspplisten)创建服务端套接字并监听客户端的连接。
...
* 通过入参[socket.SppOptions](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#sppoptions)的type参数，可以创建不同链路类型的服务端套接字，适用于不同的场景。该操作会在蓝牙子系统中注册对应的服务，表示服务端支持的能力。
* 客户端可通过[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)向该服务端发起连接请求。
* 当应用不再需要该服务端套接字时，需通过[socket.sppCloseServerSocket](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppcloseserversocket)主动关闭创建时获取到的套接字，蓝牙子系统会删除此前注册的服务。如果此时客户端发起连接，就会连接失败。
...
| options | [SppOptions](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#sppoptions) | 是 | 用于监听的套接字配置参数。 |
...
需要在服务端调用完[socket.sppListen](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketspplisten)后调用该接口，且传入的链路类型[SppType](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)需是SPP\_L2CAP或SPP\_L2CAP\_BLE。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| serverSocket | number | 是 | 服务端套接字的ID。  该值是调用[socket.sppListen](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketspplisten)接口后，通过其异步callback获取到的。 |
...
| 类型 | 说明 |
| --- | --- |
| number | 返回L2CAP链路类型套接字的psm值。  - [SppType](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)设置为SPP\_L2CAP\_BLE时，返回值的有效值范围为[0x01, 0xFF]。  - [SppType](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)设置为SPP\_L2CAP时，返回值的有效值范围为[0x0000, 0xFFFF]。  - 服务端通道建立异常或[SppType](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)非L2CAP链路类型时，返回-1。 |
...
* 须在调用[socket.sppListen](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketspplisten)创建服务端套接字成功后，才能调用该接口监听客户端的连接请求。
* 客户端可通过[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)向该服务端发起连接请求。
* 连接建立成功后，即可通过[socket.sppWrite](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppwrite)、[socket.sppWriteAsync](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppwriteasync18)、[socket.sppReadAsync](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppreadasync18)等接口，同客户端进行数据传输。
* 当服务端不再需要已建立的连接时，可通过[socket.sppCloseClientSocket](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppcloseclientsocket)主动断开指定的客户端套接字连接。
...
* 通过[SppOptions](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#sppoptions)参数的type表示需要连接的服务类型。
* 需确保服务端设备已具备需要连接的服务。服务端可通过[socket.sppListen](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketspplisten)注册并监听连接请求。
* 连接建立成功后，即可通过[socket.sppWrite](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppwrite)或[socket.sppWriteAsync](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppwriteasync18)接口，同服务端进行数据传输。
* 当客户端不再需要已建立的连接时，可通过[socket.sppCloseclientSocket](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppcloseclientsocket)主动断开连接。
...
| options | [SppOptions](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#sppoptions) | 是 | 客户端套接字连接配置参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| clientSocket | number | 是 | 客户端套接字的ID。  该值是调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)或[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)接口后，通过其异步callback获取到的。 |
...
* 需先调用[socket.sppListen](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketspplisten)并获取到有效的服务端监听套接字标识符。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| socket | number | 是 | 服务端监听套接字的ID。  该值是调用[socket.sppListen](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketspplisten)接口，通过其异步callback获取到的。 |
...
* 若客户端使用，需在调用[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)后，且连接成功后使用。
* 若服务端使用，需在调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)后，且连接成功后使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| socket | number | 是 | 客户端套接字的ID。  该值是调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)或[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)接口，通过其异步callback获取到的。 |
...
* 若客户端使用，需在调用[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)后，且连接成功后使用。
* 若服务端使用，需在调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)后，且连接成功后使用。
* 若开发者需感知传输过程中异常断连等错误，建议使用[socket.sppWriteAsync](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppwriteasync18)。
...
* 链路类型为[SPP\_L2CAP](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)或[SPP\_L2CAP\_BLE](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)时，单次发送数据大小存在限制，单位为Byte，超过限制范围的数据将被截断。链路类型为SPP\_L2CAP\_BLE时单次发送数据大小范围为[1, 65535]；链路类型为SPP\_L2CAP时服务端单次发送数据大小范围为[1, 4091]，客户端单次发送数据大小范围为[1, 8085]。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| clientSocket | number | 是 | 客户端套接字的ID。  该值是调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)或[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)接口，通过其异步callback获取到的。 |
...
* 若客户端使用，需在调用[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)后，且连接成功后使用。
* 若服务端使用，需在调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)后，且连接成功后使用。
* 不可以和API version 18开始支持的[socket.sppReadAsync](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppreadasync18)接口混用，同一路套接字连接只能使用socket.on('sppRead')接口或者[socket.sppReadAsync](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppreadasync18)接口。
* 若开发者需感知传输过程中异常断连等错误，建议使用[socket.sppReadAsync](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppreadasync18)。
* 链路类型为[SPP\_RFCOMM](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)时，当接收数据大小超过1024字节时，会自动分多次接收，每次接收数据大小范围为[1, 1024]。
* 链路类型为[SPP\_L2CAP](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)或[SPP\_L2CAP\_BLE](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)时，单次接收数据大小存在限制，需一次性读取全部数据，单位为Byte，超过最大接收数据大小限制将被截断。链路类型为SPP\_L2CAP\_BLE时单次接收数据大小范围为[1, 65535]；链路类型为SPP\_L2CAP时服务端和客户端单次接收数据大小范围为[1, 8087]。
...
| clientSocket | number | 是 | 客户端套接字的ID。  该值是调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)或[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)接口，通过其异步callback获取到的。 |
| callback | Callback<ArrayBuffer> | 否 | 指定取消订阅的回调函数通知。  若传参，则需与[socket.on('sppRead')](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketonsppread)中的回调函数一致；若无传参，则取消订阅该type对应的所有回调函数通知。 |
...
* 链路类型为[SPP\_L2CAP](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)或[SPP\_L2CAP\_BLE](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)时，单次发送数据大小存在限制，单位为Byte，超过限制大小的数据将被截断。链路类型为SPP\_L2CAP\_BLE时单次发送数据大小范围为[1, 65535]；链路类型为SPP\_L2CAP时服务端单次发送数据大小范围为[1, 4091]，客户端单次发送数据大小范围为[1, 8085]。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| clientSocket | number | 是 | 客户端套接字的ID。  该值是调用[sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)或[sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)接口，通过其异步callback获取到的。 |
| data | ArrayBuffer | 是 | 写入的数据。 |
...
* 若客户端使用，需在调用[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)后，且连接成功后使用。
* 若服务端使用，需在调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)后，且连接成功后使用。
* 不可以和API version 10开始支持的[socket.on('sppRead')](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketonsppread)接口混用，同一路socket只能使用[socket.on('sppRead')](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketonsppread)接口或者socket.sppReadAsync接口。
...
* 若客户端使用，需在调用[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)后，且连接成功后使用。
* 若服务端使用，需在调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)后，且连接成功后使用。
* 若套接字链路类型为[SPP\_RFCOMM](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)时，最大接收数据大小无限制且返回值为0。
...
* 若客户端使用，需在调用[socket.sppConnect](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppconnect)后，且连接成功后使用。
* 若服务端使用，需在调用[socket.sppAccept](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketsppaccept)后，且连接成功后使用。
* 若套接字链路类型为[SPP\_RFCOMM](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype)时，最大发送数据大小无限制且返回值为0。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| uuid | string | 否 | 否 | RFCOMM套接字链路类型的服务UUID，例如"00001101-0000-1000-8000-00805F9B34FB"。  - 建议开发者使用自定义的服务UUID（可通过工具函数[util.generateRandomUUID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-util#utilgeneraterandomuuid9)生成），也可以使用标准协议定义的Serial Port UUID服务(00001101-0000-1000-8000-00805F9B34FB)。  - SppType设置为SPP\_RFCOMM时该参数必选。  - SppType设置为SPP\_L2CAP或SPP\_L2CAP\_BLE时设置为空字符串。 |
| secure | boolean | 否 | 否 | 是否是安全通道。true表示是安全通道，false表示非安全通道。 |
| type | [SppType](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#spptype) | 否 | 否 | 蓝牙套接字链路类型。 |
| psm20+ | number | 否 | 是 | 协议/服务多路复用器值，用于标识特定的服务数据传输通道。不填写该参数时默认值为-1。  对于客户端：  - SppType设置为SPP\_RFCOMM时，该参数不填。  - SppType设置为SPP\_L2CAP\_BLE或SPP\_L2CAP时，需和服务端的psm值保持一致。  对于服务端：  - SppType设置为SPP\_RFCOMM时，该参数不填。  - SppType设置为SPP\_L2CAP\_BLE时，psm值必须由系统自动分配，有效值范围为[0x01, 0xFF]。  - SppType设置为SPP\_L2CAP时，psm值可以主动设置或蓝牙子系统分配，若为主动设置，其有效范围为[0x00, 0xFFFF]，并且需要满足低位字节最低位必须为1，高位字节最低位必须为0；若为蓝牙子系统分配，该参数不填，可以通过[socket.getL2capPsm](/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-socket#socketgetl2cappsm20)接口获取psm值。 |
