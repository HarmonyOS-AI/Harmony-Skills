...
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#bufferencoding) | 否 | 编码格式（当fill为string时，才有意义）。默认值：'utf8'。传入无法识别的encoding会抛出TypeError。 |
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | 返回一个FastBuffer对象。 |
...
从缓冲池中创建指定大小未初始化的FastBuffer对象，需要使用[fill](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fill)函数来初始化FastBuffer对象。
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | 未初始化的Buffer实例。 |
...
创建指定大小未初始化的FastBuffer对象，需要使用[fill](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fill)函数来初始化FastBuffer对象。
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | 未初始化的FastBuffer实例。 |
...
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#bufferencoding) | 否 | 编码格式。默认值：'utf8'。传入无法识别的encoding会抛出TypeError。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| buf1 | [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | Uint8Array | 是 | 待比较的第一个对象。 |
| buf2 | [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | Uint8Array | 是 | 待比较的第二个对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| list | [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer)[] | Uint8Array[] | 是 | 实例数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | 返回新的FastBuffer对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | 新的FastBuffer对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | 返回一个FastBuffer对象，该对象与入参对象arrayBuffer共享相同的内存区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| buffer | [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | Uint8Array | 是 | 对象数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | Uint8Array | 是 | 实例对象。 |
| fromEnc | string | 是 | 当前编码格式。支持的格式范围为BufferEncoding。传入空字符串时，表示使用编码格式'utf8'。 |
| toEnc | string | 是 | 目标编码。 支持的格式范围为[BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#bufferencoding)。 |
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | 将当前编码转换成目标编码，并返回一个新的FastBuffer对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| target | [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | Uint8Array | 是 | 要比较的实例对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| target | [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | Uint8Array | 是 | 要复制到的Buffer或Uint8Array实例。 |
...
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#bufferencoding) | 否 | 字符编码格式（value为string才有意义）。默认值：'utf8'。传入无法识别的encoding会抛出TypeError。 |
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#fastbuffer) | 返回填充后的FastBuffer对象。 |
...
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#bufferencoding) | 否 | 字符编码格式。默认值：'utf8'。传入无法识别的encoding会抛出TypeError。 |
...
| encoding | [BufferEncoding](/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer#bufferencoding) | 否 | 字符编码格式。默认值：'utf8'。 |
