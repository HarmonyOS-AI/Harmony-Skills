...
| **名称** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| exerciseHeartRate | [ExerciseHeartRate](/consumer/cn/doc/harmonyos-references/health-api-healthfields-lite#exerciseheartrate)[] | 否 | 运动心率详情列表，若未填写，默认为空。 |
...
| **名称** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| heartRate | [ExerciseHeartRate](/consumer/cn/doc/harmonyos-references/health-api-healthfields-lite#exerciseheartrate)[] | 否 | 运动心率详情列表，若未填写，默认为空。 |
...
| totalTrainingVolume | number | 否是 | 训练总容量,单位：kg。 |
