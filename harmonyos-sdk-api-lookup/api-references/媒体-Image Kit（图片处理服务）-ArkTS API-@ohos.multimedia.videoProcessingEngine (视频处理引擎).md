...
本模块包含一个基础类：[ImageProcessor](/consumer/cn/doc/harmonyos-references/js-apis-videoprocessingengine#imageprocessor)类。
...
| 类型 | 说明 |
| --- | --- |
| [ImageProcessor](/consumer/cn/doc/harmonyos-references/js-apis-videoprocessingengine#imageprocessor) | 图片处理模块实例。 |
...
| level | [QualityLevel](/consumer/cn/doc/harmonyos-references/js-apis-videoprocessingengine#qualitylevel) | 否 | 算法档位（HIGH、MEDIUM、LOW、NONE），默认为NONE。 |
...
| --- | --- | --- | --- |
| sourceImage | [image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | 是 | 输入图像，内存类型需为DMA内存，具体情况请参考[PixelMap的内存类型介绍](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-allocator-type#内存类型介绍)。 |
| scale | number | 是 | 目标缩放比例。取值范围(0.0, 32.0]（在满足[上述分辨率范围](/consumer/cn/doc/harmonyos-references/js-apis-videoprocessingengine#enhancedetail)的前提下，最高支持32倍放大）。 |
| level | [QualityLevel](/consumer/cn/doc/harmonyos-references/js-apis-videoprocessingengine#qualitylevel) | 否 | 算法档位（HIGH、MEDIUM、LOW、NONE），默认为NONE。 |
