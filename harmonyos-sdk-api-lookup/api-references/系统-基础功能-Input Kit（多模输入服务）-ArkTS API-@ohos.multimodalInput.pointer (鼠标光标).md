...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | number | 是 | 窗口ID。取值范围为大于等于-1的整数，取值为-1时表示全局窗口。  窗口ID合法并且对应窗口存在时，返回窗口的鼠标光标样式。  窗口ID合法但窗口不存在时，默认返回全局鼠标光标样式。  如果通过[setPointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointersetpointerstyle)接口为不存在的窗口设置了鼠标光标样式，使用本接口可以正常获取到该光标样式。 |
| callback | AsyncCallback<[PointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointerstyle)> | 是 | 回调函数，返回鼠标样式类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | number | 是 | 窗口ID。取值范围为大于等于-1的整数，取值为-1时表示全局窗口。  窗口ID合法并且对应窗口存在时，返回窗口的鼠标光标样式。  窗口ID合法但窗口不存在时，默认返回全局鼠标光标样式。  如果通过[setPointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointersetpointerstyle-1)接口为不存在的窗口设置了鼠标光标样式，使用本接口可以正常获取到该光标样式。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointerstyle)> | Promise对象，返回鼠标样式类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | number | 是 | 窗口ID。取值范围为大于等于-1的整数，取值为-1时表示全局窗口。  窗口ID合法并且对应窗口存在时，返回窗口的鼠标光标样式。  窗口ID合法但窗口不存在时，默认返回全局鼠标光标样式。  如果通过[setPointerStyleSync](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointersetpointerstylesync10)接口为不存在的窗口设置了鼠标光标样式，使用本接口可以正常获取到该光标样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [PointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointerstyle) | 返回鼠标样式类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | number | 是 | 窗口ID。取值范围为大于等于0的整数。  窗口ID合法并且对应窗口存在时，可以设置窗口的鼠标光标样式。  窗口ID合法但窗口不存在时，也可以设置鼠标光标样式。  设置结果可通过[getPointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointergetpointerstyle)获取。 |
| pointerStyle | [PointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointerstyle) | 是 | 鼠标样式。 |
| callback | AsyncCallback<void> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | number | 是 | 窗口ID。取值范围为大于等于0的整数。  窗口ID合法并且对应窗口存在时，可以设置窗口的鼠标光标样式。  窗口ID合法但窗口不存在时，也可以设置鼠标光标样式。  设置结果可通过[getPointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointergetpointerstyle-1)获取。 |
| pointerStyle | [PointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointerstyle) | 是 | 鼠标样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | number | 是 | 窗口ID。取值范围为大于等于0的整数。  窗口ID合法并且对应窗口存在时，可以设置窗口的鼠标光标样式。  窗口ID合法但窗口不存在时，也可以设置鼠标光标样式。  设置结果可通过[getPointerStyleSync](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointergetpointerstylesync10)获取。 |
| pointerStyle | [PointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointerstyle) | 是 | 鼠标样式。 |
...
| DEVELOPER\_DEFINED\_ICON22+ | -100 | 自定义光标，开发者可使用[setCustomCursor](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointersetcustomcursor15)设置自定义光标，不支持使用[setPointerStyle](/consumer/cn/doc/harmonyos-references/js-apis-pointer#pointersetpointerstyle-1)直接设置。 | 自定义光标样式，通过接口设置。 |
