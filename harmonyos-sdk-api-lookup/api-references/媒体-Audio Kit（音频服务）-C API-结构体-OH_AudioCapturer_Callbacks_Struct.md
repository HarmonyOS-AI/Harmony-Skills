...
| 名称 | 描述 |
| --- | --- |
| [int32\_t (\*OH\_AudioCapturer\_OnReadData)(OH\_AudioCapturer\* capturer,void\* userData,void\* buffer,int32\_t length)](/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiocapturer-callbacks-struct#oh_audiocapturer_onreaddata) | 该函数指针将指向用于读取音频数据的回调函数。 |
| [int32\_t (\*OH\_AudioCapturer\_OnStreamEvent)(OH\_AudioCapturer\* capturer,void\* userData,OH\_AudioStream\_Event event)](/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiocapturer-callbacks-struct#oh_audiocapturer_onstreamevent) | 该函数指针将指向用于处理音频录制流事件的回调函数。 |
| [int32\_t (\*OH\_AudioCapturer\_OnInterruptEvent)(OH\_AudioCapturer\* capturer,void\* userData,OH\_AudioInterrupt\_ForceType type,OH\_AudioInterrupt\_Hint hint)](/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiocapturer-callbacks-struct#oh_audiocapturer_oninterruptevent) | 该函数指针将指向用于处理音频录制中断事件的回调函数。 |
| [int32\_t (\*OH\_AudioCapturer\_OnError)(OH\_AudioCapturer\* capturer, void\* userData, OH\_AudioStream\_Result error)](/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiocapturer-callbacks-struct#oh_audiocapturer_onerror) | 该函数指针将指向用于处理音频录制错误结果的回调函数。 |
