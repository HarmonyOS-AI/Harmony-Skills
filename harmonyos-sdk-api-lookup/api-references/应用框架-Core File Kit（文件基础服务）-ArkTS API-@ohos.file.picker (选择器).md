...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [DocumentSelectOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentselectoptions) | 否 | documentPicker选择选项。若无此参数，则默认拉起documentPicker主界面。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [DocumentSelectOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentselectoptions) | 是 | documentPicker选择选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [DocumentSaveOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentsaveoptions) | 否 | documentPicker保存选项。若无此参数，则拉起documentPicker界面后需用户自行输入保存的文件名。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [DocumentSaveOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentsaveoptions) | 是 | documentPicker保存选项。 |
...
该方法只在调用 [save()](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#save)时使用生效，其他场景下不适用。

该方法需要配置参数[DocumentSaveOptions.fileSuffixChoices](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentsaveoptions)。

该方法返回的是所选后缀类型的下标(number)。所选的后缀类型是开发者所传的参数[DocumentSaveOptions.fileSuffixChoices](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentsaveoptions)里的某个后缀类型。如果没有传参，并且调用了getSelectedIndex()方法，返回值为-1。
...
| 类型 | 说明 |
| --- | --- |
| number | 返回所选后缀类型在[DocumentSaveOptions.fileSuffixChoices](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentsaveoptions)里的下标(number)。默认返回-1。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [AudioSelectOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#audioselectoptions) | 否 | audioPicker音频选择选项。若无此参数，则默认拉起audioPicker主界面。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [AudioSelectOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#audioselectoptions) | 是 | audioPicker音频选择选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [AudioSaveOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#audiosaveoptions) | 否 | audioPicker保存音频文件选项。若无此参数，则拉起audioPicker界面后需用户自行输入保存的文件名。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [AudioSaveOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#audiosaveoptions) | 是 | audioPicker保存音频文件选项。 |
...
| selectMode11+ | [DocumentSelectMode](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentselectmode11) | 否 | 是 | Picker选择的文档类型，默认值是FILE(文件类型)。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  **系统能力**：SystemCapability.FileManagement.UserFileService.FolderSelection |
...
| mergeMode15+ | [MergeTypeMode](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#mergetypemode15) | 否 | 是 | 开启聚合视图模式，支持拉起文件管理应用的聚合视图。默认为DEFAULT，表示该参数不生效，非聚合视图。当该参数置为非DEFAULT时，其他参数不生效。  **设备行为差异**：该参数在Phone设备中可正常使用，在其他设备中无效果。  **元服务API**：从API version 15开始，该接口支持在元服务中使用。  **系统能力**：SystemCapability.FileManagement.UserFileService |
...
| pickerMode12+ | [DocumentPickerMode](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentpickermode12) | 否 | 是 | 拉起picker的类型, 默认为DEFAULT。当pickerMode设置为DOWNLOAD时，用户配置的参数newFileNames、defaultFilePathUri和fileSuffixChoices将不会生效。  **元服务API**：从API version 12开始，该接口支持在元服务中使用。  **系统能力**：SystemCapability.FileManagement.UserFileService |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [PhotoSelectOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#photoselectoptionsdeprecated) | 否 | photoPicker选择选项。若无此参数，则默认选择媒体文件类型为图片和视频类型。选择媒体文件数量的默认最大值为50。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PhotoSelectResult](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#photoselectresultdeprecated)> | Promise对象。返回photoPicker选择后的结果集。  **注意**：此接口返回的PhotoSelectResult对象中的photoUris只能通过临时授权的方式调用接口[photoAccessHelper.getAssets](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-photoaccesshelper#getassets)去使用，具体使用方式参见用户文件URI介绍中的[媒体文件URI的使用方式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri的使用方式)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [PhotoSelectOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#photoselectoptionsdeprecated) | 是 | photoPicker选择选项。 |
| callback | AsyncCallback<[PhotoSelectResult](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#photoselectresultdeprecated)> | 是 | callback返回photoPicker选择后的结果集。  **注意**：此接口返回的PhotoSelectResult对象中的photoUris只能通过临时授权的方式调用接口[photoAccessHelper.getAssets](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-photoaccesshelper#getassets)去使用，具体使用方式参见用户文件URI介绍中的[媒体文件URI的使用方式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri的使用方式)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [PhotoSaveOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#photosaveoptionsdeprecated) | 否 | photoPicker保存图片或视频文件选项。若无此参数，则拉起photoPicker界面后需用户自行输入保存的文件名。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [PhotoSaveOptions](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#photosaveoptionsdeprecated) | 是 | photoPicker保存图片或视频文件选项。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| MIMEType | [PhotoViewMIMETypes](/consumer/cn/doc/harmonyos-references/js-apis-file-picker#photoviewmimetypesdeprecated) | 否 | 是 | 可选择的媒体文件类型。若无此参数，则默认为图片和视频类型。  **说明**：从API version 9开始支持，从API version 18开始废弃。 |
