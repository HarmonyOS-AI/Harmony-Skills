...
| publicKeyAlgorithm | [Algorithm](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#algorithm) | 否 | 否 | 密码算法。 |
| publicKey | Uint8Array | 否 | 是 | publicKey凭证请求的选项。默认值为空。 |
| authenticatorData | Uint8Array | 否 | 否 | 认证器数据。 |
| transports | string[] | 否 | 否 | 定义身份认证器访问类型，取值范围为[AuthenticatorTransport](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatortransport)枚举。 |
...
| transports | Array<string> | 否 | 否 | 定义身份认证器访问类型，取值范围为[AuthenticatorTransport](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatortransport)枚举。 |
...
| response | [AuthenticatorAttestationResponse](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatorattestationresponse) | 是 | 否 | 返回报文。 |
| authenticatorAttachment | [AuthenticatorAttachment](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatorattachment) | 是 | 是 | 认证器信息（平台、漫游），默认值为platform。 |
| id | string | 是 | 否 | 凭据ID（base64格式）。长度限制0到512。 |
| type | string | 是 | 否 | 凭据类型。长度限制0到512。 |
| clientExtensionResults | [AuthenticationExtensionsClientOutputs](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticationextensionsclientoutputs) | 是 | 否 | 客户端扩展结果。 |
| registrationResponseJson | [RegistrationResponseJson](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#registrationresponsejson) | 否 | 否 | 认证结果，JSON格式。 |
...
| response | [AuthenticatorAttestationResponseJson](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatorattestationresponsejson) | 否 | 否 | 认证器证明响应。 |
| authenticatorAttachment | string | 否 | 是 | 认证器信息（平台、漫游），默认值为platform。长度限制0到512。 |
| clientExtensionResults | [AuthenticationExtensionsClientOutputsJson](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticationextensionsclientoutputsjson) | 否 | 否 | 客户端扩展结果。当前版本不支持扩展，因此占位符始终为NULL，必须将clientExtensionResults键对应的值解析为{}。 |
...
| allowCredentials | Array<[PublicKeyCredentialDescriptor](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialdescriptor)> | 否 | 是 | 认证凭据的附加参数列表。默认值为空。 |
| userVerification | [UserVerificationRequirement](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#userverificationrequirement) | 否 | 是 | 用户认证需求枚举。默认值为preferred。 |
| hints | Array<[PublicKeyCredentialHint](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialhint)> | 否 | 是 | 认证方式指示。默认值为[]。 |
...
| --- | --- | --- | --- | --- |
| rawId | Uint8Array | 是 | 否 | 凭据唯一索引。 |
| response | [AuthenticatorAssertionResponse](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatorassertionresponse) | 是 | 否 | 返回报文。 |
| authenticatorAttachment | [AuthenticatorAttachment](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatorattachment) | 是 | 是 | 认证器信息（平台、漫游），默认值为platform。 |
| id | string | 是 | 否 | 凭据ID（base64格式）。长度限制0到512。 |
| type | string | 是 | 否 | 凭据类型。长度限制0到512。 |
| clientExtensionResults | [AuthenticationExtensionsClientOutputs](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticationextensionsclientoutputs) | 否 | 否 | 客户端扩展结果。 |
| authenticationResponseJson | [AuthenticationResponseJson](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticationresponsejson) | 否 | 否 | 认证响应数据，格式为JSON字符串。 |
...
| response | [AuthenticatorAssertionResponseJson](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatorassertionresponsejson) | 否 | 否 | 认证器断言响应，JSON字符串的结构。 |
| authenticatorAttachment | string | 否 | 是 | 认证器信息（平台、漫游），默认值为platform。长度限制0到512。 |
| clientExtensionResults | [AuthenticationExtensionsClientOutputsJson](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticationextensionsclientoutputsjson) | 否 | 否 | 客户端扩展结果。当前版本不支持扩展，因此占位符始终为NULL，必须将clientExtensionResults键对应的值解析为{}。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| mediation | [CredentialMediationRequirement](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#credentialmediationrequirement) | 否 | 是 | 该操作是否需要用户参与，默认值为"optional"。 |
| publicKey | [PublicKeyCredentialCreationOptions](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialcreationoptions) | 否 | 否 | FIDO2注册报文，包含challenge、rp、用户信息、认证器选择结果等信息。 |
...
| --- | --- | --- | --- | --- |
| mediation | [CredentialMediationRequirement](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#credentialmediationrequirement) | 否 | 是 | 该操作是否需要用户参与，默认值为"optional"。 |
| publicKey | [PublicKeyCredentialRequestOptions](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialrequestoptions) | 否 | 否 | FIDO2认证报文，包含challenge、依赖方信息、用户信息、认证器选择结果等信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| status | [TokenBindingStatus](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#tokenbindingstatus) | 否 | 否 | TokenBinding协议中客户端的绑定状态。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| authenticatorAttachment | [AuthenticatorAttachment](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatorattachment) | 否 | 是 | 认证器信息。默认值为platform。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [PublicKeyCredentialType](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialtype) | 否 | 否 | 凭证类型。 |
| id | Uint8Array | 否 | 否 | 凭据的标识符。 |
| transports | Array<[AuthenticatorTransport](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatortransport)> | 否 | 是 | 定义身份认证器访问类型，取值范围为[AuthenticatorTransport](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatortransport)枚举，默认值为空列表。 |
...
| --- | --- | --- | --- | --- |
| type | [PublicKeyCredentialType](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialtype) | 否 | 否 | 凭证类型。 |
| alg | [Algorithm](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#algorithm) | 否 | 否 | 算法。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rp | [PublicKeyCredentialRpEntity](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialrpentity) | 否 | 否 | 创建新凭证时依赖方属性。 |
| user | [PublicKeyCredentialUserEntity](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialuserentity) | 否 | 否 | 用户信息。 |
| challenge | Uint8Array | 否 | 否 | 挑战值。长度限制16到512。 |
| pubKeyCredParams | Array<[PublicKeyCredentialParameters](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialparameters)> | 否 | 否 | 身份验证凭据的附加参数列表。 |
| timeout | number | 否 | 是 | 超时时间。默认值为300000ms。限制300s到600s。 |
| excludeCredentials | Array<[PublicKeyCredentialDescriptor](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialdescriptor)> | 否 | 是 | FIDO服务器已注册的凭据列表，默认值为空数组。 |
| authenticatorSelection | [AuthenticatorSelectionCriteria](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatorselectioncriteria) | 否 | 是 | 身份认证器相关配置项。默认值为空。 |
| hints | Array<[PublicKeyCredentialHint](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeycredentialhint)> | 否 | 是 | 提示。默认值为空数组。 |
| attestation | [AttestationConveyancePreference](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#attestationconveyancepreference) | 否 | 是 | 凭证首选项，默认值为“none”。 |
...
| uvm | [Uvm](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#uvm) | 是 | 否 | 支持的平台认证器类型，人脸、指纹、PIN码。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Map<[ClientCapability](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#clientcapability), boolean>> | Promise对象，返回能力枚举的列表，用true和false代表支持或不支持。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[AuthenticatorMetadata](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#authenticatormetadata)>> | Promise对象，返回认证器元数据列表。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context#context) | 是 | 当前Ability的上下文。 |
| options | [CredentialCreationOptions](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#credentialcreationoptions) | 是 | 注册报文选项。 |
| tokenBinding | [TokenBinding](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#tokenbinding) | 否 | 通道参数，默认值为空。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PublicKeyAttestationCredential](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeyattestationcredential)> | Promise对象，返回注册结果。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context#context) | 是 | 当前Ability的上下文。 |
| options | [CredentialRequestOptions](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#credentialrequestoptions) | 是 | 认证报文选项。 |
| tokenBinding | [TokenBinding](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#tokenbinding) | 否 | 通道参数，默认值为空。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PublicKeyAssertionCredential](/consumer/cn/doc/harmonyos-references/onlineauthentication-passkey-api#publickeyassertioncredential)> | Promise对象，返回认证结果。 |
