...
| 类型 | 说明 |
| --- | --- |
| [ImageData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#imagedata) | [ImageData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#imagedata)[] | 待识别的图片数组。可输入一个或多个图片。 |
...
| --- | --- | --- | --- | --- |
| resId | string | 否 | 否 | 资源标识符。 |
| statusCode | [downloadStatusCode](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadstatuscode) | 否 | 否 | 状态码。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| inputData | [InputData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#inputdata) | 否 | 否 | 待识别的图片。可以是单个对象或多个对象的数组。 |
| scene | [SceneMode](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#scenemode) | 否 | 是 | 请求的场景模式。  该参数为预留字段，暂未实现。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadStartData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadstartdata)> | 是 | Callback回调返回是哪个资源开始下载。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadCompleteData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadcompletedata)> | 是 | Callback回调返回完成下载的资源标识符及版本。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadCancelData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadcanceldata)> | 是 | Callback回调返回是哪个资源取消下载。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadStatusData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadstatusdata)> | 是 | Callback回调返回下载状态信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadProgressData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadprogressdata)> | 是 | Callback回调返回下载进度信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadStartData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadstartdata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadCompleteData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadcompletedata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadCancelData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadcanceldata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadStatusData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadstatusdata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<[DownloadProgressData](/consumer/cn/doc/harmonyos-references/core-vision-vision-base-api#downloadprogressdata)> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
