...
| revisitShareRecordData | [RevisitShareRecordData](/consumer/cn/doc/harmonyos-references/share-system-share#revisitsharerecorddata) | 否 | 是 | 通过该字段生成二维码复访分享图。支持类型见[RevisitShareRecordType](/consumer/cn/doc/harmonyos-references/share-system-share#revisitsharerecordtype)。  **起始版本：** 6.1.0(23)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| anchor | [ShareControllerAnchor](/consumer/cn/doc/harmonyos-references/share-system-share#sharecontrolleranchor) | string | 否 | 是 | 类型为string时，表示分享面板关联的控件ID（[ArkUI组件常规属性的id值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-common-attributes#常规属性)）。  类型为ShareControllerAnchor时，表示锚点位置。  不传此参数时，面板会显示在默认位置(居中)。 |
| previewMode | [SharePreviewMode](/consumer/cn/doc/harmonyos-references/share-system-share#sharepreviewmode) | 否 | 是 | 预览的模式，缺省为卡片模式。 |
| selectionMode | [SelectionMode](/consumer/cn/doc/harmonyos-references/share-system-share#selectionmode) | 否 | 是 | 选择的模式，缺省为单选模式。 |
| excludedAbilities | Array<[ShareAbilityType](/consumer/cn/doc/harmonyos-references/share-system-share#shareabilitytype)> | 否 | 是 | 操作区不需要显示的能力列表。  **起始版本：** 5.0.0(12)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| windowOffset | [Offset](/consumer/cn/doc/harmonyos-references/share-system-share#offset) | 否 | 否 | 相对锚点的窗体偏移值。 |
| size | [Size](/consumer/cn/doc/harmonyos-references/share-system-share#size) | 否 | 是 | 锚点矩形的尺寸，缺省时，锚点是一个点，即宽高都为0。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| targetAbilityInfo | [ShareAbilityInfo](/consumer/cn/doc/harmonyos-references/share-system-share#shareabilityinfo) | 是 | 否 | 用户分享渠道的信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| name | string | 否 | 否 | 分享渠道的名称。  - 系统操作有固定名称。请参见：[ShareAbilityName](/consumer/cn/doc/harmonyos-references/share-system-share#shareabilityname)。  - 非系统操作采用'[bundleName]#[moduleName]#[abilityName]'格式拼接。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| revisitShareRecordType | [RevisitShareRecordType](/consumer/cn/doc/harmonyos-references/share-system-share#revisitsharerecordtype) | 否 | 否 | 复访分享数据类型。 |
...
| readingShareStyle | [ReadingShareRecordStyle](/consumer/cn/doc/harmonyos-references/share-system-share#readingsharerecordstyle) | 否 | 是 | 阅读分享模版数据类型， 默认STYLE\_HIGHLIGHT\_CONTENT。 |
...
| coverImageUri | string | 否 | 是 | 封面图uri路径（应用文件URI）（如：书籍封面图路径）。readingShareStyle为STYLE\_HIGHLIGHT\_TITLE生效。  应用文件URI，参见：[应用文件分享](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/share-app-file)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| record | [SharedRecord](/consumer/cn/doc/harmonyos-references/share-system-share#sharedrecord) | 是 | 分享数据记录对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| record | [SharedRecord](/consumer/cn/doc/harmonyos-references/share-system-share#sharedrecord) | 是 | 要添加到分享数据对象中的数据记录，该记录为SharedRecord对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[SharedRecord](/consumer/cn/doc/harmonyos-references/share-system-share#sharedrecord)> | 当前分享数据对象内所包含的记录。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [SharedData](/consumer/cn/doc/harmonyos-references/share-system-share#shareddata) | 是 | 分享数据。 |
...
| options | [ShareControllerOptions](/consumer/cn/doc/harmonyos-references/share-system-share#sharecontrolleroptions) | 是 | 分享控制器配置项。 |
...
| callback | Callback<[ShareOperationResult](/consumer/cn/doc/harmonyos-references/share-system-share#shareoperationresult)> | 是 | 事件回调。 |
...
| callback | Callback<[ShareOperationResult](/consumer/cn/doc/harmonyos-references/share-system-share#shareoperationresult)> | 否 | 回调函数。可以指定传入on中的callback取消对应的监听，也可以不指定callback清空所有监听。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[SharedData](/consumer/cn/doc/harmonyos-references/share-system-share#shareddata)> | Promise对象，返回分享数据。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ContactInfo](/consumer/cn/doc/harmonyos-references/share-system-share#contactinfo)> | Promise对象，返回联系人信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [SharedData](/consumer/cn/doc/harmonyos-references/share-system-share#shareddata) | 是 | 分享目标应用的分享数据信息。 |
| options | [ShareControllerOptions](/consumer/cn/doc/harmonyos-references/share-system-share#sharecontrolleroptions) | 否 | 分享控制器配置项。 |
