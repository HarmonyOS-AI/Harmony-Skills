...
| type | [FormType](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formtype) | 否 | 否 | 卡片类型。当前支持JS卡片、ArkTS卡片。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| jsComponentName | string | 否 | 否 | js卡片的组件名。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| colorMode(deprecated) | [ColorMode](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#colormodedeprecated) | 否 | 否 | 卡片颜色模式。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  **说明：**  从API version 9开始支持，从API version 20开始废弃。应用卡片需要支持深浅色两种显示模式，无替代接口。 |
...
| defaultDimension | number | 否 | 否 | 卡片规格。具体可选规格参考[FormDimension](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formdimension)。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  **说明：** 数值为[1, 9]的整数，数值5从API version 9开始支持，从API version 20开始废弃。 |
| supportDimensions | Array<number> | 否 | 否 | 卡片支持的规格。具体可选规格参考[FormDimension](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formdimension)  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  **说明：** 最大长度为9，数值取值范围[1, 9]的的整数的数组，数值5从API version 9开始支持，从API version 20开始废弃。 |
...
| supportedShapes12+ | Array<number> | 否 | 否 | 卡片支持的形状。具体可选形状参考[FormShape12+](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formshape12)  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| formState | [FormState](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formstate) | 否 | 否 | 卡片状态。 |
...
| DIMENSION\_KEY | 'ohos.extra.param.key.form\_dimension' | 卡片规格，规格尺寸参考[FormDimension](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formdimension)。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| UPDATE\_FORM\_REASON\_KEY24+ | 'ohos.extra.param.key.update\_form\_reason' | [卡片更新的原因](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formupdatereason24)。  **元服务API：** 从API version 24开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| area | [Rect](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#rect20) | 否 | 否 | 描述互动卡片动效区域范围，以卡片左上角为原点。 |
...
| dimension | number | 是 | 否 | 卡片尺寸，取值及其对应含义请参考[FormDimension](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formdimension)。 |
| formLocation | [FormLocation](/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formlocation20) | 是 | 否 | 卡片位置信息。 |