...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [FloatingBallConfiguration](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballconfiguration) | 是 | 创建闪控球控制器的参数。该参数不能为空，并且构造该参数的context不能为空。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[FloatingBallController](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballcontroller)> | Promise对象。返回当前创建的闪控球控制器。 |
...
下列API示例中都需先使用[floatingBall.create()](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballcreate)方法获取到闪控球控制器实例（即floatingBallController），再通过此实例调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [FloatingBallParams](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballparams) | 是 | 启动闪控球的参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [FloatingBallParams](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballparams) | 是 | 更新闪控球的参数。 |
...
| callback | Callback<[FloatingBallState](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballstate)> | 是 | 回调函数。返回当前的闪控球生命周期状态。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'stateChange'，即闪控球生命周期状态变化事件。 |
| callback | Callback<[FloatingBallState](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballstate)> | 否 | 回调函数。返回当前的闪控球生命周期状态。若传入参数，则停止该监听。若未传入参数，则停止所有闪控球生命周期状态变化的监听。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[FloatingBallWindowInfo](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballwindowinfo)> | Promise对象，返回闪控球窗口信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| template | [FloatingBallTemplate](/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballtemplate) | 否 | 否 | 闪控球模板。 |
