...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [DownloadableProfile](/consumer/cn/doc/harmonyos-references/js-apis-esim#downloadableprofile) | 是 | 可下载的配置文件信息。 |
...
| accessRules | Array<[AccessRule](/consumer/cn/doc/harmonyos-references/js-apis-esim#accessrule20)> | 否 | 是 | 访问规则数组。 |
