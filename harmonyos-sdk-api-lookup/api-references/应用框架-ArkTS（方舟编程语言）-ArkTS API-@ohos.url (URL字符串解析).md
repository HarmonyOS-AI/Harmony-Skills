...
| searchParams | [URLParams](/consumer/cn/doc/harmonyos-references/js-apis-url#urlparams9) | 是 | 当前调用forEach方法的实例对象。 |
...
| searchParams(deprecated) | [URLSearchParams](/consumer/cn/doc/harmonyos-references/js-apis-url#urlsearchparamsdeprecated) | 是 | 否 | 获取URLSearchParams表示URL查询参数的对象。  - **说明：** 此属性从API version 7开始支持，从API version 9开始被废弃。建议使用params9+替代。 |
| params9+ | [URLParams](/consumer/cn/doc/harmonyos-references/js-apis-url#urlparams9) | 是 | 否 | 获取URLParams表示URL查询参数的对象。**元服务API**：从API version 11开始，该接口支持在元服务中使用。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[parseURL9+](/consumer/cn/doc/harmonyos-references/js-apis-url#parseurl9)替代。
...
| 类型 | 说明 |
| --- | --- |
| [URL](/consumer/cn/doc/harmonyos-references/js-apis-url#url) | 返回创建的URL对象。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.constructor9+](/consumer/cn/doc/harmonyos-references/js-apis-url#constructor9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.append9+](/consumer/cn/doc/harmonyos-references/js-apis-url#append9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.delete9+](/consumer/cn/doc/harmonyos-references/js-apis-url#delete9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.getAll9+](/consumer/cn/doc/harmonyos-references/js-apis-url#getall9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.entries9+](/consumer/cn/doc/harmonyos-references/js-apis-url#entries9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.forEach9+](/consumer/cn/doc/harmonyos-references/js-apis-url#foreach9)替代。
...
| value | string | 是 | 当前遍历到的键值。 |
| key | string | 是 | 当前遍历到的键名。 |
| searchParams | [URLSearchParams](/consumer/cn/doc/harmonyos-references/js-apis-url#urlsearchparamsdeprecated) | 是 | 当前调用forEach方法的实例对象。 |
...
若查找一个不存在的键值对名称时返回值为undefined，从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.get9+](/consumer/cn/doc/harmonyos-references/js-apis-url#get9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.has9+](/consumer/cn/doc/harmonyos-references/js-apis-url#has9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.set9+](/consumer/cn/doc/harmonyos-references/js-apis-url#set9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.sort9+](/consumer/cn/doc/harmonyos-references/js-apis-url#sort9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.keys9+](/consumer/cn/doc/harmonyos-references/js-apis-url#keys9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.values9+](/consumer/cn/doc/harmonyos-references/js-apis-url#values9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.toString9+](/consumer/cn/doc/harmonyos-references/js-apis-url#tostring9)替代。
