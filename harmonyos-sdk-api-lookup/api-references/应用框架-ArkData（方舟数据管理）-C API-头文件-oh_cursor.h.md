...
| 名称 | 描述 |
| --- | --- |
| [int OH\_Cursor\_GetFloatVectorCount(OH\_Cursor \*cursor, int32\_t columnIndex, size\_t \*length)](/consumer/cn/doc/harmonyos-references/capi-oh-cursor-h#oh_cursor_getfloatvectorcount) | 获取当前行中指定列的浮点数数组大小。 |
| [int OH\_Cursor\_GetFloatVector(OH\_Cursor \*cursor, int32\_t columnIndex, float \*val, size\_t inLen, size\_t \*outLen)](/consumer/cn/doc/harmonyos-references/capi-oh-cursor-h#oh_cursor_getfloatvector) | 以浮点数数组的形式获取当前行中指定列的值。 |
