...
| scanCodeRect | [ScanCodeRect](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scancoderect) | 否 | 是 | 码识别位置信息。  **起始版本：** 4.1.0(11) |
| cornerPoints | Array<[Point](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#point)> | 否 | 是 | 码识别角点位置信息，返回QR Code四个角点。此参数仅图像识码接口[detectBarcode.decodeImage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-imagedecode#detectbarcodedecodeimage)返回。  **起始版本：** 5.0.0(12) |
...
| options | [ScanOptions](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanoptions) | 否 | 启动扫码参数。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise<[ScanResult](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanresult)> | Promise对象，返回扫码结果对象。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-common#context) | 是 | 应用上下文。 |
| callback | AsyncCallback<[ScanResult](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanresult)> | 是 | 回调函数。当扫码返回成功，err为undefined，data为获取到的扫码结果对象[ScanResult](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanresult)；否则为错误对象。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-common#context) | 是 | 应用上下文。 |
| options | [ScanOptions](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanoptions) | 是 | 启动扫码参数。 |
| callback | AsyncCallback<[ScanResult](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanresult)> | 是 | 回调函数。当扫码返回成功，err为undefined，data为获取到的扫码结果对象[ScanResult](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanresult)；否则为错误对象。 |
...
**废弃说明：** 从版本4.1.0(11)开始废弃，建议使用[startScanForResult](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanbarcodestartscanforresult)替代。
...
**废弃说明：** 从版本4.1.0(11)开始废弃，建议使用[startScanForResult](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanbarcodestartscanforresult-1)替代。
...
**废弃说明：** 从版本4.1.0(11)开始废弃，建议使用[startScanForResult](/consumer/cn/doc/harmonyos-references/scan-scanbarcode-api#scanbarcodestartscanforresult-2)替代。
