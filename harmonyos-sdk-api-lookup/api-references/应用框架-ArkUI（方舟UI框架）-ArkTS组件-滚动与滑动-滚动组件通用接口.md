...
设置滚动条的颜色。与[scrollBarColor11+](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#scrollbarcolor11)相比，color参数开始支持Resource类型。
...
| options | [EdgeEffectOptions](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#edgeeffectoptions11对象说明) | 否 | 组件内容大小小于组件自身时是否开启滑动效果，以及设置边缘效果生效的边缘。设置为{ alwaysEnabled: true }会开启滑动效果，{ alwaysEnabled: false }不开启。  默认值：  List、Grid、WaterFlow组件默认{ alwaysEnabled: false, EffectEdge: EffectEdge.START | EffectEdge.END }，Scroll组件默认{ alwaysEnabled: true, EffectEdge: EffectEdge.START | EffectEdge.END }。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#nestedscrolloptions10对象说明) | 是 | 嵌套滚动选项。  默认值：{ scrollForward: NestedScrollMode.SELF\_ONLY, scrollBackward: NestedScrollMode.SELF\_ONLY } |
...
| options | [FadingEdgeOptions](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#fadingedgeoptions14对象说明) | 否 | 边缘渐隐参数对象。可以通过该对象定义边缘渐隐效果属性，比如设置渐隐长度。  如果设置小于0的值或undefined或者不设置则取默认值，默认长度为32vp。  如果设置的长度超过容器高度的一半时，渐隐长度取容器高度的一半。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| clip | [ContentClipMode](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#contentclipmode14枚举说明) | [RectShape](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape#rectshape) | 是 | 裁剪只针对滚动容器的内容，即其子节点，背景不受影响。通过RectShape传入自定义矩形区域时仅支持设置宽高和相对于组件左上角的[offset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape#offset)，不支持圆角。  默认值：Grid、Scroll的默认值为ContentClipMode.BOUNDARY，List、WaterFlow的默认值为ContentClipMode.CONTENT\_ONLY。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[OnWillScrollCallback](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onwillscrollcallback12)> | 是 | 滚动组件滑动前触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnScrollCallback](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onscrollcallback12) | 是 | 滚动组件滑动时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnWillStopDraggingCallback](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onwillstopdraggingcallback20) | 是 | 滚动组件划动离手时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnDidStopDraggingCallback](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#ondidstopdraggingcallback21) | 是 | 滚动组件结束拖动时触发的回调。 |
...
| effectEdge18+ | number | 否 | 是 | 设置边缘效果生效的边缘。  如果设置[EffectEdge](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#effectedge18枚举说明).START表示只有起始边生效。如果设置[EffectEdge](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#effectedge18枚举说明).END表示只有末尾边生效。  默认值为[EffectEdge](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#effectedge18枚举说明).START | [EffectEdge](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#effectedge18枚举说明).END表示双边同时生效。当设置为其它异常值时，则默认双边同时生效。  如果需要双边都不生效，可将edgeEffect设置为EdgeEffect.None。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| onGetPreviewBadge | [OnGetPreviewBadgeCallback](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#ongetpreviewbadgecallback23) | 否 | 是 | 即将启动多选长按聚拢动画时，触发用于获取选中数量的回调。  缺省时用Grid或List显示范围内选中item的数量作为多选长按聚拢动画后菜单预览图的角标。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/v5UXW0-nSa-Ly-_sybvIcg/zh-cn_image_0000002599358551.png?HW-CC-KV=V1&HW-CC-Date=20260511T035000Z&HW-CC-Expire=86400&HW-CC-Sign=0C1531862D17B934B6F9CFA47CD2EDE5375DE2595723601A7CE4A59A4233157E)
...
| 类型 | 说明 |
| --- | --- |
| void | [ScrollResult](/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#scrollresult12对象说明) | 返回ScrollResult时按照开发者指定的相对上一帧的偏移量滑动；不返回时按回调参数scrollOffset滑动。  取值范围：(-∞, +∞) |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/umphYrYNTwiww253M-Tm8g/zh-cn_image_0000002568759254.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035000Z&HW-CC-Expire=86400&HW-CC-Sign=0E818BD6A8F75A64A41AE3B976681D6BEA96191B69E5F3B82F6EBD890729A0FC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/PdECj73QSWqu1CUDu1pEvA/zh-cn_image_0000002568918904.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035000Z&HW-CC-Expire=86400&HW-CC-Sign=78E541CE7C4A2CD08CA83405C7A8041EC5CF7E6260417FE8AA28E89F3FB31EE1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/-O3_KU1tR4WYa-TTeD1xrA/zh-cn_image_0000002568918956.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035000Z&HW-CC-Expire=86400&HW-CC-Sign=111BC61A14702E47EA95C9FC409532B05C6E737CBF9F935706D02C01BFCDA72F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/K5fBkPv3Sv6OPH-RwhWwSg/zh-cn_image_0000002599478501.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035000Z&HW-CC-Expire=86400&HW-CC-Sign=4F5952926E3F0782A561AB52F2F25403981C792D7FA9263D8923B50E80B41643)