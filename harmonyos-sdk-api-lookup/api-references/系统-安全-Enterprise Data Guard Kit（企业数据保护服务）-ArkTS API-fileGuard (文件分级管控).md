...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| securityLevel | number | 否 | 否 | 表示文件安全等级，其值参考[SecurityLevel](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#securitylevel)枚举类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [CommonDirScanType](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#commondirscantype) | 是 | 公共目录扫描范围。取值：MEDIA\_ONLY | MEDIA\_AND\_SANDBOX。 |
| callback | [ScanFileCallback](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#scanfilecallback) | 是 | 回调函数，返回的文件列表和扫描结束通知。 |
...
| --- | --- | --- | --- |
| path | string | 是 | [默认路径范围](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/dataguard-introduction#访问限制)下的绝对路径子集。 |
| level | [SecurityLevel](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#securitylevel) | 是 | 用于标识文件安全等级（外部公开、内部公开、秘密、机密、绝密），需由开发者设定，并配合[queryFileTag](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#queryfiletag)接口使用。 |
| tag | string | 是 | 标签名称，使用[updatePolicy](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#updatepolicy)接口设置自定义标签策略后，根据标签名称进行相应管控。 |
...
| --- | --- | --- | --- |
| path | string | 是 | [默认路径范围](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/dataguard-introduction#访问限制)下的绝对路径子集。 |
| callback | AsyncCallback<[FileTagInfo](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#filetaginfo)> | 是 | 回调函数。当异步获取文件属性标签成功，err为undefined，data为获取到的文件标签信息对象[FileTagInfo](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#filetaginfo)；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[FileTagInfo](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#filetaginfo)> | Promise对象，返回文件标签信息对象。 |
...
| --- | --- | --- | --- |
| path | string | 是 | [用户的个人数据目录](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/dataguard-introduction#访问限制)下的绝对路径子集。 |
| callback | AsyncCallback<[FilePathInfo](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#filepathinfo)> | 是 | 回调函数。当获取文件URI成功，err为undefined，data为获取到的[FilePathInfo](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#filepathinfo)；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[FilePathInfo](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#filepathinfo)> | Promise对象，返回文件绝对路径和URI。 |
...
添加放通应用列表，放通应用不受[updatePolicy](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#updatepolicy)接口下发的网络、U盘、蓝牙、星闪、Samba客户端和服务端策略管控，但打印管控策略仍会受到限制。使用Promise异步回调。
...
16. console.info(`Succeeded in removeing the application to the unrestricted list.`);
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| devType | [AuthenticateDeviceType](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#authenticatedevicetype) | 是 | HDC认证的设备类型枚举。当设备类型为上位机时，需分别设置公钥和私钥；当设备类型为下位机时，仅需设置私钥。 |
| keyType | [AuthenticateKeyType](/consumer/cn/doc/harmonyos-references/dataguard-fileguard#authenticatekeytype) | 是 | HDC认证的密钥类型枚举。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<void> | 否 | 回调函数，用于取消监听打印服务启动事件。 |
