...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextInputOptions](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#textinputoptions对象说明) | 否 | TextInput组件参数。 |
...
| controller8+ | [TextInputController](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#textinputcontroller8) | 否 | 是 | 设置TextInput控制器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [InputType](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#inputtype枚举说明) | 是 | 输入框类型。  默认值：InputType.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EnterKeyType](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#enterkeytype枚举说明) | 是 | 输入法回车键类型。  默认值：EnterKeyType.Done |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextInputStyle](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#textinputstyle9枚举说明) | [TextContentStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#textcontentstyle10) | 是 | 输入框为默认风格或内联输入风格。  默认值：TextInputStyle.Default |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [PasswordIcon](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#passwordicon10对象说明) | 是 | 密码输入模式时，输入框末尾的图标。  默认为系统提供的密码图标。  该图标的固定尺寸为24vp，Wearable设备上默认值为28vp，若引用的图标过大或过小，均显示为固定尺寸。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ContentType](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#contenttype12枚举说明) | 是 | 自动填充类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [WordBreak](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#wordbreak11) | 是 | 内联输入风格编辑态时断行规则。  默认值：WordBreak.BREAK\_WORD |
...
当[输入框的类型](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#inputtype枚举说明)设置为Password、NEW\_PASSWORD和NUMBER\_PASSWORD模式时，密码保护功能才能生效。非密码输入模式则不会触发该功能。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<boolean> | 是 | 是否启用自动填充动效。  true表示启用，false表示不启用。  默认值：true  **说明：**  启用之后，仅输入模式[InputType](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#inputtype枚举说明)设置为Password、NEW\_PASSWORD或NUMBER\_PASSWORD的输入框在进行自动填充时动效可生效。 |
...
| Password | 7 | 密码输入模式。  默认输入文字短暂显示后变成圆点。从API version 12开始，PC/2in1设备上输入文字直接显示为圆点。  TV设备上输入框末尾默认不显示小眼睛图标，其他设备输入框末尾默认显示小眼睛图标。  密码输入模式中，[decoration](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#decoration12)、[showUnderline](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#showunderline10)、[lineHeight](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#lineheight12)不生效。  在已启用密码保险箱的情况下，支持用户名、密码的自动保存和自动填充。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnSubmitCallback](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#onsubmitcallback18) | 是 | 提交回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnPasteCallback](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#onpastecallback18) | 是 | 粘贴回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnTextSelectionChangeCallback](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#ontextselectionchangecallback18) | 是 | 文本选择变化回调或光标位置变化回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnContentScrollCallback](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#oncontentscrollcallback18) | 是 | 文本内容滚动回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enterKey | [EnterKeyType](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#enterkeytype枚举说明) | 是 | 输入法回车键类型。 |
| event | [SubmitEvent](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#submitevent11) | 是 | 提交事件。可以控制是否收起键盘。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/rg41Qq-HTCyr_u4N3kjZPQ/zh-cn_image_0000002568759412.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=E3CC051E3B12BB7B6352360ADE4E981FA871FE7FA0AC7CB8991A85176BF683C8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/2Phn4zhBR-avu4Uy42jSoA/zh-cn_image_0000002599358655.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=A531B7041BF083ACEED2681CEDA47EFABDBD407FB0C2B6DDAB357498158E930D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/c0B44yOsTfyqmB3u8xqvsQ/zh-cn_image_0000002568919060.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=CC788E1736292FEA35F566AE4DFFE895A2423D1F4F06D82BE89DF2D90F5B3E54)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/x4oiTygrQHGO7N0MNmsNeQ/zh-cn_image_0000002599478605.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=9C311344F0D9BCBF12F479D4787C128BF1D88F8C768510E4A3A9E80B58549576)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/cCnuCGLqRt6ZUkrIMPNhNA/zh-cn_image_0000002568759414.jpg?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=3719D03FD920CA4195B31F9BCB148EF8E999891E7189EBC23C8B47A5AFD00448)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/yGiojCQZT7KowjiKL8EhJw/zh-cn_image_0000002599358657.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=6C8DE83F51B115069F45CFA1ED3F37F08BC295DA2B507A42F2A13389A83116A6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/t_q06pCVT2Oj3kl-gH_oyw/zh-cn_image_0000002568919062.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=F32796FE444D6FA21FD870B68048DAE1DB3B138945034681423405254F4A6383)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/VLvtqoe-Q86mqmHihMzWXA/zh-cn_image_0000002599478607.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=BADF0CDAB80FC5B8144E420B3327F11ECB1CDFCE3D973215FAE37BF978C9BB89)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/V7pj_BukR7a4XIRzSuYBUg/zh-cn_image_0000002568759416.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=A165EF65BA97B2A7E9B0FF7293A0280551236D1012174A6E9B1FFE2D30A38A1A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/ESTY248DQui8Kacf2Uz5Cw/zh-cn_image_0000002599358659.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=AF4F886BA5DBA7A1035F836D089A14066C2E5F01FE606925644976F426A4CDEC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/6oGJaWXlQQKS2pQfs46DHw/zh-cn_image_0000002568919064.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=8CB69DD3FF9180E8F316641DC43B3D8031074B16C227BBAE9A80FE813640D351)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/uQT7l6f4QWu0Mf2Xj33XRQ/zh-cn_image_0000002599478609.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=A4994B5B33FA2E1A67CB217AA71A6C13F148570246242D7633EA6A80BDB1D754)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/szjIEXkLRoSSHRxRlHDhYg/zh-cn_image_0000002568759418.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=779F2D58585999C71A692F06484E5FEFA7BC37E757BF8B2E4440E701AD7B09B0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/Zwoi4lk5ScOFWFWPKA530w/zh-cn_image_0000002599358661.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=EC13BCF10E910B7A122374605B7160D8CB8E0FEC3FE838BE224907548AD0347A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/zG_35tadSOKtzwEG5LauQw/zh-cn_image_0000002568919066.jpg?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=FD95B0B49CAB9D5EDA340B6703F66B3370FFC6D8210C5F121AECF3E8D7AC87AA)

### 示例16（文本设置省略模式）

该示例通过[textOverflow](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#textoverflow12)、[ellipsisMode](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#ellipsismode18)、[style](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#style9)属性展示了文本超长省略以及调整省略位置的效果，通过MULTILINE\_START和MULTILINE\_CENTER两种类型实现了单行文本和多行文本场景下的省略号在行首和行中的效果。

从API version 9开始，通过[style](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#style9)设置输入框的风格。

从API version 12开始，通过[textOverflow](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#textoverflow12)设置文本超长时的显示方式。

从API version 18开始，通过[ellipsisMode](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#ellipsismode18)设置省略号位置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/RcP86Q5aQr6qFnZerQONfw/zh-cn_image_0000002599478611.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=B168B3EDD0D4442EA74E7616E9BF8F3032FFDABF0E2906C3C194478E70C3BE7B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/05/v3/E6fqCJRoSKC7OFLpROM0sQ/zh-cn_image_0000002568759420.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=4349A6D757FAA8778F63C34C93AAB1530D584306C9426728ECD348953726ED15)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/5S-OrtVWTq2ppZS4rp6taA/zh-cn_image_0000002599478613.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=5DA79EE5E91988AC228B478981807BA60EAD3CC40B82A215A7AF81109093ECB7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/23B--wDuRby7VpWXNOQgLA/zh-cn_image_0000002568759422.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=3A3D02431EBE8DDBFF4046D5A8D68C0152A5B5AE4FD3468F20D6E4DE9BD5FFE8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/E628ekI0TkK6WHRcI69v5w/zh-cn_image_0000002599358665.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=2A867C9939EC6866A55EA42703DAE32BE945F40649698EEBA162102CC2FD9E95)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/_uERUWe8QceVHSCSmdN8aQ/zh-cn_image_0000002568919070.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=B564B607A0D46B28B2628811C22E0EE9D786FCDA312321D00A22CC3433530672)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/7x9iBzXQS2-X7aSHLETYTw/zh-cn_image_0000002599478615.jpg?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=FEF5F221DAC5DE0395CC0273163C5AA173AB54B57C21AB8926B0B8B62D011658)
...
从API version 10开始，该示例通过[barState](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#barstate10)接口设置内联输入风格编辑态时滚动条的显示或隐藏状态。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/6UaKMYgaTMCvplwKHmJq8g/zh-cn_image_0000002568759424.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=CC9BB32FBD619276886430E55D8BD03C156A0668AF019FC9712F3A68EF29387D)

### 示例26（设置行首标点压缩）

该示例通过[compressLeadingPunctuation](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#compressleadingpunctuation23)接口设置行首标点压缩，左侧有间距的标点符号位于行首时，标点会直接压缩间距至左侧边界。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/RjdRHX0AQSOzf5LXzb3vmg/zh-cn_image_0000002599358667.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=7DDE70330B26079B1660A8BE5BAD50F95C8AAD1B123AF1765F71904FE019B4B5)

### 示例27（设置自适应间距）

该示例通过[includeFontPadding](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#includefontpadding23)接口增加首行尾行间距和[fallbackLineSpacing](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#fallbacklinespacing23)接口设置自适应行间距。

从API version 23开始，新增[includeFontPadding](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#includefontpadding23)和[fallbackLineSpacing](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#fallbacklinespacing23)接口。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/lPJTthH_QLWfm0JLvP43cw/zh-cn_image_0000002568919072.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=A396A384EDFB93F2E953E94F97164490EB90DBDFEA09F5BDB38DD30F9789BDCB)

### 示例28（设置文本拖拽时的背板样式）

该示例通过[selectedDragPreviewStyle](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#selecteddragpreviewstyle23)接口设置文本拖拽时的背板样式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/w-q-30arTeaoW-hAznoMhQ/zh-cn_image_0000002599478617.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=6AAA3FEAE136DF7D7DDC5FA2587BD4E91A0876682153F365E59D1F35AB8685BF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/Onw9kyXgQSq0VImO0OAIGg/zh-cn_image_0000002568759426.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=E0C7E4A6357F6EE9A9590E90D0C35B13C151A22099D885449C142FB0B508E570)

### 示例30（设置文本排版方向）

该示例通过[textDirection](/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#textdirection23)接口设置文本排版方向。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/GjiK6dn_TuqxYWbR4ZNYKQ/zh-cn_image_0000002599358669.png?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=E0413B4C9A1AEECCE770F0755E86ABF7A3EFC69F4F89D71A7EC0A29D5BA31214)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6/v3/IuBt4qRkSZ2Tv4fLQ-vsKw/zh-cn_image_0000002568919074.gif?HW-CC-KV=V1&HW-CC-Date=20260511T035141Z&HW-CC-Expire=86400&HW-CC-Sign=EED35A5EDD6AE09AF87E45E420D1FC34FE1D6C8FFC1D648518A44F4EDBC16966)