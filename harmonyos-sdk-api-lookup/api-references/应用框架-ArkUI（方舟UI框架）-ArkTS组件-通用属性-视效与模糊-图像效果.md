...
为组件添加内容模糊效果。与[blur](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#blur)相比，blurRadius参数新增了对undefined类型的支持。
...
为组件添加内容模糊效果。与[blur18+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#blur18)相比，新增了sysOptions参数，即支持系统自适应调节参数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ShadowOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#shadowoptions对象说明) | [ShadowStyle](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#shadowstyle10枚举说明)10+ | 是 | 为当前组件添加阴影效果。  入参类型为ShadowOptions时，可以指定模糊半径、阴影的颜色、X轴和Y轴的偏移量。  入参类型为ShadowStyle时，可指定不同阴影样式。 |
...
为组件添加阴影效果。与[shadow](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#shadow)相比，options参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[ShadowOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#shadowoptions对象说明) | [ShadowStyle](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#shadowstyle10枚举说明)> | 是 | 为当前组件添加阴影效果。  入参类型为ShadowOptions时，可以指定模糊半径、阴影的颜色、X轴和Y轴的偏移量。  入参类型为ShadowStyle时，可指定不同阴影样式。  当options的值为undefined时，恢复为无样式的阴影效果。 |
...
为组件添加灰度效果。上层渲染灰度会覆盖下层子组件渲染。不通过该接口设置时，默认无变化。与[grayscale](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#grayscale)相比，grayscale参数新增了对undefined类型的支持。
...
为组件添加高光效果。不通过该接口设置时，默认无变化。与[brightness](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#brightness)相比，brightness参数新增了对undefined类型的支持。
...
为组件添加饱和度效果。不通过该接口设置时，默认无变化。与[saturate](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#saturate)相比，saturate参数新增了对undefined类型的支持。
...
为组件添加对比度效果。不通过该接口设置时，默认无变化。与[contrast](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#contrast)相比，contrast参数新增了对undefined类型的支持。
...
反转输入的图像。与[invert](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#invert)相比，options参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<number | [InvertOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#invertoptions11对象说明)11+> | 是 | 反转输入的图像。  入参对象为number时。入参为图像反转的比例，值为1时完全反转，值为0则图像无变化。  取值范围：[0, 1]。  设置小于0的值时，按值为0处理。设置大于1的值时，按值为1处理。  入参对象为 InvertOptions时，对比背景颜色灰度值和阈值区间，背景颜色灰度值小于阈值区间时反色取high值，当背景颜色灰度值大于阈值区间时反色取low值，背景颜色灰度值在阈值区间内取值由high线性渐变到low。  当options的值为undefined时，恢复为图像无变化的效果。  **说明：**  number和InvertOptions两种形式的入参对应不同的反转效果。两种类型的入参切换时，不会清除之前已设置的反转效果，两种反转效果会同时存在，建议始终使用同一种形式的入参。 |
...
将图像转换为深褐色。与[sepia](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#sepia)相比，sepia参数新增了对undefined类型的支持。
...
色相旋转效果。不通过该接口设置时，默认无变化。与[hueRotate](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#huerotate)相比，rotation参数新增了对undefined类型的支持。
...
为组件添加颜色叠加效果。与[colorBlend](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#colorblend)相比，color参数新增了对undefined类型的支持。
...
| options | [LinearGradientBlurOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#lineargradientbluroptions12) | 是 | 设置线性渐变模糊效果。  线性渐变参数，包含模糊程度和模糊位置数组fractionStops，及渐变模糊方向direction。 |
...
为组件添加内容线性渐变模糊效果。与[linearGradientBlur12+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#lineargradientblur12)相比，新增了对undefined类型的支持。
...
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[LinearGradientBlurOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#lineargradientbluroptions12)> | 是 | 设置线性渐变模糊效果。  线性渐变参数，包含模糊程度和模糊位置数组fractionStops，及渐变模糊方向direction。 |
...
与[renderGroup10+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#rendergroup10)相比，isGroup参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BlendMode](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#blendmode11枚举说明) | 是 | 混合模式。  默认值：BlendMode.NONE  **说明：**  混合模式设置为BlendMode.NONE时，blend效果实际为默认的BlendMode.SRC\_OVER，且BlendApplyType不生效。 |
| type | [BlendApplyType](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#blendapplytype11枚举说明) | 否 | blendMode实现方式是否离屏。  默认值：BlendApplyType.FAST  **说明：**  1. 设置BlendApplyType.FAST时，不离屏。  2. 设置BlendApplyType.OFFSCREEN时，会创建当前组件大小的离屏画布，再将当前组件（含子组件）的内容绘制到离屏画布上，再用指定的混合模式与下方画布已有内容进行混合。使用该实现方式时，将导致[linearGradientBlur12+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#lineargradientblur12)、[backgroundEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-background#backgroundeffect11)、[brightness](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#brightness)、[blur](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#blur)等需要截屏的接口无法截取到正确的画面。 |
...
将当前控件的内容（包含子节点内容）与下方画布（可能为离屏画布）已有内容进行混合。与[blendMode11+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#blendmode11)相比，mode参数新增了对undefined类型的支持。
...
控件内部子节点的阴影进行同层绘制，同层元素阴影重叠。与[useShadowBatching11+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#useshadowbatching11)相比，use参数新增了对undefined类型的支持。
...
设置组件的图像球面化程度。与[sphericalEffect12+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#sphericaleffect12)相比，effect参数新增了对undefined类型的支持。
...
设置组件图像亮起程度。与[lightUpEffect12+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#lightupeffect12)相比，degree参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [PixelStretchEffectOptions](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#pixelstretcheffectoptions10) | 是 | 设置组件的图像边缘像素扩展距离。  参数options包括上下左右四个方向的边缘像素扩展距离。  **说明：**  1. 如果距离为正值，表示向外扩展，放大原来图像大小。上下左右四个方向分别用边缘像素填充，填充的距离即为设置的边缘扩展的距离。  2. 如果距离为负值，表示内缩，但是最终图像大小不变。  内缩方式：  图像根据options的设置缩小，缩小大小为四个方向边缘扩展距离的绝对值。  图像用边缘像素扩展到原来大小。  3. 对options的输入约束：  上下左右四个方向的扩展统一为非正值或者非负值。即四个边同时向外扩或者内缩，方向一致。  所有方向的输入均为百分比或者具体值，不支持百分比和具体值混用。  所有异常情况下，显示为{0, 0, 0, 0}效果，即跟原图保持一致。 |
...
设置组件的图像边缘像素扩展距离。与[pixelStretchEffect12+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#pixelstretcheffect12)相比，options参数新增了对undefined类型的支持。
...
| type10+ | [ShadowType](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#shadowtype10枚举说明) | 否 | 是 | 阴影类型。  默认值：COLOR  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fractionStops | [FractionStop](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#fractionstop12)[] | 否 | 否 | 数组中保存的每一个二元数组（取值0-1，小于0则为0，大于1则为1）表示[模糊程度, 模糊位置]；模糊位置需严格递增，开发者传入的数据不符合规范会记录日志，渐变模糊数组中二元数组个数必须大于等于2，否则渐变模糊不生效。 |
...
设置当前控件和子控件是否整体离屏渲染绘制后重复绘制缓存，不再进行内部属性更新。与[freeze](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#freeze12)相比，freeze参数新增了对undefined类型的支持。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/S7krifgARaS6-u8knr_EPw/zh-cn_image_0000002599478349.png?HW-CC-KV=V1&HW-CC-Date=20260511T034513Z&HW-CC-Expire=86400&HW-CC-Sign=C4C1E3063FE54FD2008289C0D69AB698333CDEA461A9D91A2C646B2A96829072)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/vn58jI0rTYmwZCzw_enkaQ/zh-cn_image_0000002568759158.png?HW-CC-KV=V1&HW-CC-Date=20260511T034513Z&HW-CC-Expire=86400&HW-CC-Sign=39B144508CBDE6573A6A31BFA09DE9D89E148A49AC0A99EF7D89AEEB4DF135C7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/8BQXe5r1RzKqeZiFhsfX9w/zh-cn_image_0000002599358401.png?HW-CC-KV=V1&HW-CC-Date=20260511T034513Z&HW-CC-Expire=86400&HW-CC-Sign=C5ADA44436BBB60A822D2E8FDC48C1385A149F3702382836B7235AA6DC004A6E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3