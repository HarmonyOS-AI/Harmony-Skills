...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_RDB\_TransType](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdb_transtype) | OH\_RDB\_TransType | 表示关系型数据库事务类型。 |
...
| 名称 | 描述 |
| --- | --- |
| [OH\_RDB\_TransOptions \*OH\_RdbTrans\_CreateOptions(void)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_createoptions) | 创建事务配置对象。 |
| [int OH\_RdbTrans\_DestroyOptions(OH\_RDB\_TransOptions \*options)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_destroyoptions) | 销毁事务配置对象。 |
| [int OH\_RdbTransOption\_SetType(OH\_RDB\_TransOptions \*options, OH\_RDB\_TransType type)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtransoption_settype) | 设置关系型数据库事务类型。 |
| [int OH\_RdbTrans\_Commit(OH\_Rdb\_Transaction \*trans)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_commit) | 提交事务。 |
| [int OH\_RdbTrans\_Rollback(OH\_Rdb\_Transaction \*trans)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_rollback) | 回滚事务。 |
| [int OH\_RdbTrans\_Insert(OH\_Rdb\_Transaction \*trans, const char \*table, const OH\_VBucket \*row, int64\_t \*rowId)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_insert) | 将一行数据插入到目标表中。 |
| [int OH\_RdbTrans\_InsertWithConflictResolution(OH\_Rdb\_Transaction \*trans, const char \*table, const OH\_VBucket \*row,Rdb\_ConflictResolution resolution, int64\_t \*rowId)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_insertwithconflictresolution) | 将一行数据插入到目标表中，支持冲突解决。 |
| [int OH\_RdbTrans\_BatchInsert(OH\_Rdb\_Transaction \*trans, const char \*table, const OH\_Data\_VBuckets \*rows,Rdb\_ConflictResolution resolution, int64\_t \*changes)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_batchinsert) | 将一组数据批量插入到目标表中。 |
| [int OH\_RdbTrans\_Update(OH\_Rdb\_Transaction \*trans, const OH\_VBucket \*row, const OH\_Predicates \*predicates,int64\_t \*changes)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_update) | 根据指定的条件更新数据库中的数据。 |
| [int OH\_RdbTrans\_UpdateWithConflictResolution(OH\_Rdb\_Transaction \*trans, const OH\_VBucket \*row,const OH\_Predicates \*predicates, Rdb\_ConflictResolution resolution, int64\_t \*changes)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_updatewithconflictresolution) | 根据指定条件更新数据库中的数据，并支持冲突解决。 |
| [int OH\_RdbTrans\_Delete(OH\_Rdb\_Transaction \*trans, const OH\_Predicates \*predicates, int64\_t \*changes)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_delete) | 根据指定条件从数据库中删除数据。 |
| [OH\_Cursor \*OH\_RdbTrans\_Query(OH\_Rdb\_Transaction \*trans, const OH\_Predicates \*predicates, const char \*columns[],int len)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_query) | 根据指定的条件查询数据库中的数据。 |
| [OH\_Cursor \*OH\_RdbTrans\_QuerySql(OH\_Rdb\_Transaction \*trans, const char \*sql, const OH\_Data\_Values \*args)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_querysql) | 根据SQL语句查询数据库中的数据。 |
| [int OH\_RdbTrans\_Execute(OH\_Rdb\_Transaction \*trans, const char \*sql, const OH\_Data\_Values \*args, OH\_Data\_Value \*\*result)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_execute) | 执行包含指定参数的SQL语句。 |
| [int OH\_RdbTrans\_Destroy(OH\_Rdb\_Transaction \*trans)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_destroy) | 销毁事务对象。 |
| [OH\_Cursor \*OH\_RdbTrans\_QueryWithoutRowCount(OH\_Rdb\_Transaction \*trans, const OH\_Predicates \*predicates, const char \* const columns[], int len)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_querywithoutrowcount) | 根据指定的条件查询数据库中的数据，不计算行数。 |
| [OH\_Cursor \*OH\_RdbTrans\_QuerySqlWithoutRowCount(OH\_Rdb\_Transaction \*trans, const char \*sql, const OH\_Data\_Values \*args)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_querysqlwithoutrowcount) | 根据SQL语句查询数据库中的数据，不计算行数。 |
| [int OH\_RdbTrans\_BatchInsertWithReturning(OH\_Rdb\_Transaction \*trans, const char \*table, const OH\_Data\_VBuckets \*rows, Rdb\_ConflictResolution resolution, OH\_RDB\_ReturningContext \*context)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_batchinsertwithreturning) | 将批量数据插入目标表，并将变更信息输出到上下文中。 |
| [int OH\_RdbTrans\_UpdateWithReturning(OH\_Rdb\_Transaction \*trans, OH\_VBucket \*row, OH\_Predicates \*predicates, Rdb\_ConflictResolution resolution, OH\_RDB\_ReturningContext \*context)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_updatewithreturning) | 根据指定条件更新数据库中的数据并输出更改信息到上下文。 |
| [int OH\_RdbTrans\_DeleteWithReturning(OH\_Rdb\_Transaction \*trans, OH\_Predicates \*predicates, OH\_RDB\_ReturningContext \*context)](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_deletewithreturning) | 根据指定条件从数据库中删除数据并输出更改信息到上下文。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_RDB\_TransOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-rdb-transoptions) | 执行成功时返回指向[OH\_RDB\_TransOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-rdb-transoptions)实例的指针。否则返回nullptr。  使用完成后，必须通过[OH\_RdbTrans\_DestroyOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdbtrans_destroyoptions)接口释放内存。 |
...
| --- | --- |
| [OH\_RDB\_TransOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-rdb-transoptions) \*options | 指向[OH\_RDB\_TransOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-rdb-oh-rdb-transoptions)实例的指针。 |
| [OH\_RDB\_TransType](/consumer/cn/doc/harmonyos-references/capi-oh-rdb-transaction-h#oh_rdb_transtype) type | 表示关系型数据库事务类型。 |
...
| [Rdb\_ConflictResolution](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-rdb-types-h#rdb_conflictresolution) resolution | 发生冲突时的解决策略[Rdb\_ConflictResolution](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-rdb-types-h#rdb_conflictresolution)，不建议使用RDB\_CONFLICT\_FAIL，因为失败时会抛异常，  无法正常获取实际的变更数据。 |
