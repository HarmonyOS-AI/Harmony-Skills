...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| action | [Action](/consumer/cn/doc/harmonyos-references/js-apis-keyevent#action) | 否 | 否 | 按键事件类型。 |
| key | [Key](/consumer/cn/doc/harmonyos-references/js-apis-keyevent#key) | 否 | 否 | 按键。 |
| unicodeChar | number | 否 | 否 | 按键对应的unicode字符。 |
| keys | [Key](/consumer/cn/doc/harmonyos-references/js-apis-keyevent#key) [] | 否 | 否 | 当前处于按下状态的按键列表。 |
