...
开发者仅需要通过[定义资源文件](/consumer/cn/doc/harmonyos-references/js-lite-framework-localization#定义资源文件)和[引用资源](/consumer/cn/doc/harmonyos-references/js-lite-framework-localization#引用资源)两个步骤，就可以使用开发框架的多语言能力；如果需要在应用中获取当前系统语言，请参考[获取语言](/consumer/cn/doc/harmonyos-references/js-lite-framework-localization#获取语言)。
