...
List的预加载是指除了加载显示区域内可见的子组件外，还支持空闲时隙提前加载部分显示区域外不可见的子组件。使用预加载可以减少滚动丢帧，提升流畅性。预加载需要结合懒加载才会生效。List支持通过[cachedCount](/consumer/cn/doc/harmonyos-references/ts-container-list#cachedcount)设置预加载的数量。默认会预加载显示区域上下各一屏子节点（最大预加载16行子节点）。List和[ForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-foreach)、[LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-lazyforeach)、[Repeat](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-rendering-control-repeat)结合，预加载能力存在差异：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ListOptions](/consumer/cn/doc/harmonyos-references/ts-container-list#listoptions18对象说明) | 否 | 设置List组件参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ListDividerOptions](/consumer/cn/doc/harmonyos-references/ts-container-list#listdivideroptions18对象说明) | null | 是 | ListItem分割线样式。  默认值：null |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ListItemAlign](/consumer/cn/doc/harmonyos-references/ts-container-list#listitemalign9枚举说明) | 是 | 交叉轴方向的布局方式。  默认值：ListItemAlign.Start |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [StickyStyle](/consumer/cn/doc/harmonyos-references/ts-container-list#stickystyle9枚举说明) | 是 | ListItemGroup吸顶或吸底效果。  默认值：StickyStyle.None |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ScrollSnapAlign](/consumer/cn/doc/harmonyos-references/ts-container-list#scrollsnapalign10枚举说明) | 是 | 列表项滚动结束对齐效果。  默认值：ScrollSnapAlign.NONE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| speed | [ScrollSnapAnimationSpeed](/consumer/cn/doc/harmonyos-references/ts-container-list#scrollsnapanimationspeed22枚举说明) | 是 | 列表滚动限位动画速度。  默认值：ScrollSnapAnimationSpeed.NORMAL |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#nestedscrolloptions10对象说明) | 是 | 嵌套滚动选项。  默认值：{ scrollForward: NestedScrollMode.SELF\_ONLY, scrollBackward: NestedScrollMode.SELF\_ONLY } |
...
设置内容区域起始偏移量。列表滚动到起始位置时，列表内容与列表显示区域边界保留指定距离。与[contentStartOffset11+](/consumer/cn/doc/harmonyos-references/ts-container-list#contentstartoffset11)相比，参数名改为offset，并开始支持Resource类型。
...
设置内容区末尾偏移量。列表滚动到末尾位置时，列表内容与列表显示区域边界保留指定距离。与[contentEndOffset11+](/consumer/cn/doc/harmonyos-references/ts-container-list#contentendoffset11)相比，参数名改为offset，并开始支持Resource类型。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnScrollVisibleContentChangeCallback](/consumer/cn/doc/harmonyos-references/ts-container-list#onscrollvisiblecontentchangecallback12) | 是 | 当前显示内容发生改变的时候触发回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [VisibleListContentInfo](/consumer/cn/doc/harmonyos-references/ts-container-list#visiblelistcontentinfo12对象说明) | 入参坐标处的子组件的索引信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| start | [VisibleListContentInfo](/consumer/cn/doc/harmonyos-references/ts-container-list#visiblelistcontentinfo12对象说明) | 是 | 1. 通过该参数获取List显示区域第一个子组件在List中的索引值。  2. 如果当前List显示区域第一个子组件是ListItemGroup，可以获取当前List显示区域第一个组件属于该ListItemGroup的哪一区域。  3. 如果当前List显示区域第一个组件是ListItemGroup内的ListItem，可以获取该ListItem在ListItemGroup内的索引值。 |
| end | [VisibleListContentInfo](/consumer/cn/doc/harmonyos-references/ts-container-list#visiblelistcontentinfo12对象说明) | 是 | 1. 通过该参数获取List显示区域最后一个子组件在List中的索引值。  2. 如果当前List显示区域最后一个子组件是ListItemGroup，可以获取当前List显示区域最后一个组件属于该ListItemGroup的哪一区域。  3. 如果当前List显示区域最后一个组件是ListItemGroup内的ListItem，可以获取该ListItem在ListItemGroup内的索引值。 |
...
| itemGroupArea | [ListItemGroupArea](/consumer/cn/doc/harmonyos-references/ts-container-list#listitemgrouparea12枚举说明) | 否 | 是 | 表示处于ListItemGroup的哪一个区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnListScrollIndexCallback](/consumer/cn/doc/harmonyos-references/ts-container-list#onlistscrollindexcallback19) | undefined | 是 | onScrollIndex事件的回调函数。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3