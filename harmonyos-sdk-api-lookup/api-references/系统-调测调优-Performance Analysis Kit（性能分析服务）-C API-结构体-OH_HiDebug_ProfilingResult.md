...
| 名称 | 描述 |
| --- | --- |
| [OH\_HiDebug\_ResourceType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hidebug-type-h#oh_hidebug_resourcetype) resourceType | 资源采集类型。  **起始版本：** 24 |
