...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| Content-Type | 是 | String | 取值为：application/json; charset=utf-8。  **说明：**  Request Body传参，请务必遵循此请求头格式，否则可能导致请求失败，具体传参方式可参考[示例代码](/consumer/cn/doc/harmonyos-references/account-api-get-groupunionid#示例代码)。 |
...
| **参数** | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| openIdToGroupUnionIdList | 否 | List<[OpenIdToGroupUnionIdInfo](/consumer/cn/doc/harmonyos-references/account-api-get-groupunionid#openidtogroupunionidinfo)> | 用户的OpenID转GroupUnionID的列表。当传入openIdList参数时返回。 |
| unionIdToGroupUnionIdList | 否 | List<[UnionIdToGroupUnionIdInfo](/consumer/cn/doc/harmonyos-references/account-api-get-groupunionid#unionidtogroupunionidinfo)> | 用户的UnionID转GroupUnionID的列表，当传入unionIdList参数时返回。 |
...
| **参数** | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| resultCode | 是 | int | 错误码，详见[错误码](/consumer/cn/doc/harmonyos-references/account-api-get-groupunionid#错误码)。 |
...
| 错误码 | 描述 | 解决方法 |
| --- | --- | --- |
| 60010002 | 参数错误。 | 请按照响应描述中的提示，检查并修改[请求参数](/consumer/cn/doc/harmonyos-references/account-api-get-groupunionid#请求参数)。 |
| 60010003 | 鉴权头Authorization校验不通过。 | 检查并修改[请求参数](/consumer/cn/doc/harmonyos-references/account-api-get-groupunionid#请求参数)中Authorization参数。 |
