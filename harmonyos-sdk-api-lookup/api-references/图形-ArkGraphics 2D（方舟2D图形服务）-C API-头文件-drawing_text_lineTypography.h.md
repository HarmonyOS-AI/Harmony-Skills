...
| 名称 | 描述 |
| --- | --- |
| [OH\_Drawing\_LineTypography\* OH\_Drawing\_CreateLineTypography(OH\_Drawing\_TypographyCreate\* handler)](/consumer/cn/doc/harmonyos-references/capi-drawing-text-linetypography-h#oh_drawing_createlinetypography) | 创建一个排版行对象[OH\_Drawing\_LineTypography](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-linetypography)的指针，排版行对象保存着文本内容以及样式的载体，可以用于计算单行排版信息。 |
| [void OH\_Drawing\_DestroyLineTypography(OH\_Drawing\_LineTypography\* lineTypography)](/consumer/cn/doc/harmonyos-references/capi-drawing-text-linetypography-h#oh_drawing_destroylinetypography) | 释放排版行对象[OH\_Drawing\_LineTypography](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-linetypography)占用的内存。 |
| [size\_t OH\_Drawing\_LineTypographyGetLineBreak(OH\_Drawing\_LineTypography\* lineTypography,size\_t startIndex, double width)](/consumer/cn/doc/harmonyos-references/capi-drawing-text-linetypography-h#oh_drawing_linetypographygetlinebreak) | 计算在限定排版宽度的情况下，从指定位置处开始可以排版的字符个数。 |
| [OH\_Drawing\_TextLine\* OH\_Drawing\_LineTypographyCreateLine(OH\_Drawing\_LineTypography\* lineTypography,size\_t startIndex, size\_t count)](/consumer/cn/doc/harmonyos-references/capi-drawing-text-linetypography-h#oh_drawing_linetypographycreateline) | 根据指定区间文本内容创建一个指向文本行对象[OH\_Drawing\_TextLine](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-textline)的指针。 |
