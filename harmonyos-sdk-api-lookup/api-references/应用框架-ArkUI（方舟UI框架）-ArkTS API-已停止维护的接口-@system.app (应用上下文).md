...
| 参数类型 | 说明 |
| --- | --- |
| [AppResponse](/consumer/cn/doc/harmonyos-references/js-apis-system-app#appresponse) | 定义AppResponse信息。 |
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ScreenOnVisibleOptions](/consumer/cn/doc/harmonyos-references/js-apis-system-app#screenonvisibleoptions) | 否 | 当启动保活时，锁屏时将阻止系统返回桌面显示，以保持屏幕唤醒时应用可见。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RequestFullWindowOptions](/consumer/cn/doc/harmonyos-references/js-apis-system-app#requestfullwindowoptions) | 否 | 请求全屏时，设定非全屏到全屏的过渡时间，单位为毫秒，默认时间与非全屏到全屏的距离成正比。 |
