...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_NativeXComponent\_KeyCode](/consumer/cn/doc/harmonyos-references/capi-native-xcomponent-key-event-h#oh_nativexcomponent_keycode) | OH\_NativeXComponent\_KeyCode | 按键事件的键码。 |
| [OH\_NativeXComponent\_KeyAction](/consumer/cn/doc/harmonyos-references/capi-native-xcomponent-key-event-h#oh_nativexcomponent_keyaction) | OH\_NativeXComponent\_KeyAction | 按键事件动作。 |
