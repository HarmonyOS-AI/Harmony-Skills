...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [DrivingRouteParams](/consumer/cn/doc/harmonyos-references/map-navi-api#drivingrouteparams) | 是 | 驾车路径规划的参数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[RouteResult](/consumer/cn/doc/harmonyos-references/map-navi-api#routeresult)> | Promise对象，返回[RouteResult](/consumer/cn/doc/harmonyos-references/map-navi-api#routeresult)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [RouteParams](/consumer/cn/doc/harmonyos-references/map-navi-api#routeparams) | 是 | 步行路径规划的参数。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [RouteParams](/consumer/cn/doc/harmonyos-references/map-navi-api#routeparams) | 是 | 骑行路径规划的参数。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context) | 是 | Context上下文。 |
| params | [TransitRouteParams](/consumer/cn/doc/harmonyos-references/map-navi-api#transitrouteparams) | 是 | 中转路线规划的参数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[TransitRouteResult](/consumer/cn/doc/harmonyos-references/map-navi-api#transitrouteresult)> | Promise对象，返回[TransitRouteResult](/consumer/cn/doc/harmonyos-references/map-navi-api#transitrouteresult)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [DrivingMatrixParams](/consumer/cn/doc/harmonyos-references/map-navi-api#drivingmatrixparams) | 是 | 驾车批量算路的参数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[MatrixResult](/consumer/cn/doc/harmonyos-references/map-navi-api#matrixresult)> | Promise对象，返回[MatrixResult](/consumer/cn/doc/harmonyos-references/map-navi-api#matrixresult)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [MatrixParams](/consumer/cn/doc/harmonyos-references/map-navi-api#matrixparams) | 是 | 步行批量算路的参数。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [MatrixParams](/consumer/cn/doc/harmonyos-references/map-navi-api#matrixparams) | 是 | 骑行批量算路的参数。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [SnapToRoadsParams](/consumer/cn/doc/harmonyos-references/map-navi-api#snaptoroadsparams) | 是 | 轨迹绑路的参数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[SnapToRoadsResult](/consumer/cn/doc/harmonyos-references/map-navi-api#snaptoroadsresult)> | Promise对象，返回[SnapToRoadsResult](/consumer/cn/doc/harmonyos-references/map-navi-api#snaptoroadsresult)。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| origins | Array<[RouteCoordinate](/consumer/cn/doc/harmonyos-references/map-navi-api#routecoordinate)> | 否 | 否 | 道路绑定的起点坐标列表。  坐标点的数量不能超过31个，相邻两个点之间的距离应大于1米。 |
| destination | [RouteCoordinate](/consumer/cn/doc/harmonyos-references/map-navi-api#routecoordinate) | 否 | 否 | 目的地。  **说明：**  若未设置途经点，起点和目的地坐标不能相同。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| routes | Array<[Route](/consumer/cn/doc/harmonyos-references/map-navi-api#route)> | 否 | 否 | 从起点到目的地的规划路径。如果没有结果，返回空数组。 |

## DrivingRouteParams

PhonePC/2in1TabletWearable

驾车路径规划参数接口，继承[RouteParams](/consumer/cn/doc/harmonyos-references/map-navi-api#routeparams)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| steps | Array<[RouteStep](/consumer/cn/doc/harmonyos-references/map-navi-api#routestep)> | 否 | 否 | 路线规划信息。 |
...
| bounds | Array<[CoordinateBound](/consumer/cn/doc/harmonyos-references/map-navi-api#coordinatebound)> | 否 | 是 | 路线边界范围。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| roads | Array<[RouteRoad](/consumer/cn/doc/harmonyos-references/map-navi-api#routeroad)> | 否 | 否 | 路线分段信息。 |
...
| viaWaypoints | Array<[Waypoint](/consumer/cn/doc/harmonyos-references/map-navi-api#waypoint)> | 否 | 是 | 途经点信息。 |
...
| trafficSegments | Array<[TrafficSegment](/consumer/cn/doc/harmonyos-references/map-navi-api#trafficsegment)> | 否 | 是 | 路况信息。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| origins | Array<[RouteCoordinate](/consumer/cn/doc/harmonyos-references/map-navi-api#routecoordinate)> | 否 | 否 | 起点的经纬度，不能超过100个。 |
| destinations | Array<[RouteCoordinate](/consumer/cn/doc/harmonyos-references/map-navi-api#routecoordinate)> | 否 | 否 | 终点的经纬度，不能超过100个。  **说明：**  1. 驾车路线只能在直线距离2000公里内规划；步行路线只能在直线距离150公里内规划；骑行路线只能在直线距离500公里内规划。  2. 起点的数量乘以终点的数量不能超过100。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| origin | [RouteCoordinate](/consumer/cn/doc/harmonyos-references/map-navi-api#routecoordinate) | 否 | 否 | 起点的经纬度。 |
| destination | [RouteCoordinate](/consumer/cn/doc/harmonyos-references/map-navi-api#routecoordinate) | 否 | 否 | 终点的经纬度。  **说明：**  起点和终点的经纬度不能相同。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| routes | [TransitRoute](/consumer/cn/doc/harmonyos-references/map-navi-api#transitroute)[] | 否 | 是 | 可能的路线列表。 |
...
| --- | --- | --- | --- | --- |
| id | string | 否 | 否 | 路线ID。 |
| sections | [TransitRouteSection](/consumer/cn/doc/harmonyos-references/map-navi-api#transitroutesection)[] | 否 | 否 | 交通路线和行人路段列表。 |
| busSortInfo | [BusSortInfo](/consumer/cn/doc/harmonyos-references/map-navi-api#bussortinfo) | 否 | 是 | 路线规划汇总信息。 |
...
| pedestrianSection | [PedestrianSection](/consumer/cn/doc/harmonyos-references/map-navi-api#pedestriansection) | 否 | 是 | 行人路段。 |
| transitSection | [TransitSection](/consumer/cn/doc/harmonyos-references/map-navi-api#transitsection) | 否 | 是 | 中转区。 |
...
| arrival | [PedestrianDepartureArrival](/consumer/cn/doc/harmonyos-references/map-navi-api#pedestriandeparturearrival) | 否 | 否 | 行人路段的终点。 |
| departure | [PedestrianDepartureArrival](/consumer/cn/doc/harmonyos-references/map-navi-api#pedestriandeparturearrival) | 否 | 否 | 行人路段的起点。 |
| language | string | 否 | 是 | 本地语言（如果有），采用BCP47格式。 |
| passthrough | [Passthrough](/consumer/cn/doc/harmonyos-references/map-navi-api#passthrough)[] | 否 | 是 | 此路段正在经过的途经点列表。请求的每个途经点在响应中显示为passThrough=true。途经点出现在最近的非直达路线中。途经点按请求中的顺序遍历。  预留字段，当前无使用场景。 |
| polyline | [mapCommon.LatLng](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#latlng)[] | 否 | 是 | 路线的形状坐标。 |
| travelSummary | [BaseSummary](/consumer/cn/doc/harmonyos-references/map-navi-api#basesummary) | 否 | 是 | 关键属性（例如，持续时间、长度）的集合，仅在‘出发’和‘到达’之间的旅行部分。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| place | [Place](/consumer/cn/doc/harmonyos-references/map-navi-api#place) | 否 | 否 | 行人路线中的场所。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| place | [Place](/consumer/cn/doc/harmonyos-references/map-navi-api#place) | 否 | 否 | 出发/到达地点。 |
...
| arrival | [TransitArrival](/consumer/cn/doc/harmonyos-references/map-navi-api#transitarrival) | 否 | 否 | 中转结束。 |
| departure | [TransitDeparture](/consumer/cn/doc/harmonyos-references/map-navi-api#transitdeparture) | 否 | 否 | 中转开始。 |
| intermediateStops | [TransitStop](/consumer/cn/doc/harmonyos-references/map-navi-api#transitstop)[] | 否 | 是 | 中转线路的始发站和目的地之间的中间站点。  如果此信息不可用或未请求，则可能缺失。 |
| language | string | 否 | 是 | 本地语言（如果有），采用BCP47格式。预留字段，当前无使用场景。 |
| passthrough | [Passthrough](/consumer/cn/doc/harmonyos-references/map-navi-api#passthrough)[] | 否 | 是 | 此路段正在经过的途经点列表。请求的每个途经点在响应中显示为passThrough=true。途经点出现在最近的非直达路线中。途经点按请求中的顺序遍历。  预留字段，当前无使用场景。 |
| polyline | [mapCommon.LatLng](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#latlng)[] | 否 | 是 | 路线的形状坐标。 |
| transport | [TransitTransport](/consumer/cn/doc/harmonyos-references/map-navi-api#transittransport) | 否 | 是 | 中转路线信息。 |
| travelSummary | [BaseSummary](/consumer/cn/doc/harmonyos-references/map-navi-api#basesummary) | 否 | 是 | 关键属性（例如，持续时间、长度）的集合。仅在‘出发’和‘到达’之间的旅行部分进行汇总，不包括预操作和后操作。 |
| extraTransitSection | [ExtraTransitSection](/consumer/cn/doc/harmonyos-references/map-navi-api#extratransitsection)[] | 否 | 是 | 相同的起点和终点，可到达的其他公共交通线路。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| place | [Place](/consumer/cn/doc/harmonyos-references/map-navi-api#place) | 否 | 否 | 到达地点。 |
| delay | number | 否 | 是 | 距计划时间的累计延迟（以秒为单位）。预留字段，当前无使用场景。 |
| time | number | 否 | 是 | 自1970年1月1日00:00:00（UTC）起，中转站的预计到达时间。以秒为单位。 |
| exit | [TransitEntranceExit](/consumer/cn/doc/harmonyos-references/map-navi-api#transitentranceexit) | 否 | 是 | 中转站出口。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| place | [Place](/consumer/cn/doc/harmonyos-references/map-navi-api#place) | 否 | 否 | 出发地点。 |
| delay | number | 否 | 是 | 距计划时间的累计延迟（以秒为单位）。预留字段，当前无使用场景。 |
| time | number | 否 | 是 | 自1970年1月1日00:00:00（UTC）起，中转站的预计出发时间。以秒为单位。 |
| entrance | [TransitEntranceExit](/consumer/cn/doc/harmonyos-references/map-navi-api#transitentranceexit) | 否 | 是 | 中转站入口。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| mode | [TransitMode](/consumer/cn/doc/harmonyos-references/map-navi-api#transitmode) | 否 | 否 | 中转类型。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| intermediateStops | [TransitStop](/consumer/cn/doc/harmonyos-references/map-navi-api#transitstop)[] | 否 | 否 | 中转线路的始发站和目的地之间的中间站点。如果此信息不可用或未请求，则可能缺失。 |
| polyline | [mapCommon.LatLng](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#latlng)[] | 否 | 否 | 路线的形状坐标。 |
| transport | [TransitTransport](/consumer/cn/doc/harmonyos-references/map-navi-api#transittransport) | 否 | 否 | 中转路线信息。 |
| travelSummary | [BaseSummary](/consumer/cn/doc/harmonyos-references/map-navi-api#basesummary) | 否 | 否 | 关键属性（例如，持续时间、长度）的集合。仅在‘出发’和‘到达’之间的旅行部分进行汇总，不包括预操作和后操作。 |
| firstVehicleHour | number | 否 | 是 | 首班车/地铁时间，单位：s。 |
| finalVehicleHour | number | 否 | 是 | 末班车/地铁时间，单位：s。 |
| stopOffset | number | 否 | 是 | 上车站点/换乘站点距离始发站的偏移时间，单位：s。 |
...
| rows | Array<[MatrixRow](/consumer/cn/doc/harmonyos-references/map-navi-api#matrixrow)> | 否 | 否 | 起点和终点两两进行路径规划后的计算出来的时长和距离。 |

## DrivingMatrixParams

PhonePC/2in1TabletWearable

驾车批量算路参数接口，继承[MatrixParams](/consumer/cn/doc/harmonyos-references/map-navi-api#matrixparams)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| cells | Array<[MatrixCell](/consumer/cn/doc/harmonyos-references/map-navi-api#matrixcell)> | 否 | 否 | 距离矩阵中每个单元格的信息。 |
...
| snappedPoints | Array<[SnappedPoint](/consumer/cn/doc/harmonyos-references/map-navi-api#snappedpoint)> | 否 | 否 | 道路上的坐标点。坐标点的数量不能超过100个，并且两个相邻点之间的距离不能超过500米。 |
