...
* 本模块接口基于[CLDR](https://cldr.unicode.org)国际化数据库实现，随着CLDR标准的迭代演进，接口处理结果可能会相应调整。例如[时间日期格式化接口](/consumer/cn/doc/harmonyos-references/js-apis-i18n#simplenumberformat18)，其返回值仅适用于界面展示场景，开发者请勿对返回格式进行硬编码或假设性判断，否则可能导致版本兼容问题。其中，API version 12 对应[CLDR 42](https://cldr.unicode.org/index/downloads/cldr-42)版本，具体数据变更详情可查阅[CLDR官方文档](https://cldr.unicode.org/)。
...
获取系统当前设置的语言。若要监听系统语言变化，可以监听[公共事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/commoneventmanager-definitions#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-system-language-region#开发步骤)。
...
获取系统当前设置的国家地区。若要监听系统地区变化，可以监听[公共事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/commoneventmanager-definitions#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-system-language-region#开发步骤)。
...
获取系统当前设置的区域对象。若要监听系统区域变化，可以监听[公共事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/commoneventmanager-definitions#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-system-language-region#开发步骤)。
...
判断系统时制是否为24小时制。若要监听系统时制变化，可以监听[公共事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/commoneventmanager-definitions#common_event_time_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_TIME\_CHANGED，具体可参考[用户偏好](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-user-preferences#开发步骤)。
...
| 类型 | 说明 |
| --- | --- |
| [TemperatureType](/consumer/cn/doc/harmonyos-references/js-apis-i18n#temperaturetype18) | 温度单位。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [TemperatureType](/consumer/cn/doc/harmonyos-references/js-apis-i18n#temperaturetype18) | 是 | 温度单位。 |
...
| 类型 | 说明 |
| --- | --- |
| [WeekDay](/consumer/cn/doc/harmonyos-references/js-apis-i18n#weekday18) | 周起始日。 |
...
| type | string | 否 | 表示历法，取值包括：buddhist, chinese, coptic, ethiopic, hebrew, gregory, indian, islamic\_civil, islamic\_tbla, islamic\_umalqura, japanese, persian。  默认值：区域默认的历法。不同取值代表的含义和使用场景请参考[设置日历和历法](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-calendar)。 |
...
| 类型 | 说明 |
| --- | --- |
| [Calendar](/consumer/cn/doc/harmonyos-references/js-apis-i18n#calendar) | 日历对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[EntityInfoItem](/consumer/cn/doc/harmonyos-references/js-apis-i18n#entityinfoitem11)> | 文本中的实体信息列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| field | string | 是 | 指定的日历属性，目前支持的属性值有 year, month, week\_of\_year, week\_of\_month, date, day\_of\_year, day\_of\_week, day\_of\_week\_in\_month, hour, hour\_of\_day, minute, second, millisecond。  各取值代表的含义请参考[get](/consumer/cn/doc/harmonyos-references/js-apis-i18n#get8)。 |
...
| options | [PhoneNumberFormatOptions](/consumer/cn/doc/harmonyos-references/js-apis-i18n#phonenumberformatoptions8) | 否 | 电话号码格式化时设置的配置项。默认值：NATIONAL。 |
...
| 类型 | 说明 |
| --- | --- |
| [IndexUtil](/consumer/cn/doc/harmonyos-references/js-apis-i18n#indexutil8) | 根据区域ID创建的IndexUtil对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。  生成的[BreakIterator](/consumer/cn/doc/harmonyos-references/js-apis-i18n#breakiterator8)将按照指定区域的规则计算可换行点的位置。 |
...
| 类型 | 说明 |
| --- | --- |
| [BreakIterator](/consumer/cn/doc/harmonyos-references/js-apis-i18n#breakiterator8) | 可换行点处理器。 |
...
| 类型 | 说明 |
| --- | --- |
| [TimeZone](/consumer/cn/doc/harmonyos-references/js-apis-i18n#timezone) | 时区ID对应的时区对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[TimeZone](/consumer/cn/doc/harmonyos-references/js-apis-i18n#timezone)> | 时区对象数组，数组中对象对应的时区为该地理位置推荐的时区。 |
...
| 类型 | 说明 |
| --- | --- |
| [ZoneRules](/consumer/cn/doc/harmonyos-references/js-apis-i18n#zonerules20) | 时区跳变规则，包含跳变的时间点、跳变前后的偏移量信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [ZoneOffsetTransition](/consumer/cn/doc/harmonyos-references/js-apis-i18n#zoneoffsettransition20) | 时区跳变对象。 |
...
| 类型 | 说明 |
| --- | --- |
| number | 从1970年1月1日0时0分0秒到时区跳变点之间的毫秒数，例如：1762074000000，单位：毫秒。如果当前时区[原始偏移量](/consumer/cn/doc/harmonyos-references/js-apis-i18n#getrawoffset)保持不变并且不使用夏令时，则返回0。 |
...
| 类型 | 说明 |
| --- | --- |
| [Transliterator](/consumer/cn/doc/harmonyos-references/js-apis-i18n#transliterator9) | 音译对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fromUnit | [UnitInfo](/consumer/cn/doc/harmonyos-references/js-apis-i18n#unitinfo8) | 是 | 需要转换的单位。 |
| toUnit | [UnitInfo](/consumer/cn/doc/harmonyos-references/js-apis-i18n#unitinfo8) | 是 | 转换成的目标单位。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [NormalizerMode](/consumer/cn/doc/harmonyos-references/js-apis-i18n#normalizermode10) | 是 | 文本标准化范式。 |
...
| 类型 | 说明 |
| --- | --- |
| [Normalizer](/consumer/cn/doc/harmonyos-references/js-apis-i18n#normalizer10) | 返回指定范式的文本标准化对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[HolidayInfoItem](/consumer/cn/doc/harmonyos-references/js-apis-i18n#holidayinfoitem11)> | 返回节假日信息列表。 |
...
| localNames | Array<[HolidayLocalName](/consumer/cn/doc/harmonyos-references/js-apis-i18n#holidaylocalname11)> | 否 | 是 | 节假日的本地名称列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [SimpleDateTimeFormat](/consumer/cn/doc/harmonyos-references/js-apis-i18n#simpledatetimeformat18) | SimpleDateTimeFormat对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dateTimeFormat | [Intl.DateTimeFormat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat) | [SimpleDateTimeFormat](/consumer/cn/doc/harmonyos-references/js-apis-i18n#simpledatetimeformat18) | 是 | 用于格式化时间日期的对象。 |
| options | [StyledDateTimeFormatOptions](/consumer/cn/doc/harmonyos-references/js-apis-i18n#styleddatetimeformatoptions23) | 否 | 指定时间日期格式化对象的配置项。默认值：默认的文本样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [SimpleNumberFormat](/consumer/cn/doc/harmonyos-references/js-apis-i18n#simplenumberformat18) | SimpleNumberFormat对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numberFormat | [intl.NumberFormat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-intl#numberformat) | [SimpleNumberFormat](/consumer/cn/doc/harmonyos-references/js-apis-i18n#simplenumberformat18) | 是 | 用于格式化数字的对象。 |
| options | [StyledNumberFormatOptions](/consumer/cn/doc/harmonyos-references/js-apis-i18n#stylednumberformatoptions18) | 否 | 指定数字格式化对象的配置项。默认值：默认的文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numberFormat | [Intl.NumberFormat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat) | [SimpleNumberFormat](/consumer/cn/doc/harmonyos-references/js-apis-i18n#simplenumberformat18) | 是 | 用于格式化数字的对象。 |
| options | [StyledNumberFormatOptions](/consumer/cn/doc/harmonyos-references/js-apis-i18n#stylednumberformatoptions18) | 否 | 指定数字格式化对象的配置项。默认值：默认的文本样式。 |
...
| options | [AdvancedMeasureFormatOptions](/consumer/cn/doc/harmonyos-references/js-apis-i18n#advancedmeasureformatoptions23) | 否 | 指定数字格式化对象的配置项。默认值：与[numberFormat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat)格式化效果一样。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| unitUsage | [UnitUsage](/consumer/cn/doc/harmonyos-references/js-apis-i18n#unitusage23) | 否 | 是 | 单位格式化使用场景的枚举。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fromUnit | [UnitInfo](/consumer/cn/doc/harmonyos-references/js-apis-i18n#unitinfo8) | 是 | 要被转换的单位。 |
| toUnit | [UnitInfo](/consumer/cn/doc/harmonyos-references/js-apis-i18n#unitinfo8) | 是 | 要转换为的单位。 |
