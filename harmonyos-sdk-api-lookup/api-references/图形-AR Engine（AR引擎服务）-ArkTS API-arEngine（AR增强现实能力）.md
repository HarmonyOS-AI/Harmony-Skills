...
| GRAVITY\_AND\_HEADING | 1 | 由重力和指南针确定。  世界坐标系的Y轴与重力方向一致，X轴指向指南针北向，原点为设备所在的原始位置。参见[坐标系说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arengine-overview#坐标系说明)。  **说明：** 该选项当前仅支持省电模式，请将[ARPowerMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpowermode)置为POWER\_SAVING以启动该选项。 |
...
| BOOST | 3 | 仅输出设备姿态信息模式。  AR Engine仅输出设备的位姿信息，电源消耗低于正常模式。在此模式下，[ARPlaneFindingMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arplanefindingmode)等与平面相关的设置不起作用。 |
...
将图像添加到图像数据库中，并输出相应图像的索引（Index）。开发者可以通过[ARAugmentedImageDatabase.getCapacity](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araugmentedimagedatabasegetcapacity)获取可添加图像的最大数量，通过[ARConfig.addAugmentedImageMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arconfig)接口来设置调用此接口后的行为。使用Promise异步回调。
...
| **类型** | **说明** |
| --- | --- |
| Promise<[ARAddAugmentedImageResult](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araddaugmentedimageresult)> | Promise对象，返回ARAddAugmentedImageResult对象。  ARAddAugmentedImageResult是一个表示添加增强图像结果的数据。 |
...
获取通过调用[ARAugmentedImageDatabase.addImage](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araugmentedimagedatabaseaddimage)接口所能添加的图像最大数量。
...
| **类型** | **说明** |
| --- | --- |
| [ARAddAugmentedImageMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araddaugmentedimagemode) | 返回图片的添加模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [ARAddAugmentedImageMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araddaugmentedimagemode) | 是 | 添加图片模式。 |
...
释放增强图像数据库对象[ARAugmentedImageDatabase](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araugmentedimagedatabase)占用的内存。使用Promise异步回调。
...
| distortion | [Distortion](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#distortion) | 是 | 否 | 相机畸变参数。 |

## ARConfig

PhoneTabletTV

[ARSession](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsession)的功能配置参数。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [ARType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artype) | 否 | 否 | AR能力类型。 |
| planeFindingMode | [ARPlaneFindingMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arplanefindingmode) | 否 | 是 | 平面检测模式。  默认为HORIZONTAL\_AND\_VERTICAL。 |
| powerMode | [ARPowerMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpowermode) | 否 | 是 | 电源功耗模式。  默认为NORMAL。 |
| focusMode | [ARFocusMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arfocusmode) | 否 | 是 | 对焦模式。  默认为FIXED。 |
| semanticMode | [ARSemanticMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsemanticmode) | 否 | 是 | 语义模式。  默认为NONE。 |
| maxMapSize | number | 否 | 是 | 存储地图数据的最大内存大小，单位为MB。可设定范围100MB~16GB，默认800MB。  建议根据设备的内存容量设置内存大小。超出硬件限制可能会导致意外错误。 |
| poseMode | [ARPoseMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arposemode) | 否 | 是 | 创建世界坐标系的方式。  默认为GRAVITY。 |
| depthMode | [ARDepthMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#ardepthmode) | 否 | 是 | 深度模式。  默认为DISABLED。 |
| meshMode | [ARMeshMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#armeshmode) | 否 | 是 | 网格模式。  默认为DISABLED。 |
| addAugmentedImageMode | [ARAddAugmentedImageMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araddaugmentedimagemode) | 否 | 是 | 添加图片模式。  默认为NORMAL。 |
| semanticDenseMode | [ARSemanticDenseMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsemanticdensemode) | 否 | 是 | 高精几何重建识别模式。  默认DISABLED。  **起始版本：** 6.0.0(20) |
| cameraLensFacing | [ARCameraLensFacing](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arcameralensfacing) | 否 | 是 | 相机镜头朝向配置项。当cameraLensFacing配置为FRONT时，type配置为[ARType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artype).FACE或[ARType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artype).BODY才生效。  默认为REAR。  **起始版本：** 6.1.0(23) |
| multiFaceMode | [ARMultiFaceMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#armultifacemode) | 否 | 是 | 多人脸模式配置项。  默认为MULTIFACE\_DISABLE。  **起始版本：** 6.1.0(23) |
...
| label | [ARSemanticPlaneLabel](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsemanticplanelabel) | 是 | 否 | 当前立方体的语义标签。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARFrame](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arframe) | 返回AR Engine处理后的一帧数据。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| pose | [ARPose](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpose) | 是 | 用于创建锚点的位姿对象。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARAnchor](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#aranchor) | 返回一个锚点对象。 |
...
由于此函数并没有释放锚点[ARAnchor](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#aranchor)，开发者需要通过调用[ARAnchor.release](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#aranchorrelease)来释放锚点。
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| anchor | [ARAnchor](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#aranchor) | 是 | 要解绑的锚点对象。 |
...
| **类型** | **说明** |
| --- | --- |
| Array<[ARAnchor](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#aranchor)> | 返回一个锚点对象组成的数组。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| type | [ARTrackableType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackabletype) | 是 | 可追踪对象的类型。 |
...
| **类型** | **说明** |
| --- | --- |
| Array<[ARTrackable](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackable)> | 返回一个可追踪对象组成的数组。 |
...
释放管理AR Engine系统状态对象[ARSession](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsession)占用的内存。使用Promise异步回调。
...
| stateReason | [ARAddAugmentedImageReason](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araddaugmentedimagereason) | 否 | 否 | 添加图像失败的原因。 |
...
| trackingState | [ARTrackingState](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackingstate) | 是 | 否 | 可追踪对象的追踪状态。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARPose](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpose) | 返回位姿对象。 |
...
这个函数不会释放锚点，开发者需要通过调用[ARAnchor.release](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#aranchorrelease)方法来释放锚点。
...
释放锚点对象[ARAnchor](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#aranchor)占用的内存。使用Promise异步回调。
...
这个类继承自[ARTrackable](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackable)类。
...
| **类型** | **说明** |
| --- | --- |
| Array<[ARBlendShapeType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arblendshapetype)> | 微表情的类型。 |
...
释放[ARBlendShapes](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arblendshapes)对象。使用Promise异步回调。
...
释放[ARLandmark](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arlandmark)对象。使用Promise异步回调。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state | [ARTrackingState](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackingstate) | 是 | 否 | 可追踪对象的追踪状态。 |
| stateReason | [ARTrackingStateReason](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackingstatereason) | 是 | 否 | 追踪失败的原因。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARPose](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpose) | 返回一个位姿对象。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARCameraIntrinsics](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arcameraintrinsics) | 返回一个相机内参对象。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARGeometry](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#argeometry) | 人脸拓扑结构对象，即人脸Mesh对象。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARBlendShapes](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arblendshapes) | 人脸微表情对象。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARLandmark](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arlandmark) | 人脸关键点对象。 |
...
这个类继承自[ARAnchor](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#aranchor)类。
...
| **类型** | **说明** |
| --- | --- |
| [ARFace](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arface) | 人脸跟踪的结果。 |
...
| type | [ARBodyLandmarkType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arbodylandmarktype) | 否 | 否 | 骨骼关键点点类型。 |
...
| **类型** | **说明** |
| --- | --- |
| Array<[ARBodyLandmark2D](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arbodylandmark2d)> | 返回人体骨骼关键点信息数组。 |
...
| pointCloud | [ARPointCloud](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpointcloud) | 是 | 否 | 表示当前帧中可追踪的3D点云集合。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARCamera](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arcamera) | 返回当前帧的相机对象。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| type | [ARTrackableType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackabletype) | 是 | 可追踪对象类型。 |
...
| **类型** | **说明** |
| --- | --- |
| Array<[ARHitResult](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arhitresult)> | 返回一个命中检测结果对象组成的数组。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARSceneMesh](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arscenemesh) | 返回环境网格数据的集合。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARImage](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arimage) | 返回相机视频流帧对象。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARSemanticDenseData](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsemanticdensedata) | 返回当前帧的高精几何重建对象数据。 |
...
| **类型** | **说明** |
| --- | --- |
| Array<[ARBody](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arbody)> | 返回人体对象组成的数组。 |
...
释放帧数据对象[ARFrame](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arframe)占用的内存。使用Promise异步回调。
...
释放[ARGeometry](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#argeometry)对象。使用Promise异步回调。
...
如果[ARPointOrientationMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpointorientationmode)是ESTIMATED\_SURFACE\_NORMAL，则 X+ 是射线的垂直向量，也就是平面的平行向量，Y+ 是平面的法向量，Z+ 是平面的平行向量，大致指向相机。

如果[ARPointOrientationMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpointorientationmode)是INITIALIZED\_TO\_IDENTITY，则坐标的旋转不会随着平面的角度变化而变化。X+ 是射线的垂直向量，指向右侧（从设备的视角），Y+ 指向上方，Z+ 大致指向相机。
...
| **类型** | **说明** |
| --- | --- |
| [ARTrackable](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackable) | 返回可被追踪的对象。 |
...
释放命中检测结果对象[ARHitResult](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arhitresult)占用的内存。使用Promise异步回调。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| format | [ARImageFormat](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arimageformat) | 是 | 否 | 图像数据格式。 |
...
| planes | Array<[ImageComponent](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#imagecomponent)> | 是 | 否 | 图像组件的基本结构参数列表。 |
...
释放相机视频流帧对象[ARImage](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arimage)占用的内存。使用Promise异步回调。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| planeType | [ARPlaneType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arplanetype) | 否 | 否 | 平面类型。 |
| extendX | number | 否 | 否 | 平面边界矩形沿平面局部坐标系X轴的长度，以m为单位，数值范围无限制。 |
| extendZ | number | 否 | 否 | 平面边界矩形沿平面局部坐标系Z轴的长度，以m为单位，数值范围无限制。 |
| label | [ARSemanticPlaneLabel](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsemanticplanelabel) | 否 | 否 | 当前平面识别到的语义类型。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARPlane](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arplane) | 返回一个平面对象，表示父平面。如果没有父平面，将返回undefined。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| pose | [ARPose](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpose) | 是 | 位姿对象。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARPlane](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arplane) | 返回平面对象，描述被检测到的可跟踪平面信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| orientationMode | [ARPointOrientationMode](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpointorientationmode) | 是 | 否 | 朝向模式。 |
...
释放位姿对象[ARPose](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpose)占用的内存。使用Promise异步回调。
...
释放环境网格数据对象[ARSceneMesh](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arscenemesh)占用的内存。使用Promise异步回调。
...
| **类型** | **说明** |
| --- | --- |
| [ARSemanticDensePointData](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsemanticdensepointdata) | 返回所有高精几何重建对象数据中稠密点云数据信息。 |
...
| **类型** | **说明** |
| --- | --- |
| Array<[ARSemanticDenseCubeData](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsemanticdensecubedata)> | 返回一个高精几何重建对象数据的立方体数据信息的列表。 |
...
释放高精几何重建对象数据[ARSemanticDenseData](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arsemanticdensedata)占用的内存。使用Promise异步回调。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [ARTrackableType](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackabletype) | 是 | 否 | 可追踪对象类型。 |
| state | [ARTrackingState](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackingstate) | 是 | 否 | 可追踪对象的追踪状态。 |
...
| **类型** | **说明** |
| --- | --- |
| [ARPose](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpose) | 返回可追踪对象的位姿信息。 |
...
释放被追踪对象[ARTrackable](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#artrackable)占用的内存。使用Promise异步回调。
...
| **类型** | **说明** |
| --- | --- |
| Promise<[ARAugmentedImageDatabase](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#araugmentedimagedatabase)> | Promise对象，返回ARAugmentedImageDatabase对象。 |
...
在AR Engine中创建和初始化一个新的[ARPose](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpose)对象并返回。
...
| **类型** | **说明** |
| --- | --- |
| [ARPose](/consumer/cn/doc/harmonyos-references/arengine-api-arengine#arpose) | 返回创建的位姿对象。 |
