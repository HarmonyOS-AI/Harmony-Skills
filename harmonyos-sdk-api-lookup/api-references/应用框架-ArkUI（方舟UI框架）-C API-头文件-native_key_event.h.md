...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI\_KeyCode](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#arkui_keycode) | ArkUI\_KeyCode | 按键事件的键码。 |
| [ArkUI\_KeyEventType](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#arkui_keyeventtype) | ArkUI\_KeyEventType | 按键的类型。 |
| [ArkUI\_KeySourceType](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#arkui_keysourcetype) | ArkUI\_KeySourceType | 触发当前按键的输入设备类型。 |
| [ArkUI\_KeyIntension](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#arkui_keyintension) | ArkUI\_KeyIntension | 按键对应的意图。 |
...
| 名称 | 描述 |
| --- | --- |
| [ArkUI\_KeyEventType OH\_ArkUI\_KeyEvent\_GetType(const ArkUI\_UIInputEvent\* event)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_gettype) | 获取按键的类型。 |
| [int32\_t OH\_ArkUI\_KeyEvent\_GetKeyCode(const ArkUI\_UIInputEvent\* event)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_getkeycode) | 获取按键的键码。 |
| [const char OH\_ArkUI\_KeyEvent\_GetKeyText(const ArkUI\_UIInputEvent event)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_getkeytext) | 获取按键的键值。 |
| [ArkUI\_KeySourceType OH\_ArkUI\_KeyEvent\_GetKeySource(const ArkUI\_UIInputEvent\* event)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_getkeysource) | 获取当前按键的输入设备类型。 |
| [void OH\_ArkUI\_KeyEvent\_StopPropagation(const ArkUI\_UIInputEvent\* event, bool stopPropagation)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_stoppropagation) | 阻塞事件冒泡传递。 |
| [ArkUI\_KeyIntension OH\_ArkUI\_KeyEvent\_GetKeyIntensionCode(const ArkUI\_UIInputEvent\* event)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_getkeyintensioncode) | 获取按键对应的意图。 |
| [uint32\_t OH\_ArkUI\_KeyEvent\_GetUnicode(const ArkUI\_UIInputEvent\* event)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_getunicode) | 获取按键的Unicode码值。支持范围为非空格的基本拉丁字符：0x0021-0x007E，不支持字符为0。组合键场景下，返回当前keyEvent对应按键的Unicode码值。 |
| [void OH\_ArkUI\_KeyEvent\_SetConsumed(const ArkUI\_UIInputEvent\* event, bool isConsumed)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_setconsumed) | 在按键事件回调中，设置事件是否被该回调消费。 |
| [void OH\_ArkUI\_KeyEvent\_Dispatch(ArkUI\_NodeHandle node, const ArkUI\_UIInputEvent\* event)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_dispatch) | 将按键事件分发到特定组件节点。 |
| [ArkUI\_ErrorCode OH\_ArkUI\_KeyEvent\_IsNumLockOn(const ArkUI\_UIInputEvent\* event, bool\* state)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_isnumlockon) | 获取按键事件发生时NumLock的状态。 |
| [ArkUI\_ErrorCode OH\_ArkUI\_KeyEvent\_IsCapsLockOn(const ArkUI\_UIInputEvent\* event, bool\* state)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_iscapslockon) | 获取按键事件发生时CapsLock的状态。 |
| [ArkUI\_ErrorCode OH\_ArkUI\_KeyEvent\_IsScrollLockOn(const ArkUI\_UIInputEvent\* event, bool\* state)](/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#oh_arkui_keyevent_isscrolllockon) | 获取按键事件发生时ScrollLock的状态。 |
