...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ResourceManager\_ErrorCode](/consumer/cn/doc/harmonyos-references/capi-resmgr-common-h#resourcemanager_errorcode) | - | 资源管理错误码。 |
| [ScreenDensity](/consumer/cn/doc/harmonyos-references/capi-resmgr-common-h#screendensity) | - | 屏幕密度类型的枚举。 |
| [ResourceManager\_Direction](/consumer/cn/doc/harmonyos-references/capi-resmgr-common-h#resourcemanager_direction) | ResourceManager\_Direction | 屏幕方向的枚举。 |
| [ResourceManager\_ColorMode](/consumer/cn/doc/harmonyos-references/capi-resmgr-common-h#resourcemanager_colormode) | ResourceManager\_ColorMode | 颜色模式的枚举。 |
| [ResourceManager\_DeviceType](/consumer/cn/doc/harmonyos-references/capi-resmgr-common-h#resourcemanager_devicetype) | ResourceManager\_DeviceType | 设备类型的枚举。 |
