...
88. .onClick(() => {
89. // 删除这个key，会导致和p失去联系，之后p无法存储，即使reconnect
...
95. .onClick(() => {
96. // 删除这个key，会导致和p失去联系，之后p无法存储，即使reconnect
...
102. .onClick(() => {
103. // 删除这个key，会导致和p失去联系，之后p无法存储，即使reconnect
...
109. .onClick(() => {
110. // 删除这个key，会导致和p失去联系，之后p无法存储，即使reconnect
...
118. .onClick(() => {
119. // 删除这个key，会导致和p失去联系，之后p无法存储，即使reconnect
