...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/-HT_r1VnTeijxqI8v_WPXg/zh-cn_image_0000002566708569.gif?HW-CC-KV=V1&HW-CC-Date=20260403T131932Z&HW-CC-Expire=86400&HW-CC-Sign=3A7F614BF8249E385682416DE5AC117BF37ECAD1D8644053910B603333969F3D)
...
14. onBackPress() {
15. // 当前页面是否可前进或者后退给定的step步(-1),正数代表前进，负数代表后退
16. if (this.controller.accessStep(-1)) {
17. this.controller.backward(); // 返回上一个web页
18. // 执行用户自定义返回逻辑
19. return true;
20. } else {
21. // 执行系统默认返回逻辑，返回上一个page页
22. return false;
23. }
24. }
25. }
...
[ReturnLastWebPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20251117/ArkWeb/WebGestureInteraction/entry/src/main/ets/pages/ReturnLastWebPage.ets#L15-L44)
