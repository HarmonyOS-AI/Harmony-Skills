...
1. 新建工程时选择API 10及以上的Stage模型，工程创建完成后，新建“Static Library”模块。模块创建方法可参考[在工程中添加Module](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-add-new-module)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/BwOUjDJnRTG6foUB801D_A/zh-cn_image_0000002532750173.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=4128EDF6CD397D3FB4B161D1BAF44B37AE8A9A7F2D5EB3F679A0D861C738F056)
2. 编写代码。
...
2. 在HAR模块的build-profile.json5中，将byteCodeHar设置为true。
   ...
   7. }
   ```
3. 点击DevEco Studio右上角图标![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/BUh8T1qdRoezMFB2u3AsQA/zh-cn_image_0000002501070134.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=181C48EA76ECD767CF31A1EB09429F6D4AA2313CF8B351E339B941ECFF2E7968)，选择**Build Mode，**默认为**<Default>**模式：在编译App时使用release模式，编译HAP/HSP/HAR时使用debug模式。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/PLZYL8p-RJSkfnEbxiPmzw/zh-cn_image_0000002501070126.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=E7F07E83BA67BDCE2DF3A1028C10C26E54D1BDE4AC601A98B4FD8AEA87EE2419)
...
6. 选中HAR模块的根目录，点击**Build > Make Module '<module-name>'**启动构建。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/RrvFla-LSM29q0DWYRx-hQ/zh-cn_image_0000002500910290.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=B68693FE8499C78F6004A745920B97848DBB8E29D0C8DD625B08AC67664BEB8F)

   构建完成后，build目录下生成HAR包产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/HdxFVpGBReCEZ0QzysVeVQ/zh-cn_image_0000002532670203.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=2684B95DA5175F0C09CE1E6E7F8FA387C18B78327DCDFE0E8A0DEF20FCDBBF53)

   HAR包产物解压后，结构如下：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/ECyq9qXoQYmGWUMIRpEGYQ/zh-cn_image_0000002532750167.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=FA5BE11A11F9375D5670B9A79943BC6F995E80737B7985956AD1B495619E4EB3)
...
2. 点击DevEco Studio右上角图标![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/EGF6bqEBTsKz7SLZZrhwaA/zh-cn_image_0000002501070130.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=F765F9198806793BD705E3CA1C3243415B2CE771A48C56FA97DC48D6F3A509BE)，**Build Mode**选择**debug。**默认为**<Default>**模式：在编译App时使用release模式，编译HAP/HSP/HAR时使用debug模式。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/CyNa6KH4TbKsYNe_8CkEXA/zh-cn_image_0000002501070136.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=2C916E8768EA45D98B0CC32C2C3904FCB1F6F942A7F867F06A55B13BF2C85EBD)
3. （可选）若部分工程源文件无需构建到HAR包中，可在模块目录下新建.ohpmignore文件，或者在模块目录下的.gitignore文件中，配置打包时要忽略的文件，.ohpmignore文件中支持正则表达式写法，.gitignore文件中支持glob语法。DevEco Studio构建时将过滤掉.ohpmignore或.gitignore文件中所包含的文件/文件夹。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/C-JHbAR0Sw2X3dPTFswhJw/zh-cn_image_0000002500910304.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=47B84D29CA25010E7BE325596926A7D0B1FBCC9FDECFB94CA549EDF1B071FF7F)
...
5. 选中HAR模块的根目录，点击**Build > Make Module '<module-name>'**启动构建。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/Qek98oA6SQqGJiEo9gPjpg/zh-cn_image_0000002532750171.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=3FC9F62197CBA661913B572FFAE2A240EEE57B5D205C719486DB6AEC77C0F57A)

   构建完成后，build目录下生成HAR包产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/tFG3lizxQr2UwKHy7BLoyg/zh-cn_image_0000002532750157.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=A1795A93122E6E77005835E0EFF39B8C8CB646752D428D35949002C9C675A6A1)

   HAR包产物解压后，结构如下：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/NM2JPiCGSDWa6kP5iFXt9Q/zh-cn_image_0000002532750169.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=1F751F3F24B70A3F7E6BE013F51AD3EFFEB012A9DB6921E4F99275BAA6B62341)
...
1. 在HAR模块的build-profile.json5中，将byteCodeHar设置为false。
   ...
   使用DevEco Studio NEXT Beta1（5.0.3.800）之前的版本，模块级build-profile.json5的byteCodeHar字段的缺省默认值为false，无需执行本步骤。
2. 点击DevEco Studio右上角图标![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/TLjBt9ZaSj-uA9KfJbbGPg/zh-cn_image_0000002532750175.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=7ABA326C1BED2663E84EB7C92A0220001FE2CB4AB28A434C87A9A2243237A52E)，**Build Mode**中选择**release。**默认为**<Default>**模式：在编译App时使用release模式，编译HAP/HSP/HAR时使用debug模式。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/_qpGErpPS86G-BcPdCotdw/zh-cn_image_0000002501070138.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=32D5AB2FD5F4E6BE5E6F4BFD3CAF6370F7A87EB27C3C673CC0415D1A57E839A5)
...
5. 选中HAR模块的根目录，点击**Build > Make Module '<module-name>'**启动构建。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/NaZYO9H1SMeZ3KyGzgE28A/zh-cn_image_0000002501070128.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=649D727663FE517ABE742781061F8807BF931C007CC8C4D2F4BC8F3B3C9D466E)

   构建完成后，build目录下生成HAR包产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/s5QaOk2yTG-NnAegS7Hgsw/zh-cn_image_0000002500910302.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=3977CA795D0907A5DCF540D7B3DDB9E62362161D55A68444101ADA1873220F4D)

   HAR包产物解压后，结构如下：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/wbtLL3BuQdG-Hi2T10-Uww/zh-cn_image_0000002500910308.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=AD1EC84828732731AF5F6C5ECB2D26ED7B332088220E9312851DA15255B011CB)
...
3. 选中HAR模块的根目录，点击**Build > Make Module '<module-name>'**启动构建。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/QKOxx-LhQYOBYubbwNIoSg/zh-cn_image_0000002532750165.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=A3A1823E075DDAC5A1F88D65B8546A9177EBF42A009C303B8C840E6A615295FD)

   构建完成后，build目录下生成签名HAR包产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/Eewv5xUISr2qdNBqVhqAgA/zh-cn_image_0000002532670209.png?HW-CC-KV=V1&HW-CC-Date=20260409T125927Z&HW-CC-Expire=86400&HW-CC-Sign=7F28F3A9C4F0892F31DB75C49BE2E4FF014EF91DAA042DD092A2CE18F0357154)