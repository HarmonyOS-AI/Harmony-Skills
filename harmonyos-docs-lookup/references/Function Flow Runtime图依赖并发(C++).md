...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/3wk6fIPyRvySYyXzkWe-mg/zh-cn_image_0000002535788896.png?HW-CC-KV=V1&HW-CC-Date=20260403T141237Z&HW-CC-Expire=86400&HW-CC-Sign=0655CB18D6782A4E96CA00EB457EBA3C55342D6F0669BED1780B6EAFE2AE201B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/98S2E34YR6ywirSXrKUZhQ/zh-cn_image_0000002535948842.png?HW-CC-KV=V1&HW-CC-Date=20260403T141237Z&HW-CC-Expire=86400&HW-CC-Sign=E73F62739E154A21A74CA0BA692648180A7A09AD1A8C41C7B7A51491D015D8B7)
...
5. {
6. // 提交任务
7. auto handle_A = ffrt::submit_h([] () { std::cout << "视频解析" << std::endl; });
8. auto handle_B = ffrt::submit_h([] () { std::cout << "视频转码" << std::endl; }, {handle_A});
9. auto handle_C = ffrt::submit_h([] () { std::cout << "视频生成缩略图" << std::endl; }, {handle_A});
10. auto handle_D = ffrt::submit_h([] () { std::cout << "视频添加水印" << std::endl; }, {handle_B, handle_C});
11. ffrt::submit([] () { std::cout << "视频发布" << std::endl; }, {handle_D});
...
11. // 提交任务并构建数据依赖
12. ffrt::submit([&]() { Fib(x - 1, y1); }, {&x}, {&y1});
13. ffrt::submit([&]() { Fib(x - 2, y2); }, {&x}, {&y2});
...
23. int y;
24. Fib(5, y);
25. std::cout << "Fibonacci(5) is " << y << std::endl;
26. }
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/GCX9WWQRQHiAfw50nuWfLg/zh-cn_image_0000002566868675.png?HW-CC-KV=V1&HW-CC-Date=20260403T141237Z&HW-CC-Expire=86400&HW-CC-Sign=D18116D8E9339E7FDE309ABF206DEF43C3D11882DFBC84D6DCB99F14FFE16DF6)
