...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/TEavYhIQTPqT5ya6Mi3EWA/zh-cn_image_0000002535948746.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=FB3F6E8A18461A48F262BF326BF6F6CD986F3C28719774496BD284BBEAD11901)

### 开始网页调试

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/VBRSUFKfQGSRWiRPcCXDQw/zh-cn_image_0000002566868579.png?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=837BE8C40735333FAE1CCD03FE44D3A24F8EB49CC18FDB50D3A741990F2D5606)
...
2. 使用hdc命令连接上设备。
   ...
   * 如果命令返回设备的ID，表示hdc已连接上设备。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/AimGTYWfTYSWZjVPv3vCww/zh-cn_image_0000002566708597.png?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=2A4FA23D55E8841BC3BD9FB9D5849EA44A02E34DDC3F18052D32C58BBFDF761A)
   * 如果命令返回 [Empty]，则说明hdc还没有发现设备。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/th-A8DhmTomSuVaGg9ddAA/zh-cn_image_0000002535788802.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=D340A769EE173EF10512A94B789EDB36AEC1379E2D15C11F5355790512821FC3)
3. 进入hdc shell。
...
1. 先在hdc shell里执行如下命令，查询ArkWeb在设备里创建的domain socket。
   ...
   * 如果前几步操作无误，该命令的执行结果将显示用于查询的domain socket端口。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/W-WcMY4gQ_qV9e0iVx9ncQ/zh-cn_image_0000002535948748.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=88BED26A565B8342322416E047D2903568FBEEEF30E7A68E54D0823BDA83322E)
   * 如果没有查询到结果， 请再次确认。
...
2. 将查询到的domain socket转发至电脑的TCP 9222端口。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/Ee7NDTPBRUqLOuMUwSs-8Q/zh-cn_image_0000002566868581.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=6D31A72A8EAB13BCCBB19DE31103EB4F12DD2A4274392CE823E901831A853CFC)
3. 在命令行里执行如下命令，检查端口是否转发成功。
   ...
   * 如果有返回端口转发的任务，则说明端口转发成功。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/bCTVqWRiQYWe9VwQncG5ew/zh-cn_image_0000002566708599.png?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=E15606F53B885911555D44383AE48D7030A9A7C7DCBD96DFD79B07A51EA678EF)
   * 如果返回 [Empty]， 则说明端口转发失败。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/9U4rSAl1RS-QIldUW_k6kQ/zh-cn_image_0000002535788804.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=FD68A503EFF5DC0267EC8E905B55CCAF19C1CEC82DEFCD9AD039D0B2A8252339)
...
2. 修改Chrome调试工具的配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/vSzo8cAWSXO88a7XgCjrmg/zh-cn_image_0000002535948750.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=1BEB3FFC23CCA49684BE0275291E698809E4029C77B8BD509E89E29544EA10A7)
3. 为了同时调试多个应用，请在Chrome浏览器的调试工具网页内，于“Devices”选项中的“configure”部分添加多个端口号。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/88ZYXy2tT6-fTLrP592fyA/zh-cn_image_0000002566868583.png?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=EC032996F3F01638A97B16C0D3CCC0CA219A3C0E18BC7F88FC8A37B90288DCD9)

### 等待发现被调试页面

如果前面的步骤执行成功，Chrome的调试页面将显示待调试的网页。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0f/v3/QqzwmLwFTQGEkb5QgM--aQ/zh-cn_image_0000002535948746.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=84DB1C6EE53BD033E1CDE4996CD7F7E17FD61496892FA4D20E4BB4FB53875F83)

### 开始网页调试

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/LIvb9UkUR7OqHsUo8JPPyQ/zh-cn_image_0000002566868579.png?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=2E623A7F629E0B7080C3297784D2C3C2069951799D2B52AEDC79D6A61C40AD3E)
...
* 转发成功后，请用电脑端的Chrome浏览器打开网址 <http://localhost:9222/json> ，URL里的9222需要改为自己实际配置的TCP端口。
  ...
  + 如果网页有内容， 说明端口转发成功，请在Chrome的调试页面[等待被调试页面的出现](/consumer/cn/doc/harmonyos-guides/web-debugging-with-devtools#等待发现被调试页面)。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/AVPYlvZRRm6vf9S9yMqMhA/zh-cn_image_0000002566708601.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=64BEEFB4D1E54C487616B2A0B345BBCE56D9A09800C582815F11FE1B71641B98)
  + 如果展示的是错误网页， 说明端口转发失败， 请参阅[端口转发不成功](/consumer/cn/doc/harmonyos-guides/web-debugging-with-devtools#端口转发不成功)中的解决方法。

    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/tq4FUrPNTjq8mu4Mk6ZWpw/zh-cn_image_0000002535788806.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T132257Z&HW-CC-Expire=86400&HW-CC-Sign=0B2EDA3F1F5B15771B8ECEB6648ADCD506361685AF5E49DF8B9B59A83A7603CA)
