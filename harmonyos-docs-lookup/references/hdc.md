...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/0krxP-iURMKoVpRD5ZKxaQ/zh-cn_image_0000002535788916.png?HW-CC-KV=V1&HW-CC-Date=20260403T142642Z&HW-CC-Expire=86400&HW-CC-Sign=E1031852F7FA67075CEF18B7E999E1088E96DE677CAC0AE9119B392C2AB700D9)
...
hdc支持USB和无线两种连接调试方式。在设备的设置>系统>开发者选项中开启或关闭调试开关 ，无需重启设备即可生效。如果设备未启用“开发者选项”，可参考[开发者选项](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-developer-mode#section530763213432)进行启用。具体调试连接方式及操作步骤请参考[USB连接场景](/consumer/cn/doc/harmonyos-guides/hdc#usb连接场景)和[TCP连接场景](/consumer/cn/doc/harmonyos-guides/hdc#tcp连接场景)。
...
配置系统环境变量可修改服务器进程的监听端口、日志打印级别或特性开关等。详细介绍请查看[可选配置项](/consumer/cn/doc/harmonyos-guides/hdc#可选配置项)章节。
...
| 参数 | 说明 |
| --- | --- |
| [-t](/consumer/cn/doc/harmonyos-guides/hdc#连接指定的目标设备) | 通过设备标识符连接指定的目标设备。单台设备连接时为可选参数，连接多台设备时为必选参数。 |
| [-l](/consumer/cn/doc/harmonyos-guides/hdc#服务器进程日志) | 可选参数，指定运行时日志等级，范围为数字0-6，默认为3（LOG\_INFO）。 |
| [-s](/consumer/cn/doc/harmonyos-guides/hdc#远程连接场景) | 可选参数，指定客户端连接服务器时，服务进程的网络监听参数，格式为IP:port。 |
| [-p](/consumer/cn/doc/harmonyos-guides/hdc#快速执行命令) | 可选参数，绕过对服务进程的查询步骤，用于快速执行客户端命令。 |
| [-m](/consumer/cn/doc/harmonyos-guides/hdc#前台启动服务) | 可选参数，使用前台启动模式启动服务进程。 |
| [-e](/consumer/cn/doc/harmonyos-guides/hdc#创建正向端口转发任务) | 可选参数，指定在TCP端口转发时，本地监听的IP地址，默认是127.0.0.1。该参数必须和-m一起使用。  使用-e参数指定监听地址时，如果监听地址不是本地回环地址（如127.0.0.1），需注意访问安全问题。  **说明**：从API version 20开始，支持该接口。 |
...
| 命令 | 说明 |
| --- | --- |
| [list targets](/consumer/cn/doc/harmonyos-guides/hdc#查询设备列表) | 查询已连接的所有目标设备。 |
| [wait](/consumer/cn/doc/harmonyos-guides/hdc#等待设备正常连接) | 等待设备正常连接。 |
| [tmode usb](/consumer/cn/doc/harmonyos-guides/hdc#usb调试和无线调试切换) | 3.1.0e版本起已废弃，不会操作设备连接通道，需在设备设置界面通过USB调试开关设置。 |
| [tmode port](/consumer/cn/doc/harmonyos-guides/hdc#打开设备网络连接通道) | 打开设备网络连接通道。 |
| [tmode port close](/consumer/cn/doc/harmonyos-guides/hdc#关闭网络连接通道) | 关闭设备网络连接通道。 |
| [tconn](/consumer/cn/doc/harmonyos-guides/hdc#tcp连接设备) | 指定连接设备：通过“IP:port”来指定连接的设备。 |
| [shell](/consumer/cn/doc/harmonyos-guides/hdc#执行交互命令) | 在设备端执行单次命令，例如hdc shell ls。无命令参数可进入设备端终端执行命令。 |
| [install](/consumer/cn/doc/harmonyos-guides/hdc#安装应用文件) | 安装指定的应用文件。 |
| [uninstall](/consumer/cn/doc/harmonyos-guides/hdc#卸载应用) | 卸载指定的应用包。 |
| [file send](/consumer/cn/doc/harmonyos-guides/hdc#本地发送文件至远端设备) | 从本地发送文件至远端设备。 |
| [file recv](/consumer/cn/doc/harmonyos-guides/hdc#接收远端设备文件至本地) | 接收远端设备文件至本地。 |
| [fport ls](/consumer/cn/doc/harmonyos-guides/hdc#查询端口转发任务列表) | 列出全部转发端口任务。 |
| [fport](/consumer/cn/doc/harmonyos-guides/hdc#创建正向端口转发任务) | 设置正向端口转发任务：监听“主机端口”，接收请求并转发到“设备端口”。 |
| [rport](/consumer/cn/doc/harmonyos-guides/hdc#创建反向端口转发任务) | 设置反向端口转发任务：监听“设备端口”，接收请求并转发到“主机端口”。 |
| [fport rm](/consumer/cn/doc/harmonyos-guides/hdc#删除端口转发任务) | 删除指定的端口转发任务。 |
| [start](/consumer/cn/doc/harmonyos-guides/hdc#启动服务) | 启动hdc服务进程。 |
| [kill](/consumer/cn/doc/harmonyos-guides/hdc#终止服务) | 终止hdc服务进程。 |
| [hilog](/consumer/cn/doc/harmonyos-guides/hdc#打印设备端日志) | 打印设备端的日志信息。 |
| [jpid](/consumer/cn/doc/harmonyos-guides/hdc#显示设备已打开应用的进程pid) | 显示设备上已打开应用的进程pid。 |
| [track-jpid](/consumer/cn/doc/harmonyos-guides/hdc#实时显示设备已打开应用的进程pid和应用名) | 实时显示设备上已打开应用的进程pid和应用名。 |
| [target boot](/consumer/cn/doc/harmonyos-guides/hdc#重启目标设备) | 重启目标设备。 |
| [keygen](/consumer/cn/doc/harmonyos-guides/hdc#安全相关命令) | 生成一个新的密钥对。 |
| [version](/consumer/cn/doc/harmonyos-guides/hdc#查询hdc版本号) | 打印hdc版本信息，也可使用hdc -v打印版本信息。 |
| [checkserver](/consumer/cn/doc/harmonyos-guides/hdc#查询客户端和服务器进程版本) | 获取客户进程与服务进程版本信息。 |
| [bugreport](/consumer/cn/doc/harmonyos-guides/hdc#导出系统信息) | 导出系统信息 |
...
如出现hdc list targets无法获取设备信息的情况，请参见[设备无法识别](/consumer/cn/doc/harmonyos-guides/hdc#设备无法识别)章节。
...
| 返回信息 | 说明 |
| --- | --- |
| 正常执行返回信息，参考[命令列表](/consumer/cn/doc/harmonyos-guides/hdc#命令列表)具体说明。 | - |
...
命令返回的错误信息仅供开发者参考，后续可能会优化调整。请勿将此类信息用于自动化脚本或程序的逻辑判断，实际程序交互建议使用系统异常提供的标准错误码，具体详情可参考[hdc错误码](/consumer/cn/doc/harmonyos-guides/hdc#hdc错误码)。
...
| hdc环境变量 | 终端命令行输入hdc -h有回显帮助信息内容。 | 参见[环境准备](/consumer/cn/doc/harmonyos-guides/hdc#环境准备)章节。 |
| 驱动 | 连接hdc设备后，设备管理器通用串行总线设备存在设备“HDC Device”或“HDC Interface”。 | 参见[设备无法识别](/consumer/cn/doc/harmonyos-guides/hdc#设备无法识别)章节。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/gFTQPFOBSue5oeczlxgwwA/zh-cn_image_0000002535948862.png?HW-CC-KV=V1&HW-CC-Date=20260403T142642Z&HW-CC-Expire=86400&HW-CC-Sign=E1956F72D7C5E14A97FE67B196DFFB98D95A32A8C5BC9CD5636AEB8AE498BF03)
...
| command | hdc支持的命令，参见[hdc命令列表](/consumer/cn/doc/harmonyos-guides/hdc#hdc命令列表)。 |
...
| [Fail]具体失败信息。 | 执行失败，参见[hdc错误码](/consumer/cn/doc/harmonyos-guides/hdc#hdc错误码)。 |
...
| -m | 使用前台启动模式启动服务进程。  前台启动模式（添加-m参数）：实时打印服务日志到客户端窗口。  后台启动模式（不添加-m参数）：客户端不打印服务日志，日志内容写入本地磁盘文件，具体文件存放路径可参考[服务器进程日志](/consumer/cn/doc/harmonyos-guides/hdc#服务器进程日志)。 |
...
用于设置服务进程日志记录级别，日志级别详情参考：[服务器进程日志](/consumer/cn/doc/harmonyos-guides/hdc#服务器进程日志)指定运行时日志等级章节。
...
以配置OHOS\_HDC\_LOG\_LEVEL值为5举例，介绍环境变量配置方法，更详细的步骤可参考[环境准备](/consumer/cn/doc/harmonyos-guides/hdc#环境准备)。
...
| hdc版本 | API版本 | 新增特性 |
| --- | --- | --- |
| 3.1.0a | 12 | wait命令支持-t参数：详细说明参见[等待设备正常连接](/consumer/cn/doc/harmonyos-guides/hdc#等待设备正常连接)。 |
| 3.1.0e | 15及以上版本 | - file send命令支持-b参数：详细说明参见[文件传输](/consumer/cn/doc/harmonyos-guides/hdc#文件传输)。  - file recv命令支持-b参数：详细说明参见[文件传输](/consumer/cn/doc/harmonyos-guides/hdc#文件传输)。  - shell命令支持-b参数：详细说明参见[执行交互命令](/consumer/cn/doc/harmonyos-guides/hdc#执行交互命令)。 |
| 3.2.0b | 20 | - 端口转发任务支持监听远端主机IP：详细说明参见[创建正向端口转发任务](/consumer/cn/doc/harmonyos-guides/hdc#创建正向端口转发任务)。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/kkrwYtjkSTymtJZW_vrm2A/zh-cn_image_0000002566868695.png?HW-CC-KV=V1&HW-CC-Date=20260403T142642Z&HW-CC-Expire=86400&HW-CC-Sign=F77AA62DD97D244991A33C564D62872EDABAE699776BF275F140E3C3EEE66344)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/8pPCL7-JTYiVKwQI1FPJzg/zh-cn_image_0000002566708715.png?HW-CC-KV=V1&HW-CC-Date=20260403T142642Z&HW-CC-Expire=86400&HW-CC-Sign=E381BC32BDD9CEDAEC4FFF80BDCEF15C2B497DBAA843109C676AF9EC16D17F40)
...
3. 执行hdc kill关闭服务器进程后，执行hdc -l5 start收集日志（hdc.log位于执行端TEMP目录下，不同平台目录位置存在差异，可参考[服务器进程日志](/consumer/cn/doc/harmonyos-guides/hdc#服务器进程日志)）。
4. 通过hdc.log日志定位相关问题。
...
可参考[hdc版本配套表](/consumer/cn/doc/harmonyos-guides/hdc#hdc版本配套表)升级到最新版本。
...
hdc tmode usb命令已废弃，参见[USB调试和无线调试切换](/consumer/cn/doc/harmonyos-guides/hdc#usb调试和无线调试切换)。

**处理步骤**

参见[USB调试和无线调试切换](/consumer/cn/doc/harmonyos-guides/hdc#usb调试和无线调试切换)tmode usb命令说明。
...
参考[USB调试和无线调试切换](/consumer/cn/doc/harmonyos-guides/hdc#usb调试和无线调试切换)，完善执行命令。
...
2. 参考[hdc版本配套表](/consumer/cn/doc/harmonyos-guides/hdc#hdc版本配套表)章节，将版本升级到最新。
...
参考[设备无法识别](/consumer/cn/doc/harmonyos-guides/hdc#设备无法识别)中描述的实际场景对应的解决方式进行操作。
...
尝试升级设备版本，或参考[hdc命令列表](/consumer/cn/doc/harmonyos-guides/hdc#hdc命令列表)检查命令是否准确。
...
确认command参数不为空值，详细使用方法请参考[执行交互命令](/consumer/cn/doc/harmonyos-guides/hdc#执行交互命令)。
...
参考[执行交互命令](/consumer/cn/doc/harmonyos-guides/hdc#执行交互命令)使用当前版本支持的命令行参数，如-b参数。
...
升级设备操作系统版本到最新，具体版本可参考[hdc版本配套表](/consumer/cn/doc/harmonyos-guides/hdc#hdc版本配套表)中版本配套说明。
...
命令指定-b参数时，缺少bundlename，SOURCE，DEST参数，命令详情参考[文件传输](/consumer/cn/doc/harmonyos-guides/hdc#文件传输)。
...
1. 场景一：升级到最新系统版本，具体版本可参考[hdc版本配套表](/consumer/cn/doc/harmonyos-guides/hdc#hdc版本配套表)中版本配套说明。
2. 场景二：升级到最新SDK版本，具体版本可参考[hdc版本配套表](/consumer/cn/doc/harmonyos-guides/hdc#hdc版本配套表)中版本配套说明。
...
请参考错误码[E003001 （命令行）指定的包名非法](/consumer/cn/doc/harmonyos-guides/hdc#e003001-命令行指定的包名非法)。
...
参考[应用管理](/consumer/cn/doc/harmonyos-guides/hdc#应用管理)。
