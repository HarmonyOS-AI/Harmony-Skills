...
* 方式二：通过DevEco Studio主动采集日志。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/FnOP2__qTpuzFjOaDZExxA/zh-cn_image_0000002497916886.png?HW-CC-KV=V1&HW-CC-Date=20260403T142104Z&HW-CC-Expire=86400&HW-CC-Sign=3E9A367686DEDC6A5374373AE0F4899B08C1E9D3A8D9227524764B089FED12EE)
...
* 检测到泄漏后抓取**15min内的进程内存trace**，可将日志如下图通过Open File加载到DevEco Studio进行解析。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/fr7QL5xGREqr4GU9P0lW1A/zh-cn_image_0000002529596883.png?HW-CC-KV=V1&HW-CC-Date=20260403T142104Z&HW-CC-Expire=86400&HW-CC-Sign=8CDCE0C43A12CE8CA90EAAD2E25E624C23207987C2D444004A550B2423EE57D4)
...
* **All Heap：**选择后展示抓取15分钟内的内存情况，记录了hook malloc等系统调用的堆栈。Native日志是以so+偏移的形式展示调用栈（每一行表示一次内存分配行为调用栈），需要结合符号表进一步分析。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/kWk1idEDSuKpQPtEnJRtiA/zh-cn_image_0000002529716857.png?HW-CC-KV=V1&HW-CC-Date=20260403T142104Z&HW-CC-Expire=86400&HW-CC-Sign=32BB6FBE2D570CBD4D2E9F66B42565E78401BC534A13EA71E056EDA611638A1D "点击放大")
...
* **All Anonymous VM：**选择后记录了当前hook mmap系统调用的堆栈信息。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/KvmiLlJOSc-zTL0wIeoEqA/zh-cn_image_0000002497756910.png?HW-CC-KV=V1&HW-CC-Date=20260403T142104Z&HW-CC-Expire=86400&HW-CC-Sign=9834FE8A688F00A3C8CDF724BBE567E55E17A9C22E37111C251FCC73E5A1A9FD "点击放大")
