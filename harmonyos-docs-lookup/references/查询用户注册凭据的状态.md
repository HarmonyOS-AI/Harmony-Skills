...
2. try {
3. let enrolledState = userAuth.getEnrolledState(userAuth.UserAuthType.PIN);
4. Logger.info(`get current enrolled state success, enrolledState: ${JSON.stringify(enrolledState)}`);
