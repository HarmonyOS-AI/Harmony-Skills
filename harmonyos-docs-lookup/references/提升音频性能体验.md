...
1. 进入CPU Trace。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/4BiAeGv5TW63e66DnkQDtw/zh-cn_image_0000002566868727.png?HW-CC-KV=V1&HW-CC-Date=20260403T143138Z&HW-CC-Expire=86400&HW-CC-Sign=C10FC741BC2E44DE5494F54DBC15E4B7138EF69027C1A0A0A386948A186E621E)

   打开HiSmartPerf工具，进入游戏性能分析的CPU Trace页面。虽然标题是游戏性能分析，但分析场景并不仅限于游戏场景。
2. 抓取配置。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/OK5muIZXRkuSwrGMzREB6A/zh-cn_image_0000002566708747.png?HW-CC-KV=V1&HW-CC-Date=20260403T143138Z&HW-CC-Expire=86400&HW-CC-Sign=E776BBB1B626FCB1E13B4E0A108BD4B9D3622DFDDCD0B79E7B5F90C750D33F7A)

   配置项主要有数据文件名、缓存容量、最大文件大小、数据项和采集时间。要抓取系统音频相关的数据项，需要勾选zaudio。采集时间可以按测试场景进行调节，需要注意，测试时长和勾选的数据项数量会影响文件大小，往往需要同步调节。
3. 开始采集。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/Ums000ttSZCvbydOp0WRZw/zh-cn_image_0000002535788950.png?HW-CC-KV=V1&HW-CC-Date=20260403T143138Z&HW-CC-Expire=86400&HW-CC-Sign=FC5840F7C83A237D54F13A24A57ED10D362934DCD5ED3A7A3400416652A99807)

   采集完成后将提示文件回传，当文件较大时请耐心等待。
4. 查看Trace。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/DgaeGEw2RY613GEbLXWD3g/zh-cn_image_0000002535948898.png?HW-CC-KV=V1&HW-CC-Date=20260403T143138Z&HW-CC-Expire=86400&HW-CC-Sign=B29C88F50BD0F6F3B2ECC8D56317439B2FC5E0C88C1B786784739FDF806E3BF5)

   采集时间内的cpu性能分析结果。
5. 找到音频数据处理线程。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/Rzr5hzePTaG7CQekFZdjdg/zh-cn_image_0000002566868729.png?HW-CC-KV=V1&HW-CC-Date=20260403T143138Z&HW-CC-Expire=86400&HW-CC-Sign=BEA77D7A239C45C5192EE96A107EB1E773E64AAFA13E39F4ED93884834AEB3B1)

   对于音频播放业务，可以通过OnWriteData搜索目标测试应用为系统输入播放数据的位置，进一步分析数据的生产来源的性能情况。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/9J-GXhCoT1yngOv6qJ7fVw/zh-cn_image_0000002566708749.png?HW-CC-KV=V1&HW-CC-Date=20260403T143138Z&HW-CC-Expire=86400&HW-CC-Sign=2A27E0355BBEFAB37454316CACF3F2506BB04C6BE1EDD4C30D3C178D8CDF125B)

   runnable表示线程在等待调度，当存在由于过长的runnable导致数据未能被及时写入的情况，包括应用自身的数据生产线程，则需要考虑接入音频工作组，以提升线程的优先级并保障CPU资源分配。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/G_PX-H9vTl6o_8asciBT2A/zh-cn_image_0000002535788952.png?HW-CC-KV=V1&HW-CC-Date=20260403T143138Z&HW-CC-Expire=86400&HW-CC-Sign=367D72A78C5A34B3AD16251C3AD527744A111B35867371E6E8D092EACBC589AB)

   在CPU Usage中可以查看每个任务的CPU占用情况。

   从Trace中找出问题原因后，可以参考[常见性能问题和解决方案](/consumer/cn/doc/harmonyos-guides/audio-performance#常见性能问题和解决方案)，进行性能调优。
