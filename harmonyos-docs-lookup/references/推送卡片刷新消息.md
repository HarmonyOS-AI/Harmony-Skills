...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/cHR0Nqm0QYqkrcu7kyxjYQ/zh-cn_image_0000002368705872.png?HW-CC-KV=V1&HW-CC-Date=20260403T154616Z&HW-CC-Expire=86400&HW-CC-Sign=2D2F21DFC4D54F40E31EF37F8BE8F233B77983C28310ECC2D1010BD92242ADFE "点击放大")
...
3. 应用服务端调用REST API推送卡片刷新消息，消息详情可参见[场景化消息API接口功能介绍](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-scenariozed-api-intro)，请求示例如下：
   ...
   * moduleName：项目模块级别下的 **src/main/module.json5** 中的 **module** 标签下的**name**值。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/jt_xbt9qSte9Z3tqvYtr_A/zh-cn_image_0000002402225577.png?HW-CC-KV=V1&HW-CC-Date=20260403T154616Z&HW-CC-Expire=86400&HW-CC-Sign=268328D8440951F69F1CDEB79FFB416EE239E87DD51FEDE1C3F74FC7C1354796 "点击放大")
   * abilityName：项目模块级别下的**src/main/module.json5**中的**extensionAbilities**标签下的服务卡片的ability名称。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/O121-Rw-TnuNNtP_vJSFTg/zh-cn_image_0000002402305721.png?HW-CC-KV=V1&HW-CC-Date=20260403T154616Z&HW-CC-Expire=86400&HW-CC-Sign=AF615854112E262BC0BA146BEF3EFDC92A8D9CF30CB9F226C49BA5D09DAB7516 "点击放大")
   * formName：项目模块级别下的**src/main/resources/base/profile/form\_config.json**中的**forms**标签下的服务卡片的名称。下图以卡片配置文件form\_config为例：

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/_KrpM5zlQveOVxBWh8kn1A/zh-cn_image_0000002368545980.png?HW-CC-KV=V1&HW-CC-Date=20260403T154616Z&HW-CC-Expire=86400&HW-CC-Sign=1D4A78B90C9C6DC407682EF5F0E17637017C9C5F32F25DFE91C38D3F82C41FE0 "点击放大")
   ...
   * formData：填写待刷新服务卡片的业务数据，该数据来源于项目模块级别下的**src/main/ets/widget/pages/WidgetCard.ets**文件下的声明式范式组件名称。下图以卡片页面文件WidgetCard为例：
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/3nwLeBa-ReOVfCKh00pF6A/zh-cn_image_0000002368705868.png?HW-CC-KV=V1&HW-CC-Date=20260403T154616Z&HW-CC-Expire=86400&HW-CC-Sign=A46DF16B1CC5679C65B0F45CC314E5E35E944D696046B910D6F9CF3911924C66 "点击放大")
   * images：待刷新服务卡片业务数据中的图片数据，其中keyName为您服务卡片中图片控件的key值，url为图片的地址，下图以卡片页面文件**WidgetCard**为例：

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/LtaIGlAtQpC61kfOkbIhzw/zh-cn_image_0000002402225573.png?HW-CC-KV=V1&HW-CC-Date=20260403T154616Z&HW-CC-Expire=86400&HW-CC-Sign=8EFFC918AE9769C8399BBF44048BE340FB3D8D041197023713A836AA13404FBB "点击放大")
