...
| --- | --- | --- | --- |
| 场景编号 | 场景分类 | 场景名称 | 简述 |
| 1 | 并发能力选择 | [耗时任务并发执行场景](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section15392153922413) | 相对独立的耗时任务放到单独的子线程中执行，推荐TaskPool |
| 2 | [常驻任务并发执行场景](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section76941238135110) | 常驻的耗时任务放到单独的子线程中执行，推荐Worker |
| 3 | [传统共享内存并发业务](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section196265243512) | 开发共享内存并发业务，推荐TaskPool和Worker的API |
| 4 | [长时任务并发执行场景](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section484614505514) | 长时间运行的任务不独占线程执行，推荐TaskPool长时任务 |
| 5 | 并发任务管理 | [多任务关联执行（串行顺序依赖）](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section843404931116) | 有顺序的任务不希望并发执行 |
| 6 | [多任务关联执行（树状依赖）](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section154701412191218) | 任务存在依赖关系，等待依赖执行完再调度 |
| 7 | [多任务同步等待结果（任务组）](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section13759133112128) | 多个任务等待全部结果返回后再进行后续操作 |
| 8 | [多任务优先级调度](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section873704510120) | 设置不同任务的优先级 |
| 9 | [任务延时调度](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section18304175813129) | 任务延时调度 |
| 10 | 线程间通信 | [同语言线程间通信（ArkTS内）](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section35851753051) | 介绍ArkTS线程间通信机制 |
| 11 | [跨语言多线程通信（C++与ArkTS）](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section101785720619) | 介绍C++与ArkTS线程间通信机制 |
| 12 | [线程间模块共享（单例模式）](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section19259192873) | 介绍进程内单例场景 |
| 13 | [线程间不可变数据共享](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section154816558122) | 介绍不可变数据共享场景 |
| 14 | [生产者与消费者模式](/consumer/cn/doc/best-practices/bpta-app-concurrency-design#section9833163071612) | 介绍生产者与消费者模式 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/4ydfEwfmTmaipiYVLuuzQg/zh-cn_image_0000002194011076.png?HW-CC-KV=V1&HW-CC-Date=20260403T155901Z&HW-CC-Expire=86400&HW-CC-Sign=5AB94493757C8653FAB6F95D638FCB6C1777A823E1C333B628AA48E4CD4788FC "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/UQ_D_mL7RdaeDph9vpW4_A/zh-cn_image_0000002194011072.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T155901Z&HW-CC-Expire=86400&HW-CC-Sign=C67F85542CA7D92D2AE3285FF2DFDD0269DFB7D492497F75B8A56E798EC1D6B8 "点击放大")

共享内存模型采用线程和锁的并发机制，不同线程共享内存并通过锁保护临界区。对于包含I/O操作或锁的业务，为防止阻塞，需开启多个线程执行不同业务。线程情况如下图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/kS3VexGMQFO_w7oL2_rbmw/zh-cn_image_0000002194011068.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T155901Z&HW-CC-Expire=86400&HW-CC-Sign=AFBE19127F9FC27AEB7DC0C26C5BB4AECD1A14A4970D1F40044D72A0A5B2DBC3 "点击放大")

因此，应用经常存在几百个线程，增加调度开销和内存占用。

### ArkTS并发模型

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/2TB6bt61RA2KPQhzITOr6Q/zh-cn_image_0000002194011084.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T155901Z&HW-CC-Expire=86400&HW-CC-Sign=49EF396318F5682D9C02401A8C989A4301DD864EDF5436FD09B61A4AC3F869C2 "点击放大")

ArkTS采用内存隔离的线程模型，不同线程间通过消息通信，线程内无锁化运行。业务内部的I/O操作由系统分发到后台的I/O任务池，不阻塞ArkTS上层逻辑，线程情况如下图所示。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/NwsmPEhASpSd_g1KldCPdw/zh-cn_image_0000002229336865.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T155901Z&HW-CC-Expire=86400&HW-CC-Sign=2CA366BDC8EAD1371A3ABF78375E28A68DEA2BD62CA9692D400647A7D5251F0F "点击放大")
...
* **实现方案介绍（方案一）**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/W8loLgKSQ-iLR5xQ6PYDOg/zh-cn_image_0000002194011080.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T155901Z&HW-CC-Expire=86400&HW-CC-Sign=C5C5ADA6C17C099486D21E27547A468FFDBB4404A7BFAAA3D4059AC1DFCCEAD6 "点击放大")
* **业务实现中的关键点**
  1. JS模块对象
