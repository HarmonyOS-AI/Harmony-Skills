...
```
1. bm install [-h] [-p filePath] [-r] [-w waitingTime] [-s hspDirPath] [-u userId]
```
...
| -u | 可选参数，指定[用户](/consumer/cn/doc/harmonyos-guides/bm-tool#userid)，默认在当前活跃用户下安装应用。仅支持在当前活跃用户或0用户下安装。  **说明：**  如果当前活跃用户是100，使用命令bm install -p /data/local/tmp/ohos.app.hap -u 102安装时，只会在当前活跃用户100下安装应用。 |
...
| -u | 可选参数，指定[用户](/consumer/cn/doc/harmonyos-guides/bm-tool#userid)，默认在当前活跃用户下卸载应用。仅支持在当前活跃用户或0用户下卸载应用。  **说明：**  如果当前活跃用户是100，使用命令bm uninstall -n com.ohos.app -u 102卸载时，只会在当前活跃用户100下卸载应用。 |
...
| -u | 可选参数，查询指定[用户](/consumer/cn/doc/harmonyos-guides/bm-tool#userid)下的应用信息，默认在当前活跃用户下查询应用信息。仅支持在当前活跃用户或0用户下查询。  **说明：**  如果当前活跃用户是100，使用命令bm dump -n com.ohos.app -u 102查询时，只会在当前活跃用户100下查询应用。 |
...
| -u | 可选参数，清理指定[用户](/consumer/cn/doc/harmonyos-guides/bm-tool#userid)下的数据，默认在当前活跃用户下清理数据。仅支持在当前活跃用户或0用户下清理数据。  **说明：**  如果当前活跃用户是100，使用命令bm clean -c -n com.ohos.app -u 102清理数据时，只会在当前活跃用户100下清理。 |
...
| -u | 可选参数，在指定[用户](/consumer/cn/doc/harmonyos-guides/bm-tool#userid)下查询OverlayModuleInfo信息，默认在当前活跃用户下查询。仅支持在当前活跃用户或0用户下查询。  **说明：**  如果当前活跃用户是100，使用命令bm dump-overlay -b com.ohos.app -u 102查询OverlayModuleInfo信息，只会返回当前活跃用户100下的OverlayModuleInfo信息。 |
...
| -u | 可选参数，在指定[用户](/consumer/cn/doc/harmonyos-guides/bm-tool#userid)下查询OverlayModuleInfo信息，默认在当前活跃用户下查询。仅支持在当前活跃用户或0用户下查询。  **说明：**  如果当前活跃用户是100，使用命令bm dump-target-overlay -b com.ohos.app -u 102查询目标应用com.ohos.app中的所有关联的OverlayBundleInfo信息，只会返回当前活跃用户100下的OverlayModuleInfo信息。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/_InP6UEER9WissVdRZ5VQg/zh-cn_image_0000002566868709.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=5CD8773F17F1AC50AAFE9D046D50EF1380E92275108301E93F0FD7983E057B28)
...
* 方法一：先通过[bm install -p](/consumer/cn/doc/harmonyos-guides/bm-tool#安装命令install)命令安装依赖的动态共享包（HSP）模块，再在应用运行配置页勾选Keep Application Data，点击OK保存配置，再运行/调试。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/GJJKrA_JQv2f2hSW99c5yQ/zh-cn_image_0000002566708729.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=82DA241DDE81AEAEAB9F757607E7520453C19EC4A262E869F3D9AA36739915E5)
* 方法二：在运行配置页，选择Deploy Multi Hap标签页，勾选Deploy Multi Hap Packages，选择依赖的模块，点击OK保存配置，再进行运行/调试。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/Gll7nJ0tSs-GTYYscak9Hg/zh-cn_image_0000002535788932.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=213110144E5F62508BFFBD01F8F8CC4CAE8BB8B5AE90E9F751CD8D0D079AC59E)
* 方法三：单击Run > Edit Configurations，在General中，勾选Auto Dependencies。点击OK保存配置，再运行/调试。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/rVEDLQP9Qb2f_e769njPyw/zh-cn_image_0000002535948880.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=EFE67A9C193C68342A45CD7DB7C6B1FD4A1406E753A81AA002A2B96E3F205FFE)

场景二：依赖的HSP与HAP不在同一工程内：

在安装HAP前，使用[bm install](/consumer/cn/doc/harmonyos-guides/bm-tool#安装命令install)命令安装依赖的HSP。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/TNals1BYTuuY5vQoUtvfeQ/zh-cn_image_0000002566868711.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=BFFA217E82E2760D871D51A8338E90EC7272C34E2BE5EEBAF8A565E2AC1A2984)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/FFLL8Rv5S_yP0rD3BHthAw/zh-cn_image_0000002566708731.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=CC77934A8256BE2AD5B4DE1C52A65D04AE16C0188587D0D82B0BE04C9986E542)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/tBZboKMaRCGkRm8OV0ezNA/zh-cn_image_0000002535788934.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=96887076A7EA00B018F68239FB45B2C6AA2E085936E3E394848C7B84E57DA35D)
...
安装插件用了[bm install](/consumer/cn/doc/harmonyos-guides/bm-tool#安装命令install)命令。

**处理步骤**

安装插件请使用[bm install-plugin](/consumer/cn/doc/harmonyos-guides/bm-tool#安装插件命令install-plugin)命令。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/Ozk-aKgxTaWmFsqvUH060Q/zh-cn_image_0000002535948882.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=3AA25540AA755915FF565E6E18444376A07FA7EB68CE08273B470B7F54D93906)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/HO7cEKqXQ4qctt3YcmZNQw/zh-cn_image_0000002566868713.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=4F447F32A7B472D5C0DAB42E83A4FFFB2ECAC90DC4E037602B94CDFD100F9F96)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/Hx0likKQQa2x6sqykTtYhA/zh-cn_image_0000002566708733.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=2582E3A9218ECE3F1BB3106B76AFA5B81156527820A08E5F095B60E35BED1694)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/sUfZfaHYQT6ah_a42amk1w/zh-cn_image_0000002535788936.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=48F09B19F1AF8CB4F3D1A97C981033D391BAFF48C4B8654032DDA8BCC37BD4D3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/p6K4L5_9RJyH8KPUKpSrcg/zh-cn_image_0000002535948884.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=DBE79479577925B2B35A13DD6B95CFEC49AC9A54C899DA8F82867239ED463B08)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/BD2GDux9R4OOnSZDe6db0Q/zh-cn_image_0000002566868715.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=9551421C643E0DB17196CDD69A8F03B372952B264D7A48F115E23AD13FCA64C7)
...
1. 确认签名文件p7b中apl字段是否有误。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/8jZNW9sDThmnkyEs9ZkaiA/zh-cn_image_0000002566708735.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=E59CDBD8FFCB3C3D6158805C1C948D3DF1B8B0FDDC3B33BAEF900952C16F1CE7)
2. 若apl字段有误，修改UnsgnedReleasedProfileTemplate.json文件中apl字段，并重新签名。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/1RMJoBjARvC3qRB9Hydl9g/zh-cn_image_0000002535788938.png?HW-CC-KV=V1&HW-CC-Date=20260403T142707Z&HW-CC-Expire=86400&HW-CC-Sign=8CBE03BD549A5380F14641BB28984921B85886D4C76B565DF2E5A31F35492986)
...
使用[bm dump -n](/consumer/cn/doc/harmonyos-guides/bm-tool#查询应用信息命令dump)命令查看应用配置，确认要卸载的模块已经安装。
...
2. 在命令行执行如下[hdc命令](/consumer/cn/doc/harmonyos-guides/bm-tool#环境要求hdc工具)，查询设备支持的Abi列表。
...
检查多HAP的Abi是否一致，请参考[错误码9568347](/consumer/cn/doc/harmonyos-guides/bm-tool#section9568347-解析本地so文件失败)的处理步骤。
...
使用[bm dump -n 命令](/consumer/cn/doc/harmonyos-guides/bm-tool#查询应用信息命令dump)查询应用的信息，检查传入的插件是否安装。
