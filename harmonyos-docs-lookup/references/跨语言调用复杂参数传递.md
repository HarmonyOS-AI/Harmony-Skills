...
**图1** 新建Napi模块  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/oRlPPaWXR82e6hoqT0uEyQ/zh-cn_image_0000002229450485.png?HW-CC-KV=V1&HW-CC-Date=20260403T160551Z&HW-CC-Expire=86400&HW-CC-Sign=18757721194C5B746A84F5DF94090CF19F12E07E7B99870667147EF3D2EEA9A3 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/H4_tMfniQmu04nNjY1G-yg/zh-cn_image_0000002194010204.png?HW-CC-KV=V1&HW-CC-Date=20260403T160551Z&HW-CC-Expire=86400&HW-CC-Sign=12CAAA5B53889B707A7669F3766BD96A6426F2D4E2A4577AE5974115E4A6A804 "点击放大")
...
1. 函数声明与调用，与[arrayBuffer类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section9552193517193)类同，此处不再赘述。
...
3. 在DevEco Studio[预生成](/consumer/cn/doc/best-practices/bpta-complex-type-pass#fig08576372193)的Init()函数中设置写好的数据传递函数。与[arrayBuffer类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section9552193517193)类同，此处不再赘述。

**实现效果**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/UgKWzu-AS0ygznMl8eCqEw/zh-cn_image_0000002194010224.png?HW-CC-KV=V1&HW-CC-Date=20260403T160551Z&HW-CC-Expire=86400&HW-CC-Sign=3AE3088C0C413592FAD1437F19E4CB387D6098038C18F4D7FB7160E06A73218D "点击放大")
...
3. 需在DevEco Studio[预生成](/consumer/cn/doc/best-practices/bpta-complex-type-pass#fig08576372193)的Init()函数中设置写好的数据传递函数。与[arrayBuffer类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section9552193517193)类同，此处不再赘述。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e/v3/kSG0z7xdTfa83zxbLMkjGA/zh-cn_image_0000002193850624.png?HW-CC-KV=V1&HW-CC-Date=20260403T160551Z&HW-CC-Expire=86400&HW-CC-Sign=D732EADF2F9A6498BCFFFBE6D4F361CA4F0655AFB899D2FC9FD79AEC95C70E85 "点击放大")

### pixelMap类型数据交互

本章以图片处理应用为例，介绍如何进行pixelMap类型数据交互。

除本文介绍的方法外，也可通过readPixelsToBuffer将其转换为Uint8Array类型，进行处理。此方案可以参考[arrayBuffer类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section9552193517193)，本文不作介绍。
...
4. 在Init()函数中的设置流程与[arrayBuffer类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section9552193517193)相同，不再赘述。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/dchrlH0uTB6Q2qhgdvWTbw/zh-cn_image_0000002194010228.png?HW-CC-KV=V1&HW-CC-Date=20260403T160551Z&HW-CC-Expire=86400&HW-CC-Sign=9853DB7D1FA072DD21F74780267690B8D0B0343583A99426D442BFB6AAC31E12 "点击放大")
...
2. 在C++工程中，定义数据传递函数。
   ...
   value2String、string2value()：负责napi\_value与string类型之间的相互转换，实现方法详见[hashMap类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section81062596218)。
3. 需在DevEco Studio[预生成](/consumer/cn/doc/best-practices/bpta-complex-type-pass#fig08576372193)的Init()函数中设置写好的数据传递函数。与[arrayBuffer类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section9552193517193)类同，此处不再赘述。

**实现效果**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/QfDHlSFlQ2mNCY1oRjAPTQ/zh-cn_image_0000002193850628.png?HW-CC-KV=V1&HW-CC-Date=20260403T160551Z&HW-CC-Expire=86400&HW-CC-Sign=8F65653B74DA521FBE5964600C6A02BAB7AF95B05B9548FF9B5A441EC43AA207 "点击放大")
...
3. 在C++工程中，定义对应的class。
   ...
   string2value()：负责将obj->hintStr转换为napi\_value，作为输出。此函数的实现方法详见[hashMap类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section81062596218)。
   ...
   3. 实现times方法，为加区分，此处命名为TSTimes。
      ...
      string2Value()：负责将string转换为napi\_value数据。此函数的实现方法详见[hashMap类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section81062596218)。
   ...
   4. TsConstructor()，用于构造ArkTS class。
      ...
      value2String()：负责将入参转换为string。此函数的实现方法详见[hashMap类型数据交互](/consumer/cn/doc/best-practices/bpta-complex-type-pass#section81062596218)。
...
4. 在Init()函数中设置class。
   ...
   需要先在DevEco Studio[预生成](/consumer/cn/doc/best-practices/bpta-complex-type-pass#fig08576372193)的Init()函数中，定义一个classProp，并写入class对应的访问器与方法

   并调用napi\_define\_class()和napi\_set\_named\_property()完成ArkTS class 与C++ class的关联与设置。从而令ArkTS可以调用C++中的class。

**实现效果**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/2bpdWu_kQfCKITs3rsZ1EA/zh-cn_image_0000002229450497.png?HW-CC-KV=V1&HW-CC-Date=20260403T160551Z&HW-CC-Expire=86400&HW-CC-Sign=26D138C84DEB45FF81EC87301D823286E0729F4C058D18AE2B1CD2B68119ABDF "点击放大")
