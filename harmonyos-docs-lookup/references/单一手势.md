...
18. .onClick(() => { // 1. 子组件上注册了点击事件，正常情况下点击在子组件上时，优先得到响应
19. console.info('Clicked on child');
20. this.increaseJudgeGuard();
21. })
22. .onGestureJudgeBegin((gestureInfo: GestureInfo, event: BaseGestureEvent) => {
23. // 3. 当数字增长为5的倍数时禁用子组件上的点击手势，这样父组件上的点击可以得到响应
24. if (this.judgeCount % 5 == 0 && gestureInfo.type == GestureControl.GestureType.CLICK) {
25. return GestureJudgeResult.REJECT;
26. } else {
27. return GestureJudgeResult.CONTINUE;
28. }
29. })
30. }
31. .width('80%')
...
35. .gesture(
36. TapGesture() // 2. 父组件上注册了点击手势，正常情况下点击在子组件区域时，父组件上的手势优先级低于子组件
37. .onAction(() => {
38. console.info('Clicked on parent');
39. this.increaseJudgeGuard();
40. }))
41. }
42. .height('100%')
43. .width('100%')
...
47. // 请将$r('app.string.singlegesture_Index_Click_title')替换为实际资源文件，在本示例中该资源文件的value值为"点击事件"
48. .title($r('app.string.singlegesture_Index_Click_title'))
49. }
50. }
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/6weraD5YSj2D5u_a_3xo0w/zh-cn_image_0000002535948482.gif?HW-CC-KV=V1&HW-CC-Date=20260403T130311Z&HW-CC-Expire=86400&HW-CC-Sign=483AA9F7C0220FC8539C37A0409B1FBCA4FA06FFA8430DB146EF2F6EFE7DBE17)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a/v3/ctTLGdleQ7O9t_AaV0p-xQ/zh-cn_image_0000002566868315.gif?HW-CC-KV=V1&HW-CC-Date=20260403T130311Z&HW-CC-Expire=86400&HW-CC-Sign=6198CC15FC4E457DA8FD7994FDDE9FC0FE254752B1F4465FD4EDD5579D29CFB9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/fMDsdFbtRUSy-ce8EOGLgg/zh-cn_image_0000002566708333.gif?HW-CC-KV=V1&HW-CC-Date=20260403T130311Z&HW-CC-Expire=86400&HW-CC-Sign=9E85076A727C9A1A1E29144CA23FF29E4BE265CB536F67C5BC83977E10445D0D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/X-jD11LtTfidocIFZj0EOA/zh-cn_image_0000002535788538.png?HW-CC-KV=V1&HW-CC-Date=20260403T130311Z&HW-CC-Expire=86400&HW-CC-Sign=6521F45127D6B90B5A31D3F0FDB711F46CDB6F51F808076EBFF5EFB6D4235D95)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/uh8Sq1gfSxidvu1Cu2J0tw/zh-cn_image_0000002535948484.png?HW-CC-KV=V1&HW-CC-Date=20260403T130311Z&HW-CC-Expire=86400&HW-CC-Sign=BBADAD0A40E0B8098A27D0D428343995A47B389AB9F45E61FBC4D247C76F8DAF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/GKM7gEFES0GXglQjmseF4g/zh-cn_image_0000002566868317.gif?HW-CC-KV=V1&HW-CC-Date=20260403T130311Z&HW-CC-Expire=86400&HW-CC-Sign=28FDE75B44730DC1265B2AC50786969879647001735DD7E901C903E19821643D)
