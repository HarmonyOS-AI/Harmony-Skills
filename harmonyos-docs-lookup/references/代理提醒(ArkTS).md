...
| getValidReminders(): Promise<Array<ReminderRequest>> | 获取当前应用设置的所有[有效（未过期）的代理提醒](/consumer/cn/doc/harmonyos-guides/agent-powered-reminder#约束与限制)。 |
...
3. 进入“项目设置”->“开放能力管理”页面，点击“代理提醒”卡片对应的“申请”按钮。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/6n-HoZDsSa-TqmHSfrpkwg/zh-cn_image_0000002535788810.png?HW-CC-KV=V1&HW-CC-Date=20260403T132338Z&HW-CC-Expire=86400&HW-CC-Sign=8735D3A276F0391B37F7FE0B84B5F14E7063B33D212085FB6A8F58F3A66FB5D4)
4. 在“新建业务申请”窗口填写申请原因，上传代理提醒功能场景截图和应用分类信息截图，然后点击“提交”。应用分类信息可登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)网站，在“APP”页签中选择“应用上架”->“应用信息”查询。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/PDMWBIXBR-iWCcIepHUoIQ/zh-cn_image_0000002535948756.png?HW-CC-KV=V1&HW-CC-Date=20260403T132338Z&HW-CC-Expire=86400&HW-CC-Sign=CD875EC4319CB748DD51CA4C8A254072731FC8B6296F8A8F3B0416B1FA23C966)
5. 返回“开放能力接入”页面，原“申请”按钮变为“申请中”，8个工作日反馈申请结果。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/TelvtXHIRsup84FoU0LLbQ/zh-cn_image_0000002566868589.png?HW-CC-KV=V1&HW-CC-Date=20260403T132338Z&HW-CC-Expire=86400&HW-CC-Sign=C6D6EA6BEE2F7330C8B2C3B4A4EF377EB97A7D615173D9705171819F4BE1FDC4)
...
7. 能力申请通过后，勾选代理提醒的能力开关，点击右上角“保存”。至此，您的应用已成功接入开放能力。此时，调试和发布应用必须使用[手动签名](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-signing)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/bLe75ALfTKeQl5IBWaiSpA/zh-cn_image_0000002566708607.png?HW-CC-KV=V1&HW-CC-Date=20260403T132338Z&HW-CC-Expire=86400&HW-CC-Sign=347EBCF023252F9E63475C01251E892139E638F03927A52A53ED5187ECB07E22)
...
1. 导入模块。
   ...
   [Timer.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20251117/BackGroundTasksKit/ReminderAgentManager/entry/src/main/ets/pages/timer/Timer.ets#L16-L20)
2. 定义目标提醒代理。开发者根据实际需要，选择定义如下类型的提醒。
   ...
   * 定义倒计时实例。
     ...
     [Timer.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20251117/BackGroundTasksKit/ReminderAgentManager/entry/src/main/ets/pages/timer/Timer.ets#L244-L258)
   * 定义日历实例。
...
4. 根据需要删除提醒任务。
   ...
   [CalendarReminder.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20251117/BackGroundTasksKit/ReminderAgentManager/entry/src/main/ets/util/CalendarReminder.ets#L149-L152)