...
* [音频焦点抢占流程](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section1747213761316)：了解多音频流抢占焦点的流程，熟悉系统音频焦点管理机制，有助于开发者更高效地定位和解决焦点问题。
* [音频流类型正确配置](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section2888185819153)：正确配置音频流类型，可以获取合理的系统默认焦点策略。同时，在音量管理、音效管理以及输入/输出设备选择上，避免出现不可预期的故障现象。
* [自定义焦点策略设置](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section048671914296)：使用AudioSession进行自定义焦点策略设置，可以定制化地满足用户预期的播放体验。
* [焦点中断事件正确处理](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section1664171514332)：正确处理焦点中断事件，可以避免出现中断后不恢复或播放UI状态错误的现象。
* [应用内多音频流焦点处理](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section168291861114)：同一应用内创建多个音频流时，可实现自主管控，定制不同场景下的多音频流播放体验。
* [常见焦点场景的问题分析](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section8750452171110)：通过分析典型问题场景，有助于开发者获取解决方案，以提升开发效率。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/Ep2_GsP0R8CzWKwuC_exuw/zh-cn_image_0000002531280209.gif?HW-CC-KV=V1&HW-CC-Date=20260403T160400Z&HW-CC-Expire=86400&HW-CC-Sign=979B8375B5A7154AC28FBE3032B6D5BEEF4B1D2D96ED01A3593CDF5107DDACD0 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/qCfab6nCRvyYa4QsPqsZgA/zh-cn_image_0000002531200167.png?HW-CC-KV=V1&HW-CC-Date=20260403T160400Z&HW-CC-Expire=86400&HW-CC-Sign=C5A38BBCFF8712C698BAA73A5EB876E65A06334F0FAE9BC55F5EE2042C0EB58F "点击放大")
...
系统根据先播和后播音频流类型，查询[默认策略表](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section17923135513547)。不同策略对应着不同的焦点处理方式，具体如下流程图：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/h6e5Woo5QO2H-3tkqSvjGg/zh-cn_image_0000002499520260.png?HW-CC-KV=V1&HW-CC-Date=20260403T160400Z&HW-CC-Expire=86400&HW-CC-Sign=D73D0981102F2D3AD8C753D21DDE092F492D2A47CAF58FA2AF53FF00190ED98F "点击放大")
...
为了开发者能够更好地选择正确的音频流类型，本文提供了常见音频流及其对应业务场景映射表以供参考。开发者也可以根据音频流类型，查询对应的[系统默认策略](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section17923135513547)。
...
以新闻或者公众号文章中的内嵌短视频播放中断后台音乐场景为例，短视频音频流类型正确配置为[STREAM\_USAGE\_MOVIE](/consumer/cn/doc/best-practices/bpta-audio-focus-management#table1513115566277)，根据系统默认策略，后台音乐会在短视频播放时停止播放，且短视频播放结束后，后台音乐不会自动恢复播放。然而，该场景下，更佳的音频播放体验应为短视频播放结束后，后台音乐自动恢复播放。此例说明开发者有需要精细化管理音频焦点策略的场景。
...
1. **默认模式（CONCURRENCY\_DEFAULT）：**即系统默认的音频焦点策略，默认焦点策略详见本章[系统默认焦点策略表](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section17923135513547)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/FfeKRrMcS3CazIuQYdxRrQ/zh-cn_image_0000002499360276.png?HW-CC-KV=V1&HW-CC-Date=20260403T160400Z&HW-CC-Expire=86400&HW-CC-Sign=5975744DCBF74A25915E1A05239A09D0490C546553FDC5CDE75D012114A12854 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/qs16IAqtSeS6kw44ZUmAow/zh-cn_image_0000002531280215.png?HW-CC-KV=V1&HW-CC-Date=20260403T160400Z&HW-CC-Expire=86400&HW-CC-Sign=047FE658C3AAE080A1D66B7768DD64A8AB4C9AF5AA23C00144B802E76AAEF552 "点击放大")
...
通过给后播短视频设置自定义焦点策略，可以实现[场景描述](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section938014296464)中的更优体验。主要的开发步骤如下。
...
可通过设置[焦点模式（InterruptMode）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#interruptmode9)，可以实现同应用内不同音频流之间的并发或中断效果，详细流程参考上文[应用内多音频流焦点处理](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section168291861114)。
...
1. **音频流类型设置解决方案**
   * 了解音频流类型与系统默认策略关联原理。
   * 参考[音频流类型正确配置](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section2888185819153)，选择正确的音频流类型。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/cRXJJGYqR2O1y9smHklXZw/zh-cn_image_0000002531200173.png?HW-CC-KV=V1&HW-CC-Date=20260403T160400Z&HW-CC-Expire=86400&HW-CC-Sign=BBF053A85A1BC79E00EA7FF66DFEE2E9CF2B76383666E472A5529CFAB60FE0F6 "点击放大")
...
* **游戏配乐、配音中断后台音乐，预期是并发播放，**可参考上文[短音中断场景分析思路](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section8811136185118)
  + 音频流类型设置错误，导致系统默认策略错误。
  + 系统默认策略不符合用户播放预期。
* **游戏语音中断后台音乐不恢复**，可参考上文[VoIP通话场景分析思路](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section195701439164615)
  + 音频流类型设置错误，导致系统默认策略错误。
  + 应用未正确处理中断事件，导致音频中断不恢复。
* **游戏应用内，VOIP通话音频与游戏音效存在中断，预期是并发播放。**可参考[应用内多音频流焦点处理](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section168291861114)
...
3. **焦点中断事件处理解决方案**
   * 由于恢复事件属于非强制类型，系统不会自动恢复先播音频播放。先播应用收到中断提示为InterruptHint.INTERRUPT\_HINT\_RESUME（音频恢复）后，需要主动在相应的事件中调用播放接口完成恢复。具体操作参考[处理音频焦点变化](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-playback-concurrency#处理音频焦点变化)。
4. **焦点模式设置解决方案**
   * 通过设置[焦点模式（InterruptMode）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#interruptmode9)，可以实现同应用内不同音频流之间的并发或中断效果。参考上文[应用内多音频流焦点处理](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section168291861114)
...
上文提供了[音频流类型正确配置](/consumer/cn/doc/best-practices/bpta-audio-focus-management#section2888185819153)，用以帮助开发者根据业务场景选择正确的音频流类型。下文将提供手机场景下常见音频流类型与系统默认焦点策略之间的关联矩阵表，用以帮助开发者选择合适的音频会话（AudioSession）策略，从而满足用户预期播放行为。为方便阅读，去掉了播放音频流类型的“STREAM\_USAGE\_”前缀。
