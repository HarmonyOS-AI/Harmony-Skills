...
如果应用在[AbilityStage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-abilitystage#abilitystage)中使能[应用恢复功能](/consumer/cn/doc/harmonyos-guides/apprecovery-guidelines#应用恢复接口功能介绍)，并对临时数据进行保存，应用非预期退出后的下一次启动会恢复先前的状态和数据，给用户更连贯的使用体验。这里状态包括应用的页面栈以及onSaveState接口中保存的数据。
...
应用故障恢复接口由appRecovery模块提供，开发者可以通过import引入，详见[开发步骤](/consumer/cn/doc/harmonyos-guides/apprecovery-guidelines#开发步骤)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/YIs1E1IxTy6A81YwPZiuAQ/zh-cn_image_0000002535948860.png?HW-CC-KV=V1&HW-CC-Date=20260403T142633Z&HW-CC-Expire=86400&HW-CC-Sign=5BDBCFE9B2F5A207ED0089A9B2C02F0163596B20F1667CC845B8921AD7ED2BE0)

### 应用卡死的状态保存及恢复

API 10开始支持应用卡死时的状态保存。JsError故障时，onSaveState接口在主线程进行回调。对于AppFreeze故障，主线程可能处于卡死的状态，onSaveState会在非主线程进行回调。其主要流程如下图：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/0j1Gc0OhQRifl9xqrx8Piw/zh-cn_image_0000002566868693.png?HW-CC-KV=V1&HW-CC-Date=20260403T142633Z&HW-CC-Expire=86400&HW-CC-Sign=BA1FEB3E51ABFE9377EE3B878BC902CBB9DF42FD19F2BA78BA404682FECED55C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/JFMJYVBcQnCfDF4SUBfxcg/zh-cn_image_0000002566708713.png?HW-CC-KV=V1&HW-CC-Date=20260403T142633Z&HW-CC-Expire=86400&HW-CC-Sign=00EE6D0A6239879895CEB3E93B7ED4490355FBD4A5D181410B5D0B1D6F116C46)
...
| [CPP\_CRASH](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-faultlogger#faulttype) | 不支持 | 不支持 | 不支持 | 支持 |
