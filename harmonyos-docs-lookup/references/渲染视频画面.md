...
3. 启动解码器、解码输入子线程、解码输出子线程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/idZUCj_RQGKRM4LuF5PBXg/zh-cn_image_0000002484614821.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=E5A41B8DEB28EC67FB23EC8985FA044E10CC0A934D310D087B39010FDC33B06E "点击放大")
4. 通过OnNeedInputBuffer获取可用的AVBuffer后，在解码输入子线程中，将解封装器读取视频数据填充到AVBuffer中，并提交给解码器进行解码。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/9Wpi_633RSaroBWRhRj3oQ/zh-cn_image_0000002451534962.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=B3F4A18F29D218CCDFF4E9268AA665834D8452C8CD3F2645E7D9036AADC8DF24 "点击放大")
5. 通过OnNeedOutputBuffer获取解码的视频数据后，在解码输出子线程中，将解码后的视频数据提交给输出Surface（即XComponent的NativeWindow）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/8eNSA4BHT9WOQihhgg3nQg/zh-cn_image_0000002451375366.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=031373B4C6DAEA26BD0A784FD23B29F659DA6971487CA31665D09BB21FAA4A53 "点击放大")
...
3. 获取XComponent的NativeWindow对象，并根据XComponent的NativeWindow对象创建EGLSurface。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/rb0OtazUQKKlST1axBqJ2A/zh-cn_image_0000002484494809.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=9A2897D2B92A72287366A8060DA3C05E08FAF340A500505C7A011400DB63ED1B "点击放大")
...
5. 启动解码器、解码输入子线程、解码输出子线程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/7FoJG8KHS8GETvMYva_hqg/zh-cn_image_0000002484614829.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=2329F4DFB031D397B8446675761659FAF7E93D890A805771E26365D386039331 "点击放大")
...
7. 通过OnNeedOutputBuffer获取解码的视频数据后，在解码输出子线程中，将解码后的视频数据提交给输出Surface（当前Surface为NativeImage的NativeWindow对象）。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/s0Ndil5sSnqk_L23p9NESQ/zh-cn_image_0000002451534970.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=821045A7BD4489CEEBE3240AAF34FA133E1B2D355314718AA791E3B40B5A4F20 "点击放大")
8. 通过NativeImage，将视频图像缓存更新至OpenGL的纹理上。
9. 通过eglSwapBuffers交换前后缓冲区的内容，并将渲染结果显示在屏幕。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/ChTv9g9pSZaGdV99KXGFVw/zh-cn_image_0000002451375374.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=2DB5EC04757CD73248D255CCD2292A4CE4824D025A5623617E10EB6ABAD30C4E "点击放大")
...
3. 获取XComponent的NativeWindow对象，并根据XComponent的NativeWindow对象创建Vulkan的Surface用于显示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/uRkyHNqUT7WAbCCe_SHRfg/zh-cn_image_0000002484494813.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=370FADFFECD142BDA1624AEB31A5B7D0B82713050818F994378ADED9F4294CC8 "点击放大")
...
9. Vulkan根据NativeBuffer创建对应的ImageView用于采样，同时，创建对应格式的采样器，通过采样器将YUV格式的图像转化成RGBA的图像，最后，通过渲染管道进行显示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/vsXuP4ePRE2gi_mdecR5ow/zh-cn_image_0000002484614833.jpg?HW-CC-KV=V1&HW-CC-Date=20260403T160347Z&HW-CC-Expire=86400&HW-CC-Sign=C6F26B17C6A9D6B9C428A9B50EC000EAB0A67F87AB10B93BEDBF6F692195C5E8 "点击放大")
