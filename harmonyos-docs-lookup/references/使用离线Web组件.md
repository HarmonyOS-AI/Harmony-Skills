...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/knBcAmhFThyu_SLSeqL-3g/zh-cn_image_0000002535788798.png?HW-CC-KV=V1&HW-CC-Date=20260403T132245Z&HW-CC-Expire=86400&HW-CC-Sign=A9A986F1D6345C04037CCC2F14B1719463862CBC9C396F4597234799A2E0CED4)
...
1. onWindowStageCreate(windowStage: window.WindowStage): void {
2. windowStage.loadContent('pages/Index', (err, data) => {
3. // 创建空的Web动态组件（需传入UIContext），loadContent之后的任意时机均可创建
4. createNWeb('about：blank', windowStage.getMainWindowSync().getUIContext());
5. if (err.code) {
6. return;
7. }
8. });
...
10. Column() {
11. // 已经预启动Render进程
12. Button('Jump to web page').onClick(()=>{
13. this.getUIContext().getRouter().pushUrl({url: 'pages/index2'});
14. })
15. .width('100%')
16. .height('100%')
17. }
...
9. Row() {
10. Column() {
11. Web({src: 'https://www.example.com', controller: this.webviewController})
12. .width('100%')
13. .height('100%')
14. }
15. .width('100%')
...
47. console.info('uicontext is undifined : ' + (uiContext === undefined));
...
[Common.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20251117/ArkWeb/UseOfflineWebComp/entry3/src/main/ets/pages/Common.ets#L152-L221)
...
* Page1页面同时显示了两个Web页面，每个页面使用了一个离线Web组件，加载并显示相同URL的内容。该页面用于演示预渲染与不预渲染的效果对比，以及如何复用离线组件。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/-FGAqyu1RmSLFk20IhdAFw/zh-cn_image_0000002535948744.gif?HW-CC-KV=V1&HW-CC-Date=20260403T132245Z&HW-CC-Expire=86400&HW-CC-Sign=4E3F34C5CA395176BF471F9182E5894C66C7361DDC2D60D9F680FC08218458E5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/jVms1tUfTMyY3SWLE6Ceng/zh-cn_image_0000002566868577.gif?HW-CC-KV=V1&HW-CC-Date=20260403T132245Z&HW-CC-Expire=86400&HW-CC-Sign=64B757C934838ABAC79D92E54AEE73BA30C058143801973A9AF057DDD6D1E42B)
